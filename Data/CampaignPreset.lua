...
PlaceObj('CampaignPreset', {
	...
	Sides = {
		PlaceObj('CampaignSide', {
			'Id', "neutral",
			'DisplayName', T(521973101724, --[[CampaignPreset HotDiamonds DisplayName]] "Neutral"),
		}),
		PlaceObj('CampaignSide', {
			'Id', "player1",
			'DisplayName', T(222892508302, --[[CampaignPreset HotDiamonds DisplayName]] "Player 1"),
			'Player', true,
		}),
		PlaceObj('CampaignSide', {
			'Id', "player2",
			'DisplayName', T(942355779355, --[[CampaignPreset HotDiamonds DisplayName]] "Player 2"),
			'Player', true,
		}),
		PlaceObj('CampaignSide', {
			'Id', "enemy1",
			'DisplayName', T(692913892455, --[[CampaignPreset HotDiamonds DisplayName]] "Enemy 1"),
			'Standing', -100,
			'Enemy', true,
		}),
		PlaceObj('CampaignSide', {
			'Id', "enemy2",
			'DisplayName', T(456135028453, --[[CampaignPreset HotDiamonds DisplayName]] "Enemy 2"),
			'Standing', -100,
			'Enemy', true,
		}),
		PlaceObj('CampaignSide', {
			'Id', "enemyNeutral",
			'DisplayName', T(607169506860, --[[CampaignPreset HotDiamonds DisplayName]] "Enemy Neutral"),
			'Standing', -100,
		}),
		PlaceObj('CampaignSide', {
			'Id', "ally",
			'DisplayName', T(346100175449, --[[CampaignPreset HotDiamonds DisplayName]] "Ally"),
		}),
	},
	group = "Default",
	id = "HotDiamonds",
