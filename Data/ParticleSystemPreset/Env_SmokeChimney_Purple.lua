...
PlaceObj('ParticleSystemPreset', {
	...
	PlaceObj('ParticleBehaviorColorize', {
		'start_color_min', RGBA(105, 47, 118, 255),
		'start_color_max', RGBA(89, 40, 102, 255),
		'mid_color', RGBA(109, 81, 117, 255),
		'end_color', RGBA(172, 143, 179, 255),
	}, nil, nil),
	...
	PlaceObj('ParticleBehaviorColorize', {
		'bins', set( "C" ),
		'start_color_min', RGBA(190, 94, 47, 255),
		'start_intensity_min', 2000,
		'start_color_max', RGBA(168, 47, 190, 255),
		'start_intensity_max', 3000,
		'mid_color', RGBA(222, 42, 255, 255),
		'mid_intensity', 2000,
		'end_color', RGBA(19, 0, 60, 255),
		'end_intensity', 2000,
		'middle_pos', 20,
	}, nil, nil),
	PlaceObj('ParticleBehaviorColorize', {
