...
PlaceObj('ParticleSystemPreset', {
	...
	group = "Destruction",
	id = "Destr_DebrisChunks_MetalSplinters",
	...
	PlaceObj('ParticleBehaviorColorize', {
		'start_color_min', RGBA(141, 118, 106, 255),
		'start_intensity_min', 1200,
		'start_color_max', RGBA(147, 135, 111, 255),
		'start_intensity_max', 1200,
		'mid_color', RGBA(168, 154, 127, 255),
		'mid_intensity', 1200,
		'end_color', RGBA(157, 128, 109, 255),
		'end_intensity', 1200,
		'type', "One of four",
	}, nil, nil),
