...
PlaceObj('ParticleSystemPreset', {
	...
	group = "Destruction",
	id = "Destr_DebrisChunks_BoneSplinters",
	...
	PlaceObj('ParticleBehaviorColorize', {
		'start_color_min', RGBA(150, 147, 144, 255),
		'start_intensity_min', 1200,
		'start_color_max', RGBA(191, 187, 179, 255),
		'start_intensity_max', 1200,
		'mid_color', RGBA(179, 176, 169, 255),
		'mid_intensity', 1200,
		'end_color', RGBA(163, 160, 155, 255),
		'end_intensity', 1200,
		'type', "One of four",
	}, nil, nil),
