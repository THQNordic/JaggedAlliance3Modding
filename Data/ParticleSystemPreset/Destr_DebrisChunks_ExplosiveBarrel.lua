...
PlaceObj('ParticleSystemPreset', {
	...
	group = "Destruction",
	id = "Destr_DebrisChunks_ExplosiveBarrel",
	...
	PlaceObj('ParticleBehaviorColorize', {
		'start_color_min', RGBA(89, 29, 21, 255),
		'start_intensity_min', 1200,
		'start_color_max', RGBA(96, 32, 15, 255),
		'start_intensity_max', 1200,
		'mid_color', RGBA(29, 18, 17, 255),
		'mid_intensity', 1200,
		'end_color', RGBA(61, 9, 8, 255),
		'end_intensity', 1200,
		'type', "One of four",
	}, nil, nil),
