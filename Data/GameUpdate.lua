...
PlaceObj('GameUpdate', {
	SortKey = 96,
	Text = T(233817448743, --[[GameUpdate Update1_5 Text]] "Update 1.5 introduces a treasure trove of powerful modding tools. The modding toolset now encompasses most of what was used during the development of the game. Additionally we've introduced some new Game Rules that would allow for new special twists on your playthroughs and tweak the difficulty to your liking."),
	Title = T(593519602713, --[[GameUpdate Update1_5 Title]] "Update 1.5 - Codename: Larry"),
	group = "Default",
	id = "Update1_5",
})
...
PlaceObj('GameUpdate', {
	SortKey = 97,
	Text = T(374638348565, --[[GameUpdate Update1_4 Text]] 'Update 1.4 introduces a major mid- to late-game quest - "U-Bahn" with new maps and items. Discover the secrets hidden beneath Grand Chien since WW2... if you dare to face the formidable adversaries that guard them.\nBut that\'s not all - update 1.4 also provides many Sat View improvements like a revamped Conflict Screen, multiselection in the Inventory, Sector stash overhaul, and tweaks to some Operations.'),
	Title = T(565194456035, --[[GameUpdate Update1_4 Title]] "Update 1.4 - Codename: Wolf"),
	group = "Default",
	id = "Update1_4",
})
