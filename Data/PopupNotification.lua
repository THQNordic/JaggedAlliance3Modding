...
PlaceObj('PopupNotification', {
	Image = "UI/Messages/scouting_outcome",
	Text = T(300082102483, --[[PopupNotification Tired Text]] "<base_activity_info>\nThe mission was unexpectedly hard and all Mercs are now Exhausted."),
	Title = T(172203007150, --[[PopupNotification Tired Title]] "Exhausted"),
	group = "Outcome",
	id = "Tired",
})
...
PlaceObj('PopupNotification', {
	...
	Text = T(848286344110, --[[PopupNotification Morale Text]] "The icon at the top left of the HUD <image UI/Hud/morale_high.tga 2000 192 187 170> indicates the current Team Morale level for your team. Each merc has an individual Morale value, based on Team Morale and various personal factors.\n\nMorale <em>modifies AP</em> and can trigger various positive and negative effects based on the <em>highest Leadership</em> stat among the mercs. Killing enemies sometimes boosts Team Morale, while taking heavy damage or suffering casualties lowers it."),
