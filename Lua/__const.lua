...
DefineConst{
	Comment = "Point to reach to heal a wound for nemies and miltia",
	group = "Satellite",
	id = "HealWoundThreshold",
	value = 1000,
}
DefineConst{
	Comment = "Heal wound point per tick for emenies and militia",
	group = "Satellite",
	id = "HealWoundsPerTick",
	value = 10,
}
DefineConst{
	group = "Satellite",
...
DefineConst{
	Comment = "For each HP point above that constant the character loses Energy 1% slower, down to -(1000 -costant)%.\nFor each HP point below that constant the character loses Energy 1% faster, up to +50%.",
	group = "Satellite",
...
DefineConst{
	...
	translate = true,
	type = "text",
	value = T(173062976593, --[[ConstDef TagLookupTable agility value]] "<em>Agility</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "agility-f",
	translate = true,
	type = "text",
	value = T(604427989653, --[[ConstDef TagLookupTable agility-f value]] "<em>Agility</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "agility-s",
	translate = true,
	type = "text",
	value = T(605709911368, --[[ConstDef TagLookupTable agility-s value]] "<em>Agility</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "dexterity",
	translate = true,
	type = "text",
	value = T(445190944231, --[[ConstDef TagLookupTable dexterity value]] "<em>Dexterity</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "dexterity-f",
	translate = true,
	type = "text",
	value = T(168838094663, --[[ConstDef TagLookupTable dexterity-f value]] "<em>Dexterity</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "dexterity-s",
	translate = true,
	type = "text",
	value = T(445855730389, --[[ConstDef TagLookupTable dexterity-s value]] "<em>Dexterity</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "explosives",
	translate = true,
	type = "text",
	value = T(740643734848, --[[ConstDef TagLookupTable explosives value]] "<em>Explosives</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "explosives-f",
	translate = true,
	type = "text",
	value = T(987216838762, --[[ConstDef TagLookupTable explosives-f value]] "<em>Explosives</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "explosives-s",
	translate = true,
	type = "text",
	value = T(786219088415, --[[ConstDef TagLookupTable explosives-s value]] "<em>Explosives</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "failure",
	translate = true,
	type = "text",
	value = T(660586654399, --[[ConstDef TagLookupTable failure value]] "<em>(failure)</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "health",
	translate = true,
	type = "text",
	value = T(771315187589, --[[ConstDef TagLookupTable health value]] "<em>Health</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "health-f",
	translate = true,
	type = "text",
	value = T(934194806866, --[[ConstDef TagLookupTable health-f value]] "<em>Health</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "health-s",
	translate = true,
	type = "text",
	value = T(538191903225, --[[ConstDef TagLookupTable health-s value]] "<em>Health</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "leadership",
	translate = true,
	type = "text",
	value = T(434575611315, --[[ConstDef TagLookupTable leadership value]] "<em>Leadership</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "leadership-f",
	translate = true,
	type = "text",
	value = T(115961113381, --[[ConstDef TagLookupTable leadership-f value]] "<em>Leadership</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "leadership-s",
	translate = true,
	type = "text",
	value = T(791099644012, --[[ConstDef TagLookupTable leadership-s value]] "<em>Leadership</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "loyalty",
	translate = true,
	type = "text",
	value = T(540663603961, --[[ConstDef TagLookupTable loyalty value]] "<em>Loyalty</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "marksmanship",
	translate = true,
	type = "text",
	value = T(231310967363, --[[ConstDef TagLookupTable marksmanship value]] "<em>Marksmanship</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "marksmanship-f",
	translate = true,
	type = "text",
	value = T(377084552469, --[[ConstDef TagLookupTable marksmanship-f value]] "<em>Marksmanship</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "marksmanship-s",
	translate = true,
	type = "text",
	value = T(967747929528, --[[ConstDef TagLookupTable marksmanship-s value]] "<em>Marksmanship</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "mechanical",
	translate = true,
	type = "text",
	value = T(182951201564, --[[ConstDef TagLookupTable mechanical value]] "<em>Mechanical</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "mechanical-f",
	translate = true,
	type = "text",
	value = T(887233553893, --[[ConstDef TagLookupTable mechanical-f value]] "<em>Mechanical</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "mechanical-s",
	translate = true,
	type = "text",
	value = T(907017027968, --[[ConstDef TagLookupTable mechanical-s value]] "<em>Mechanical</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "medical",
	translate = true,
	type = "text",
	value = T(955267014620, --[[ConstDef TagLookupTable medical value]] "<em>Medical</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "medical-f",
	translate = true,
	type = "text",
	value = T(206296047675, --[[ConstDef TagLookupTable medical-f value]] "<em>Medical</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "medical-s",
	translate = true,
	type = "text",
	value = T(725550892596, --[[ConstDef TagLookupTable medical-s value]] "<em>Medical</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "negotiator",
	translate = true,
	type = "text",
	value = T(385382636358, --[[ConstDef TagLookupTable negotiator value]] "<em>Negotiator</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "psycho",
	translate = true,
	type = "text",
	value = T(373801051640, --[[ConstDef TagLookupTable psycho value]] "<em>Psycho</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "scoundrel",
	translate = true,
	type = "text",
	value = T(101209792712, --[[ConstDef TagLookupTable scoundrel value]] "<em>Scoundrel</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "strength",
	translate = true,
	type = "text",
	value = T(736618764391, --[[ConstDef TagLookupTable strength value]] "<em>Strength</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "strength-f",
	translate = true,
	type = "text",
	value = T(136303670108, --[[ConstDef TagLookupTable strength-f value]] "<em>Strength</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "strength-s",
	translate = true,
	type = "text",
	value = T(646626968372, --[[ConstDef TagLookupTable strength-s value]] "<em>Strength</em> check successful "),
}
DefineConst{
	group = "TagLookupTable",
	id = "success",
	translate = true,
	type = "text",
	value = T(590323149753, --[[ConstDef TagLookupTable success value]] "<em>(success)</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "wisdom",
	translate = true,
	type = "text",
	value = T(290895471056, --[[ConstDef TagLookupTable wisdom value]] "<em>Wisdom</em>"),
}
DefineConst{
	group = "TagLookupTable",
	id = "wisdom-f",
	translate = true,
	type = "text",
	value = T(703234572711, --[[ConstDef TagLookupTable wisdom-f value]] "<em>Wisdom</em> check failed "),
}
DefineConst{
	group = "TagLookupTable",
	id = "wisdom-s",
	translate = true,
	type = "text",
	value = T(940972260976, --[[ConstDef TagLookupTable wisdom-s value]] "<em>Wisdom</em> check successful "),
}
DefineConst{
...
DefineConst{
	Comment = "Mercenaries exploration mode walk speed.",
	group = "UnitMoveSpeed",
	id = "MercWalk",
	value = 1400,
}
