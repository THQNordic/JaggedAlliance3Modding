...
DefineClass.TearGasGrenade = {
	...
	ItemType = "GrenadeGas",
	DisplayName = T(591872286262, --[[InventoryItemCompositeDef TearGasGrenade DisplayName]] "Tear Gas Grenade"),
	DisplayNamePlural = T(942175585447, --[[InventoryItemCompositeDef TearGasGrenade DisplayNamePlural]] "Tear Gas Grenades"),
	AdditionalHint = T(102232599134, --[[InventoryItemCompositeDef TearGasGrenade AdditionalHint]] "<bullet_point> Inflicts <em>Blinded</em>\n<bullet_point> Ranged attacks passing through gas become <em>grazing</em> hits\n<bullet_point> No damage\n<bullet_point> High mishap chance\n<bullet_point> Almost silent"),
	UnitStat = "Explosives",
	Cost = 1500,
	MinMishapChance = 2,
	MaxMishapChance = 30,
