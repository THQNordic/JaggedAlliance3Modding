...
SetpiecePrgs.ArcheologicalChickenMove2_Veinard = function(seed, state, TriggerUnits)
	local li = { id = "ArcheologicalChickenMove2_Veinard" }
	...
	prgdbg(li, 1, 3) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", LuckyVeinard, "Waypoint2_03", true, true, false, "", false, true, "", 1000)
end