...
SetpiecePrgs.SanatoriumOutbreak = function(seed, state, TriggerUnits)
	...
	prgdbg(li, 1, 61) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "Establishing Shot", InitialInfected, "InitialInfectedGoToFinal", true, false, false, "", false, false, "", 1000)
	...
	prgdbg(li, 1, 78) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_03, "CivQ_07_RunSpot", true, true, false, "Standing", false, false, "", 1000)
	...
	prgdbg(li, 1, 83) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_01, "Civ06_RunSpot", false, true, false, "Standing", false, false, "Run_RainHeavy", 1000)
	prgdbg(li, 1, 84) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_02, "CivQ_02_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 85) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_03, "CivQ_03_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	...
	prgdbg(li, 1, 89) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_07, "CivQ_07_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	...
	prgdbg(li, 1, 94) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_04, "Civ04_RunSpot", false, true, false, "Standing", false, false, "Run_RainHeavy", 1000)
	...
	prgdbg(li, 1, 97) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "AttackingGuard", InfectedQueue_04, "Infected_04HitGuard", true, false, false, "Standing", false, false, "", 1000)
	local _
	...
	prgdbg(li, 1, 102) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_01, "CivQ_07_RunSpot", false, false, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 103) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_02, "InfQ_02chase_CivQ06", true, false, false, "Standing", true, false, "", 1000)
	...
	prgdbg(li, 1, 106) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_04, "InfQ04_chase_CivQ08", true, false, false, "Standing", false, false, "", 1000)
	...
	prgdbg(li, 1, 110) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_06, "CivQ_03_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 111) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_02, "CivQ_03_RunSpot", true, false, false, "Standing", true, false, "", 1000)
	prgdbg(li, 1, 112) sprocall(SetpieceSleep.Exec, SetpieceSleep, state, rand, true, "", 4000)
	prgdbg(li, 1, 113) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_08, "Civ08_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 114) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_04, "Civ08_RunSpot", true, true, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 115) sprocall(SetpieceSleep.Exec, SetpieceSleep, state, rand, true, "", 7000)
	prgdbg(li, 1, 116) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", InfectedQueue_01, "Civ06_RunSpot", false, true, false, "Standing", false, false, "", 1000)
	prgdbg(li, 1, 117) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", QueueCiv_04, "CivQ_02_RunSpot", false, true, false, "Standing", false, false, "", 1000)
