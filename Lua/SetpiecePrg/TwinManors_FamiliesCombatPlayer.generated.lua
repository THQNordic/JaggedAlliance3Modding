...
SetpiecePrgs.TwinManors_FamiliesCombatPlayer = function(seed, state, TriggerUnits)
	local li = { id = "TwinManors_FamiliesCombatPlayer" }
	...
	prgdbg(li, 1, 10) sprocall(PrgPlayEffect.Exec, PrgPlayEffect, state, rand, true, "", {PlaceObj('PlayBanterEffect', {Banters = {"TwinManorsFinale_FamiliesCombatPlayer",},searchInMap = true,searchInMarker = false,}),})
