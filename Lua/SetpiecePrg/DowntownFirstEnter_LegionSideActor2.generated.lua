...
SetpiecePrgs.DowntownFirstEnter_LegionSideActor2 = function(seed, state, MainActor, TargetActor)
	...
	prgdbg(li, 1, 4) _, LegionSideActor1_GoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", MainActor, "LegionSideActor2_GoTo", true, true, false, "Standing", true, false, "")
	...
	prgdbg(li, 1, 9) _, LegionSideActor2_GoTo2 = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", MainActor, "LegionSideActor2_GoTo2", true, true, false, "Standing", true, false, "")
end