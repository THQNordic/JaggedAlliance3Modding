...
SetpiecePrgs.CirclesChickenMove2_Schliemann = function(seed, state, TriggerUnits)
	local li = { id = "CirclesChickenMove2_Schliemann" }
	...
	prgdbg(li, 1, 3) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", Schliemann, "chicken2", true, true, false, "", false, true, "")
end