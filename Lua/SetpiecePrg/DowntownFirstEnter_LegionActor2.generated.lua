...
SetpiecePrgs.DowntownFirstEnter_LegionActor2 = function(seed, state, MainActor, TargetActor)
	...
	prgdbg(li, 1, 4) _, LegionActor3MoveTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", MainActor, "LegionActor2MoveTo", true, true, false, "Crouch", true, false, "")
