...
SetpiecePrgs.GraveyardChickenMove3_Schliemann = function(seed, state, TriggerUnits)
	local li = { id = "GraveyardChickenMove3_Schliemann" }
	...
	prgdbg(li, 1, 3) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", Schliemann, "chicken3", true, true, false, "", false, true, "", 1000)
end