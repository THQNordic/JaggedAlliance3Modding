...
SetpiecePrgs.BeasIntro_BridgeRun = function(seed, state, TriggerUnits)
	local li = { id = "BeasIntro_BridgeRun" }
	local rand = BraidRandomCreate(seed or AsyncRand())
	local _, SP_BeastPort
	prgdbg(li, 1, 1) _, SP_BeastPort = sprocall(SetpieceTeleport.Exec, SetpieceTeleport, state, TriggerUnits, "SP_BeastPort", true)
