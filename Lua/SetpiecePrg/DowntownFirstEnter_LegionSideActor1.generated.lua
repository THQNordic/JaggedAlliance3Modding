...
SetpiecePrgs.DowntownFirstEnter_LegionSideActor1 = function(seed, state, MainActor, TargetActor)
	...
	prgdbg(li, 1, 4) _, LegionSideActor1_GoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", MainActor, "LegionSideActor1_GoTo", true, true, false, "Crouch", false, false, "")
