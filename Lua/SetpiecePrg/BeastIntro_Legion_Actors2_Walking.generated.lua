...
SetpiecePrgs.BeastIntro_Legion_Actors2_Walking = function(seed, state, TriggerUnits)
	...
	prgdbg(li, 1, 3) _, SP_Beast_LActor1_GoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", TriggerUnits, "SP_Beast_LActor2_GoTo_01", true, false, false, "Standing", true, false, "")
	prgdbg(li, 1, 4) sprocall(SetpieceSleep.Exec, SetpieceSleep, state, rand, true, "", 3000)
	local _
	prgdbg(li, 1, 5) _, SP_Beast_LActor1_GoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", TriggerUnits, "SP_Beast_LActor2_GoTo", true, false, false, "Standing", true, false, "")
end