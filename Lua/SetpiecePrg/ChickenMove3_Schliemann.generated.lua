...
SetpiecePrgs.ChickenMove3_Schliemann = function(seed, state, TriggerUnits)
	local li = { id = "ChickenMove3_Schliemann" }
	...
	prgdbg(li, 1, 3) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", Schliemann, "Waypoint3", true, true, false, "", false, true, "", 1000)
end