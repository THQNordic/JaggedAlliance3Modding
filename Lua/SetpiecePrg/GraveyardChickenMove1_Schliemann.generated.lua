...
SetpiecePrgs.GraveyardChickenMove1_Schliemann = function(seed, state, TriggerUnits)
	local li = { id = "GraveyardChickenMove1_Schliemann" }
	...
	prgdbg(li, 1, 3) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "", Schliemann, "chicken1", true, true, false, "", false, true, "", 1000)
end