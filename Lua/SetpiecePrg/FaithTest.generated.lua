...
SetpiecePrgs.FaithTest = function(seed, state)
	...
	prgdbg(li, 1, 6) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "Test", BunsandCLiff, "Dest01", true, false, false, "", false, false, "")
	prgdbg(li, 1, 7) sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, false, "Test", Fauda, "Dest02", true, true, false, "", false, false, "")
