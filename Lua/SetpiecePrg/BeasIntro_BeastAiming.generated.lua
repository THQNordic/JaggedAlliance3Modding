...
SetpiecePrgs.BeasIntro_BeastAiming = function(seed, state, TriggerUnits)
	...
	prgdbg(li, 1, 3) _, SP_BeastGoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", TriggerUnits, "SP_BeastGoTo_01", true, true, false, "Crouch", false, false, "")
	local _
	prgdbg(li, 1, 4) _, SP_BeastGoTo = sprocall(SetpieceGotoPosition.Exec, SetpieceGotoPosition, state, rand, true, "", TriggerUnits, "SP_BeastAim", true, false, false, "Crouch", true, false, "")
