...
DefineClass.InventoryItemProperties = {
	...
	properties = {
		...
		{ category = "General", id = "LargeItem", name = "Large", 
			editor = "bool", default = false, template = true, },
		...
		{ category = "General", id = "is_valuable", name = "Valuable Item (for VR only)", help = "Will check whether to play the ValuableItemFound VR", 
			editor = "bool", default = false, template = true, },
		...
		{ category = "General", id = "Cost", help = "How much this item costs to buy in $", 
