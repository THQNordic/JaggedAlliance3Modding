...
DefineClass.Larry_Clean = {
	...
	IsMercenary = true,
	Name = T(226963931566, --[[UnitDataCompositeDef Larry_Clean Name]] "Larry Roachburn"),
	Nick = T(585663232996, --[[UnitDataCompositeDef Larry_Clean Nick]] "Larry"),
	AllCapsNick = T(713622604085, --[[UnitDataCompositeDef Larry_Clean AllCapsNick]] "LARRY"),
	Affiliation = "Secret",
	HireStatus = "MIA",
	Bio = T(489792807692, --[[UnitDataCompositeDef Larry_Clean Bio]] "Explosives require a steady hand, and Larry's got some of the steadiest - most of the time. Although he has in the past struggled with bouts of chemical dependency, Larry's been clean and sober for two years now. His knowledge of pharmaceuticals comes in handy when administering first aid and his history of checking himself out of rehab whenever he liked has also made him good at sneaking around and picking locks. But Larry swears all that is behind him and we here at M.E.R.C. believe him!"),
	Nationality = "USA",
	Title = T(112796718025, --[[UnitDataCompositeDef Larry_Clean Title]] "Former Artist. Explosives Expert"),
	SalaryLv1 = 0,
	SalaryMaxLv = 0,
