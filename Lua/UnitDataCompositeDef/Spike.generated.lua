...
DefineClass.Spike = {
	...
	IsMercenary = true,
	Name = T(179009952002, --[[UnitDataCompositeDef Spike Name]] "Maj. Spike Scallion"),
	Nick = T(353222848335, --[[UnitDataCompositeDef Spike Nick]] "Spike"),
	AllCapsNick = T(419643289579, --[[UnitDataCompositeDef Spike AllCapsNick]] "SPIKE"),
	Affiliation = "Secret",
	Bio = T(380759971288, --[[UnitDataCompositeDef Spike Bio]] "Spike is revealed to be the Major, fighting against the Santiago Corporation after realizing the nature of their activities in Grand Chien. Originally being hired by them, the sequence of events that led to Spike abandoning his lengthy contract with the North Koreans and joining the Santiago Corporation are unknown."),
	Nationality = "USA",
	SalaryLv1 = 0,
	SalaryMaxLv = 0,
