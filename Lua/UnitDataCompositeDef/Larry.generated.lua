...
DefineClass.Larry = {
	...
	IsMercenary = true,
	Name = T(869169089971, --[[UnitDataCompositeDef Larry Name]] "Larry Roachburn"),
	Nick = T(753281095956, --[[UnitDataCompositeDef Larry Nick]] "Larry"),
	AllCapsNick = T(620838526188, --[[UnitDataCompositeDef Larry AllCapsNick]] "LARRY"),
	Affiliation = "Secret",
	HireStatus = "MIA",
	Bio = T(333869191425, --[[UnitDataCompositeDef Larry Bio]] "Explosives require a steady hand, and Larry's got some of the steadiest - most of the time. Although he has in the past struggled with bouts of chemical dependency, Larry's been clean and sober for two years now. His knowledge of pharmaceuticals comes in handy when administering first aid and his history of checking himself out of rehab whenever he liked has also made him good at sneaking around and picking locks. But Larry swears all that is behind him and we here at M.E.R.C. believe him!"),
	Nationality = "UnicornLand",
	Title = T(157807300841, --[[UnitDataCompositeDef Larry Title]] "Artist. Paints with mines"),
	SalaryLv1 = 0,
	SalaryMaxLv = 0,
