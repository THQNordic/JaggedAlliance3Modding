...
UndefineClass('GrimerPotentiallyInfected_Female')
DefineClass.GrimerPotentiallyInfected_Female = {
	__parents = { "UnitData" },
	...
	Name = T(177410803978, --[[UnitDataCompositeDef GrimerPotentiallyInfected_Female Name]] "Villager"),
	Randomization = true,
