...
DefineClass.WorkingGirl = {
	...
	Name = T(604442574361, --[[UnitDataCompositeDef WorkingGirl Name]] "Working Girl"),
	...
	AppearancesList = {
		PlaceObj('AppearanceWeight', {
			'Preset', "WorkingGirl01",
			'Weight', 25,
		}),
		PlaceObj('AppearanceWeight', {
			'Preset', "WorkingGirl02",
			'Weight', 25,
		}),
		PlaceObj('AppearanceWeight', {
			'Preset', "WorkingGirl03",
			'Weight', 25,
		}),
		PlaceObj('AppearanceWeight', {
			'Preset', "WorkingGirl04",
			'Weight', 25,
		}),
	},
	AdditionalGroups = {
		PlaceObj('AdditionalGroup', {
			'Name', "CivilianFemaleFlirty",
		}),
	},
	pollyvoice = "Kimberly",
	gender = "Female",
