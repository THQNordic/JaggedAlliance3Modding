...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Margins', box(3, 8, 0, 0),
			'MouseCursor', "UI/Cursors/Hand.tga",
			'Image', "UI/PDA/Chat/T_Call_Offer_Bar",
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
			'Id', "idThumb",
			...
			'MaxHeight', 22,
			'MouseCursor', "UI/Cursors/Hand.tga",
			'Image', "UI/PDA/Chat/T_Call_Offer_Slider",
		}),
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, enabled)
				...
				--self.idThumb:SetVisible(enabled)
			end,
		}),
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, ...)
				...
				local extra = ScaleXY(self.scale,  6, 0) -- half the thumb width
				self.interaction_box = box(x - extra, y, mx + extra, my)
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "SetScroll(self, scrollTo)",
			'func', function (self, scrollTo)
