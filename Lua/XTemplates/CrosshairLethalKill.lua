...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "SetLethalKillChance(self, chance, text)",
			'func', function (self, chance, text)
		...
		PlaceObj('XTemplateWindow', {
			...
			'Id', "idText",
			'VAlign', "center",
			'TextStyle', "CrosshairStealthKill",
			'Translate', true,
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'MaxWidth', 8,
				'MaxHeight', 4,
				'Background', RGBA(130, 128, 120, 102),
			}),
			PlaceObj('XTemplateWindow', {
				'MinWidth', 8,
				'MinHeight', 4,
