	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(207129590037, --[[XTemplate PDABrowserError Text]] "<title>"),
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				'Id', "ErrorDescription",
				...
				'Translate', true,
				'Text', T(260009954892, --[[XTemplate PDABrowserError Text]] "<text>"),
			}),
			PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(931613236873, --[[XTemplate PDABrowserError Text]] "<underline>Back</underline>"),
			}, {
				PlaceObj('XTemplateFunc', {
					'name', "Open",
					'func', function (self, ...)
