	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if sector then
					self.idSectorId:SetText(T{764093693143, "<SectorIdColored(id)>", id = sector.Id})
					self.idSectorSquare:SetBackground(GetSectorControlColor(sector.Side))
				end
				
				if context.quest and context.quest.preset then -- single quest
				...
				elseif context.quest and next(context.quest) then -- multiple quests
					self.idTitle:SetText(#context.quest > 1 and T(882126902415, "Multiple Quests") or context.quest[1].preset.DisplayName)
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(189800741094, --[[XTemplate RolloverQuests Text]] "<display_name>"),
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return parent.context end,
