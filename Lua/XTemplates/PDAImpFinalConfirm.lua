...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(818027610859, --[[XTemplate PDAImpFinalConfirm name]] "HeaderButtonId"),
	}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(767221303643, --[[XTemplate PDAImpFinalConfirm Text]] "Confirmation Page"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Padding', box(0, 0, 0, 0),
					...
					'Translate', true,
					'Text', T(709573996800, --[[XTemplate PDAImpFinalConfirm Text]] "We can offer you only 1 slot for a mercenary certificate.\nAre you sure this is your choice of mercenary?"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XContextFrame",
					'IdNode', false,
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(138806340028, --[[XTemplate PDAImpFinalConfirm Text]] "Go Back"),
							}, {
								PlaceObj('XTemplateFunc', {
									'name', "OnMouseButtonDown(self, pos, button)",
									'func', function (self, pos, button)
						...
						PlaceObj('XTemplateWindow', {
							...
							'MouseCursor', "UI/Cursors/Pda_Hand.tga",
							'OnContextUpdate', function (self, context, ...)
								self.idAnswer:SetText(T{160081380457, "Pay <money(cost)>", cost=const.Imp.CertificateCost})
