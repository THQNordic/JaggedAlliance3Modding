...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'OnLayoutComplete', function (self)
			...
			-- Detect when another button dies so the anchor can be overriden
			-- by this one. The order should be the spawn order.
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				self.parent.OnLayoutComplete = function()
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(488963413186, --[[XTemplate CombatLogButton Text]] "SNYPE"),
			}),
			}),
		}),
})
