...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return GetWeaponUpgrades(context) end,
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(602548457051, --[[XTemplate RolloverModifications Text]] "Modifications"),
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(440367422932, --[[XTemplate RolloverModifications Text]] "<DisplayName>"),
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XText",
								'Id', "idDescription",
								...
								'Translate', true,
								'Text', T(227814808041, --[[XTemplate RolloverModifications Text]] "<Description>"),
							}),
							}),
						}),
					}),
