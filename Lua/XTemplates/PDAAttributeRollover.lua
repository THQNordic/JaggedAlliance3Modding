		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if mods then
					if mods.studying and mods.studying > 0 then
						...
						boostRow.idStatValue:SetText(T{745254251351, "+<value>", value = Untranslated(mods.studying)})
					end
					if mods.training and mods.training > 0 then
						self.idBoosts:SetVisible(true)
						local boostRow = self.idStatTraining
						boostRow:SetVisible(true)
						boostRow.idStatValue:SetText(T{745254251351, "+<value>", value = Untranslated(mods.training)})
					end
					if mods.statGain and mods.statGain > 0 then
						self.idBoosts:SetVisible(true)
						local boostRow = self.idStatGain
						boostRow:SetVisible(true)
						boostRow.idStatValue:SetText(T{745254251351, "+<value>", value = Untranslated(mods.statGain)})
					end
				end
			end,
		}, {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateForEach', {
					'comment', "equiped item mod",
					'array', function (parent, context) return context:GetStatBoostItemMods(context.control:GetAttribute()) end,
					'run_after', function (child, context, item, i, n, last)
						child.idStatSource:SetText(item.display_text)
						child.idStatValue:SetText(T{745254251351, "+<value>", value = Untranslated(item.add)})
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Id', "idStatSource",
							'FoldWhenHidden', true,
							'TextStyle', "PDARolloverAdditional",
							'Translate', true,
							'HideOnEmpty', true,
						}),
						PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverAdditional",
						'Translate', true,
						'Text', T(393632423840, --[[XTemplate PDAAttributeRollover Text]] "Studying"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverAdditional",
						'Translate', true,
						'Text', T(383969792797, --[[XTemplate PDAAttributeRollover Text]] "Training"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverAdditional",
						'Translate', true,
						'Text', T(636384859066, --[[XTemplate PDAAttributeRollover Text]] "Field Experience"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
