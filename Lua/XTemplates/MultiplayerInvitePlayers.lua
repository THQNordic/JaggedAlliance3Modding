...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "SelectPlayer(self, element)",
			'func', function (self, element)
		...
		PlaceObj('XTemplateFunc', {
			'name', "InviteSelectedPlayer(self)",
			'func', function (self)
				if not self.selected_player or not netSwarmSocket then return end
		...
		PlaceObj('XTemplateFunc', {
			'name', "InvitePlayer(self,id, name)",
			'func', function (self,id, name)
				local err, game_id
				local game_type =  "CoOp"
				-- If going from a non-campaign game to one.
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(337390292096, --[[XTemplate MultiplayerInvitePlayers Text]] "Invite Player"),
			}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateForEach', {
						'array', function (parent, context) return netSwarmSocket and netSwarmSocket.chat_room_guests or empty_table end,
						'condition', function (parent, context, item, i) return item and #item > 2 and netDisplayName ~= item[2] end,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'Id', "idInviteCoOp",
						'DisabledBackground', RGBA(130, 128, 120, 255),
						'OnPress', function (self, gamepad)
							GetDialog(self):InviteSelectedPlayer()
						end,
						'Text', T(918753699044, --[[XTemplate MultiplayerInvitePlayers Text]] "Invite"),
					}),
					PlaceObj('XTemplateTemplate', {
						'comment', "close",
						'__template', "PDACommonButton",
						'OnPressEffect', "close",
						'Text', T(656402173271, --[[XTemplate MultiplayerInvitePlayers Text]] "Close"),
					}),
					}),
				}),
			}),
