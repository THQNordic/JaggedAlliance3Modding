	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnPress', function (self, gamepad)
				-- For operations with the inventory we need to use the established internal flow
				-- using GetSectorInventory and we can't use the objects we already have because
				-- of the ui. The data will sync back through the inventory-sentry thread
			...
			PlaceObj('XTemplateWindow', {
				...
				'VAlign', "top",
				'UseClipBox', false,
				'Image', "UI/Icons/SateliteView/icon_neutral",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Id', "idUpperIcon",
				...
				'VAlign', "center",
				'UseClipBox', false,
				'Image', "UI/Icons/SateliteView/sa_stash",
				'Columns', 3,
				'Column', 2,
			}),
			PlaceObj('XTemplateWindow', {
