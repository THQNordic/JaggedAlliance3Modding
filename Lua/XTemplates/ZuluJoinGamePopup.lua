...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'MinHeight', 25,
						'Background', RGBA(32, 35, 47, 255),
						'FocusedBorderColor', RGBA(32, 35, 47, 255),
						'FocusedBackground', RGBA(32, 35, 47, 255),
						'TextStyle', "TextInputHint",
						'OnTextChanged', function (self)
							if string.len(self:GetText()) > 50 then
								return-- do not allow of paste larger than 50 lines
							end
						end,
						'Multiline', false,
						'ConsoleKeyboardDescription', T(131295207467, --[[XTemplate ZuluJoinGamePopup ConsoleKeyboardDescription]] "Enter Game Code"),
						'MaxVisibleLines', 1,
						'MaxLines', 1,
						'MaxLen', 50,
						'AutoSelectAll', true,
						...
						PlaceObj('XTemplateFunc', {
							'name', "EditOperation(self, insert_text, op_type, setcursor_charidx, keep_selection)",
							'func', function (self, insert_text, op_type, setcursor_charidx, keep_selection)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idOk",
			'ActionName', T(978248601619, --[[XTemplate ZuluJoinGamePopup ActionName]] "Ok"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idPaste",
			'ActionName', T(667549065522, --[[XTemplate ZuluJoinGamePopup ActionName]] "Paste"),
			'ActionToolbar', "ActionBar",
			'ActionShortcut', "P",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idEnterText",
			'ActionName', T(364019189126, --[[XTemplate ZuluJoinGamePopup ActionName]] "Type Code"),
			'ActionToolbar', "ActionBar",
			'ActionShortcut', "Y",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idCancel",
			'ActionName', T(876832343501, --[[XTemplate ZuluJoinGamePopup ActionName]] "Cancel"),
			'ActionToolbar', "ActionBar",
