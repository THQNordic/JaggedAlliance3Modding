...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'comment', "table",
		'__condition', function (parent, context) return context.operation and context.operation.id=="TrainMercs" end,
		...
		PlaceObj('XTemplateWindow', {
			...
			'Id', "idTrainingHint",
			'HandleMouse', false,
			'TextStyle', "PDARolloverHeaderDark",
			'Translate', true,
			'Text', T(280247885791, --[[XTemplate SectorOperationTrainMercsDescritionUI Text]] "Sector Details"),
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XFrame",
			'VAlign', "top",
