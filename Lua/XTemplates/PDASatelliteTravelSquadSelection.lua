	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateForEach', {
				'array', function (parent, context) return GetPlayerMercSquads() end,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'RolloverText', T(314554616502, --[[XTemplate PDASatelliteTravelSquadSelection RolloverText]] "<u(Name)>"),
						'RolloverTitle', T(658387709843, --[[XTemplate PDASatelliteTravelSquadSelection RolloverTitle]] "<u(Name)>"),
						'LayoutMethod', "HList",
						'LayoutHSpacing', 5,
						'BorderColor', RGBA(0, 0, 0, 0),
						'Background', RGBA(0, 0, 0, 0),
						...
						'OnContextUpdate', function (self, context, ...)
							...
							if notTravelling then
							    ...
							    self.idLocation:SetText(T{857749023735, "<clr><u(sectorId)></color>", clr = color, sectorId = startSectorId})
							else
								local _, color = GetSectorControlColor(gv_Sectors[startSectorId].Side)
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(931625862646, --[[XTemplate PDASatelliteTravelSquadSelection Text]] "<u(Name)> [<u(SquadMemberCount())>]"),
							'TextVAlign', "center",
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
