...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'comment', "active quest change observer",
		...
		PlaceObj('XTemplateWindow', {
			'comment', "selected quest change observer",
		...
		PlaceObj('XTemplateWindow', {
			'comment', "read quest observer",
			'__context', function (parent, context) return "quest_read" end,
			'__class', "XContextWindow",
			'ContextUpdateOnOpen', true,
			'OnContextUpdate', function (self, context, ...)
				local node = self:ResolveId("node")
		...
		PlaceObj('XTemplateFunc', {
			'name', "UpdateStyle(self)",
			'func', function (self)
				local questPreset = self.context.questPreset
				local overrideCtx = SubContext(questPreset, {em = "<color EmStyleDark>"})
