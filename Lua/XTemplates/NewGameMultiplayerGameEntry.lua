	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'HandleKeyboard', false,
				'HandleMouse', false,
				'TextStyle', "MMMultiplayerGameName",
				'Text', "Game name",
				'WordWrap', false,
				'TextVAlign', "center",
			}),
			PlaceObj('XTemplateWindow', {
				...
				'HandleKeyboard', false,
				'HandleMouse', false,
				'TextStyle', "MMMultiplayerCampaignName",
				'Translate', true,
				'WordWrap', false,
				'TextVAlign', "center",
			}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'HandleKeyboard', false,
					'HandleMouse', false,
					'TextStyle', "MMMultiplayerModsTitle",
					'Translate', true,
					'Text', T(672091379875, --[[XTemplate NewGameMultiplayerGameEntry Text]] "Mods"),
					'WordWrap', false,
					'TextHAlign', "right",
					'TextVAlign', "bottom",
				}),
				PlaceObj('XTemplateWindow', {
					...
					'HandleKeyboard', false,
					'HandleMouse', false,
					'TextStyle', "MMMultiplayerModsCount",
					'WordWrap', false,
					'TextHAlign', "right",
					'TextVAlign', "center",
				}),
