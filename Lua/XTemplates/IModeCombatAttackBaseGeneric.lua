...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ExitAttackMode",
			'ActionName', T(727215168833, --[[XTemplate IModeCombatAttackBaseGeneric ActionName]] "Exit Attack Mode"),
			...
			'OnAction', function (self, host, source, ...)
				...
				if dlg.crosshair then
					dlg:RemoveCrosshair()
					if not IsKindOfClasses(dlg, "IModeCombatAttack", "IModeCombatMelee") then return end
				end
		...
		PlaceObj('XTemplateTemplate', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(247399428705, --[[XTemplate IModeCombatAttackBaseGeneric Text]] "CANCEL"),
					'TextHAlign', "center",
				}),
