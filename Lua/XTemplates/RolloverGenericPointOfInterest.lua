...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "PointOfInterestRolloverClass",
		'BorderWidth', 0,
		'MaxWidth', 400,
		'UseClipBox', false,
		...
		PlaceObj('XTemplateForEach', {
			'array', function (parent, context) return context.pois end,
			'condition', function (parent, context, item, i)
				return true
			end,
			'__context', function (parent, context, item, i, n) return { building = item, sector = context.sector } end,
		}, {
			PlaceObj('XTemplateWindow', {
