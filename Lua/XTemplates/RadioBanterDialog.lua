...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return not GetDialog("PDADialogSatellite") end,
			'__class', "XBlurRect",
			'BlurRadius', 10,
			'Desaturation', 150,
		}),
		PlaceObj('XTemplateWindow', {
			'comment', "tint",
			'Background', RGBA(52, 55, 61, 44),
		}),
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return not GetDialog("PDADialogSatellite") end,
			'__class', "XMovieBlackBars",
			'Dock', "box",
			...
			PlaceObj('XTemplateWindow', {
				...
				'__class', "XImage",
				'Dock', "box",
				'Image', "UI/Hud/sc_grid",
				'ImageFit', "stretch",
			}),
			PlaceObj('XTemplateWindow', {
				'comment', "frame",
				'__class', "XImage",
				'UIEffectModifierId', "RadioBanter",
				'HAlign', "center",
				'VAlign', "center",
				'Image', "UI/Hud/sc_frame",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__class', "XImage",
						'Image', "UI/Hud/T_HUD_ApPoints_Background",
						'ImageColor', RGBA(110, 162, 90, 255),
					}, {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "RadioBanterTimer",
						'Translate', true,
						'Text', T(896666701489, --[[XTemplate RadioBanterDialog Text]] "Sat-Com"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
						...
						'func', function (self)
							...
							self:CreateThread("update-timer", function()
								while self.window_state ~= "destroying" do
									...
									local h = (timerValue % (60 * 60 * 24)) / (60*60)
									if h < 10 then
										h = "0" .. tostring(h)
									end
									local m = (timerValue % (60 * 60)) / 60
									if m < 10 then
										m = "0" .. tostring(m)
									end
		...
		PlaceObj('XTemplateWindow', {
			...
			'DrawOnTop', true,
			'HandleMouse', false,
			'TextStyle', "PopupDescriptionTextWhite",
			'Translate', true,
		}),
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				self:CreateThread(function()
					Sleep(750)
					cameraTac.Rotate(90 * 60, 70000)
				end)
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "AnimatedClose(self)",
			'func', function (self)
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, shortcut, source, ...)
				if RealTime() - self.openedAt < self.skipDelay then return "break" end
