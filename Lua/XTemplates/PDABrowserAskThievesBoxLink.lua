...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'FocusedBackground', RGBA(255, 0, 0, 0),
		'TextStyle', "PDABrowserThievesBoxLinks",
		'Translate', true,
	}, {
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, ...)
				...
				self:SetTextStyle(HyperlinkVisited(GetPDABrowserDialog(), self:GetProperty("HyperlinkLinkId")) and
					"PDABrowserThievesBoxLinksVisited" or
