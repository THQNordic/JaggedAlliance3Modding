...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', nil, {
				PlaceObj('XTemplateWindow', {
					...
					'UseClipBox', false,
					'HandleMouse', false,
					'TextStyle', "InventoryToolbarButtonCenterShortcut",
					'Translate', true,
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XImage",
					'Id', "idBtnHoldShortcut",
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'HandleMouse', false,
				'TextStyle', "InventoryToolbarButtonCenter",
				'Translate', true,
			}),
			}),
		...
		PlaceObj('XTemplateFunc', {
			'name', "OnHoldButtonTick(self, i, shortcut)",
			'func', function (self, i, shortcut)
