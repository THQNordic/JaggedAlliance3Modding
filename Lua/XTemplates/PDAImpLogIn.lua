...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(216982902846, --[[XTemplate PDAImpLogIn name]] "HeaderButtonId"),
	}),
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if dlg.clicked_links["pswd"] then
					self.idText:SetText(T{298769192636, "Forgot your <style PDAIMPHyperLinkClickedSmall><hl><underline>password?</underline></h></style>", hl = hyperlink})
				else
					self.idText:SetText(T{123042917573, "Forgot your <style PDAIMPHyperLinkSmall><hl><underline>password?</underline></h></style>", hl = hyperlink})
				end
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(530712122173, --[[XTemplate PDAImpLogIn Text]] "Log In"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Id', "idError",
					...
					'Translate', true,
					'Text', T(835243801015, --[[XTemplate PDAImpLogIn Text]] "<GameColorI>Wrong password! Try again.</GameColorI>"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Margins', box(0, 16, 0, 0),
					...
					'TextStyle', "PDAIMPContentText",
					'Translate', true,
					'Text', T(330439391851, --[[XTemplate PDAImpLogIn Text]] "Enter your personal authorization code"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XFrame",
					'IdNode', false,
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAIMPContentTextSmall",
					'Translate', true,
				}, {
					PlaceObj('XTemplateFunc', {
