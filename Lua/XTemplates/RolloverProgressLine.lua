...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "ChangeColorState(self,  changed_props)",
			'func', function (self,  changed_props)
				local state
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(247685009197, --[[XTemplate RolloverProgressLine name]] "Bind to property"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "MaxProgress",
		'editor', "number",
		...
		'name', T(907882520381, --[[XTemplate RolloverProgressLine name]] "Max Progress"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "ReverseBar",
		'translate', false,
		...
		'name', T(663664214752, --[[XTemplate RolloverProgressLine name]] "Reverse bar"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "ReverseValue",
		'translate', false,
		...
		'name', T(698169979310, --[[XTemplate RolloverProgressLine name]] "Reverse value"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "PercentValue",
		'translate', false,
		...
		'name', T(497483875643, --[[XTemplate RolloverProgressLine name]] "Percent value"),
		'help', T(746558075214, --[[XTemplate RolloverProgressLine help]] "Show percent symbol"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "Centered",
		'translate', false,
		...
		'name', T(935834731350, --[[XTemplate RolloverProgressLine name]] "Centered"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "Text",
		'editor', "text",
		...
		'name', T(913518042563, --[[XTemplate RolloverProgressLine name]] "Text"),
	}),
})
