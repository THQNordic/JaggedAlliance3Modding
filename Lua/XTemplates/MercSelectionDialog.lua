...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return GetSquadsOnMap("refs") end,
						'__class', "SnappingScrollArea",
						'Id', "idMercRows",
						'IdNode', false,
						'Padding', box(15, 5, 15, 15),
						'MinWidth', 670,
						'MaxHeight', 590,
						'Clip', false,
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateForEach', {
											...
											PlaceObj('XTemplateTemplate', {
												...
												PlaceObj('XTemplateFunc', {
													'name', "CreateRolloverWindow(self, ...)",
													'func', function (self, ...)
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateAction', {
						'ActionId', "idSelectAction",
						'ActionName', T(965852386218, --[[XTemplate MercSelectionDialog ActionName]] "Select"),
					...
					PlaceObj('XTemplateAction', {
						...
						'ActionName', T(563060593643, --[[XTemplate MercSelectionDialog ActionName]] "Close"),
						'ActionToolbar', "ActionBar",
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, shortcut, source, ...)
				...
				if shortcut == "DPadLeft" or shortcut == "DPadRight" or shortcut == "DPadUp" or shortcut == "DPadDown" then
					...
					if not selectedSquad then return "break" end
					...
					if not selectedMerc then return "break" end
		...
		PlaceObj('XTemplateFunc', {
			'name', "ApplyGamepadSelection(self)",
			'func', function (self)
				local squadIdx, mercIdx = self:GetGamepadSelection()
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(844638853048, --[[XTemplate MercSelectionDialog name]] "Selected Merc Id"),
	}),
})
