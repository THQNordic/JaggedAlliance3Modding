...
PlaceObj('XTemplate', {
				...
				'func', function (self, ...)
					...
					if self.Horizontal then
						...
						if not self.layout_update then
							Msg(self.parent.Message) 
							if GetUIStyleGamepad() then
								self:PlayFX(self.FXPress, "start")
							end
							self.parent:OnValueChanged(self)
						end
					else
	...
	PlaceObj('XTemplateProperty', {
		...
		'editor', "text",
		'translate', false,
		'name', T(578064127425, --[[XTemplate PropNumber name]] "Message"),
		'help', T(315686640425, --[[XTemplate PropNumber help]] "Set message to be sent on value set."),
	}),
})
