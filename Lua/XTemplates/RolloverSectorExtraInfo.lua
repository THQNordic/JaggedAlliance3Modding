			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(631817613193, --[[XTemplate RolloverSectorExtraInfo Text]] "Available Operations:"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateForEach', {
						'array', function (parent, context) return GetOperationsInSector(context.sector.Id) end,
						'run_after', function (child, context, item, i, n, last)
							...
							if item.operation.id == "GatherIntel" and item.enabled and not context.sector.intel_discovered and context.sector.Intel then
								child:SetText(T{990131144686, "<em><display_name> (*)</em>", item.operation})
							end
						end,
					}, {
						PlaceObj('XTemplateWindow', {
