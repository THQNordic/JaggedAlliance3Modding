	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateTemplate', {
				...
				'OnContextUpdate', function (self, context, ...)
					self:SetText(T{836711100688, "<action_name> (<merc_name>)",action_name =  context.item.action_name or T(539507517622, "USE"),merc_name = context.unit.Nick})
					local enabled = self.enabled and (not context.item.UnitStat or context.unit[context.item.UnitStat]<100)
					enabled = enabled and (not context.item.onlyOnMap or g_Units[context.unit.session_id])
				...
				'OnPress', function (self, gamepad)
					...
					if not g_Combat or unit:UIHasAP(item.APCost * const.Scale.AP) then
						CreateRealTimeThread(function()
							local res = WaitQuestion(self.desktop, 
								T(684118311188, "Use Item"), 
								T{766869245085, "Do you want <merc_name> to use the <item_name>?",merc_name = context.unit.Nick, item_name = item.DisplayName})										
							if res=="ok" then	
				...
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return InventoryIsCombatMode() end,
					'__class', "XText",
					'Id', "text",
					...
					PlaceObj('XTemplateFunc', {
						...
						'func', function (self, rollover)
							local context = self.context
							if not InventoryIsCombatMode() then return end
							local unit = context.unit
			...
			PlaceObj('XTemplateTemplate', {
				...
				'Text', T(886263727249, --[[XTemplate InventoryContextMenu Text]] "GIVE"),
			}, {
				PlaceObj('XTemplateFunc', {
			...
			PlaceObj('XTemplateTemplate', {
				...
				'Text', T(333299723785, --[[XTemplate InventoryContextMenu Text]] "GIVE TO SQUAD"),
			}, {
				PlaceObj('XTemplateFunc', {
					'name', "OnShortcut(self, shortcut, source, ...)",
					'func', function (self, shortcut, source, ...)
			...
			PlaceObj('XTemplateTemplate', {
				'comment', "split and give to squad",
				'__condition', function (parent, context)
					if not IsKindOf(context.context, "SquadBag") or not IsKindOf(context.item, "InventoryStack") then
						return false
					end	
					local sector_id 
					local unit_squad = context.unit and context.unit.Squad 
					local	sector_id = gv_Squads[unit_squad].CurrentSector
					return #GetCurrentSectorPlayerSquads(sector_id) > 1 and not InventoryIsCombatMode() 
				end,
				'__template', "ContextMenuButton",
				'Id', "splitgiveToSquad",
				...
				'Text', T(920024662816, --[[XTemplate InventoryContextMenu Text]] "SPLIT & GIVE"),
			}, {
				PlaceObj('XTemplateFunc', {
					'name', "OnShortcut(self, shortcut, source, ...)",
					'func', function (self, shortcut, source, ...)
			...
			PlaceObj('XTemplateGroup', {
				'comment', "weapon",
				'__condition', function (parent, context) return  context and context.item:IsWeapon() and IsKindOf(context.item, "Firearm") end,
			}, {
				PlaceObj('XTemplateTemplate', {
					'comment', "modify weapon",
					'__template', "ContextMenuButton",
					'Id', "modify",
					'FocusOrder', point(1, 3),
					'RelativeFocusOrder', "new-line",
					'OnContextUpdate', function (self, context, ...)
					...
					'Text', T(588090355770, --[[XTemplate InventoryContextMenu Text]] "MODIFY"),
				}),
				PlaceObj('XTemplateTemplate', {
					'comment', "reload",
					'__template', "ContextMenuButton",
					'Id', "reload",
					'FocusOrder', point(1, 4),
					'RelativeFocusOrder', "new-line",
					'OnContextUpdate', function (self, context, ...)
						local unit = context.unit 
						local enabled = false
						local args = { weapon = context.item.class, pos =  context.context:GetItemPackedPos(context.item)} 								
						local action = CombatActions.Reload 
						local ap = action:GetAPCost(unit, args)
						if context.context:IsKindOf("UnitInventory") then -- disable for item containers
					...
					'Text', T(202847622393, --[[XTemplate InventoryContextMenu Text]] "RELOAD"),
				}, {
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return InventoryIsCombatMode() end,
						'__class', "XText",
				...
				PlaceObj('XTemplateTemplate', {
					'comment', "unload",
					'__condition', function (parent, context) return InventoryIsContainerOnSameSector(context) end,
					'__template', "ContextMenuButton",
					'Id', "unload",
					'FocusOrder', point(1, 5),
					'OnContextUpdate', function (self, context, ...)
						local item = context.item
						local unit = context.unit
					...
					'Text', T(642602107801, --[[XTemplate InventoryContextMenu Text]] "UNLOAD"),
				}, {
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return InventoryIsCombatMode() end,
						'__class', "XText",
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Text', T(260165467032, --[[XTemplate InventoryContextMenu Text]] "UNLOAD MOD"),
				}, {
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return InventoryIsCombatMode() end,
						'__class', "XText",
				...
				PlaceObj('XTemplateTemplate', {
					'comment', "unjam",
					'__condition', function (parent, context) return context and context.item:IsKindOfClasses("Firearm") and not context.item:IsCondition("Broken") and context.item.jammed end,
					'__template', "ContextMenuButton",
					'Id', "unjam",
					'FocusOrder', point(1, 6),
					'OnContextUpdate', function (self, context, ...)
					...
					'OnPress', function (self, gamepad)
						...
						local unit = context.unit
						local item = context.item
						local args = { weapon = item.class, item_id = item.id , pos =  context.context:GetItemPackedPos(context.item)}
					...
					'Text', T(461075645427, --[[XTemplate InventoryContextMenu Text]] "UNJAM"),
				}, {
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return InventoryIsCombatMode() end,
						'__class', "XText",
			...
			PlaceObj('XTemplateTemplate', {
				...
				'Text', T(737533224447, --[[XTemplate InventoryContextMenu Text]] "UNEQUIP"),
			}, {
				PlaceObj('XTemplateFunc', {
					'name', "OnShortcut(self, shortcut, source, ...)",
					'func', function (self, shortcut, source, ...)
			...
			PlaceObj('XTemplateGroup', {
				'comment', "stack",
				'__condition', function (parent, context) return context and context.item:IsKindOf("InventoryStack") end,
			}, {
				PlaceObj('XTemplateTemplate', {
					'comment', "split",
					...
					'OnContextUpdate', function (self, context, ...)
						...
						if hasSpace then
							self:SetText(T(614440672207, --[[XTemplate InventoryContextMenu Text]] "SPLIT"))
							self:SetEnabled(true)
						else
					...
					'Text', T(614440672207, --[[XTemplate InventoryContextMenu Text]] "SPLIT"),
				}),
				}),
			PlaceObj('XTemplateGroup', {
				'comment', "medicine",
				...
				PlaceObj('XTemplateGroup', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'OnPress', function (self, gamepad)
							...
							CreateRealTimeThread(function()
								...
								local scrapPrompt = CreateQuestionBox(
									...
									T(193228332373, "This action will destroy the item. Are you sure?"),
									T(689884995409, "Yes"), 
									T(782927325160, "No"))
						...
						'Text', T(575220930819, --[[XTemplate InventoryContextMenu Text]] "SALVAGE"),
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							'Margins', box(0, 0, 10, 0),
					...
					PlaceObj('XTemplateTemplate', {
						...
						'Text', T(826934867343, --[[XTemplate InventoryContextMenu Text]] "REFILL"),
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							'Margins', box(0, 0, 10, 0),
			...
			PlaceObj('XTemplateTemplate', {
				'comment', "equip",
				'__condition', function (parent, context) return InvContextMenuEquippable(context) end,
				'__template', "ContextMenuButton",
				'Id', "equip",
				'FocusOrder', point(1, 9),
				'OnPress', function (self, gamepad)
					local context = self:ResolveId("node").context
					context.slot_wnd:EquipItem(context.item)
				end,
				'Text', T(919083865056, --[[XTemplate InventoryContextMenu Text]] "EQUIP"),
			}, {
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return InventoryIsCombatMode() end,
					'__class', "XText",
			...
			PlaceObj('XTemplateTemplate', {
				...
				'OnPress', function (self, gamepad)
					...
					if context then context.slot_wnd:ClosePopup() end
				end,
				'Text', T(980665628283, --[[XTemplate InventoryContextMenu Text]] "COMBINE"),
			}, {
				PlaceObj('XTemplateFunc', {
					'name', "OnShortcut(self, shortcut, source, ...)",
					'func', function (self, shortcut, source, ...)
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "SatelliteContextMenuText",
					'Translate', true,
					'Text', T(667056736749, --[[XTemplate InventoryContextMenu Text]] "Combat"),
					'TextHAlign', "right",
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "Open(self)",
			...
			PlaceObj('XTemplateTemplate', {
				'comment', "scrap",
				'__condition', function (parent, context) return context and InventoryIsContainerOnSameSector(context) and context.item and context.item.ScrapParts and context.item.ScrapParts > 0 and context.item.object_class~="Medicine" end,
				'__template', "ContextMenuButton",
				'Id', "scrap",
				...
				'Text', T(486269126756, --[[XTemplate InventoryContextMenu Text]] "SCRAP"),
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Margins', box(0, 0, 10, 0),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateTemplate', {
					'comment', "compare",
					'__condition', function (parent, context) return next(GetSlotsToEquipItem(context.item)) and not IsKindOfClasses(context.context, "SectorStash", "ItemDropContainer") end,
					'__template', "ContextMenuButton",
					'Id', "compare",
					'FocusOrder', point(1, 10),
					'OnPress', function (self, gamepad)
					...
					'Text', T(647488663144, --[[XTemplate InventoryContextMenu Text]] "COMPARE"),
				}),
				}),
			PlaceObj('XTemplateTemplate', {
				'comment', "cashin",
				...
				'Text', T(251539285860, --[[XTemplate InventoryContextMenu Text]] "CASH IN"),
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Margins', box(0, 0, 10, 0),
			...
			PlaceObj('XTemplateTemplate', {
				...
				'Text', T(102695071847, --[[XTemplate InventoryContextMenu Text]] "CASH STACK"),
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Margins', box(0, 0, 10, 0),
			...
			PlaceObj('XTemplateTemplate', {
				'comment', "unpack",
				'__condition', function (parent, context) return InvContextMenuFilter(context, "ValuableItemContainer") end,
				'__template', "ContextMenuButton",
				'Id', "unpack",
				'FocusOrder', point(1, 11),
				'OnContextUpdate', function (self, context, ...)
					...
					local actionName = T(735979570064, "OPEN")
					if type(err) == "boolean" then
						self:SetText(actionName)
						self:SetEnabled(not err)
					elseif err then
				...
				'OnPress', function (self, gamepad)
					...
					NetSquadBagAction(unit, container, slot_name, item, false, "unpack", 0)
					PlayFX("Cashin", "start", item)
					context.slot_wnd:ClosePopup()
				end,
			}, {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(927307546934, --[[XTemplate InventoryContextMenu Text]] "Item Menu"),
				'TextVAlign', "center",
			}),
			}),
		PlaceObj('XTemplateFunc', {
