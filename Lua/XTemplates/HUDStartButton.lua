	...
	PlaceObj('XTemplateTemplate', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnPress', function (self, gamepad)
				...
				if node.idStartMenu then return end
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(892354137885, --[[XTemplate HUDStartButton Text]] "COMMAND"),
				'WordWrap', false,
				'TextHAlign', "center",
			}),
		...
		PlaceObj('XTemplateWindow', {
			...
			'Translate', true,
			'Text', T(979330466889, --[[XTemplate HUDStartButton Text]] "<ShortcutButton('GamepadOpenCommandMenu')>"),
		}),
		}),
})
