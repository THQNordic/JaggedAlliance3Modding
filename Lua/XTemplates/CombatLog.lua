...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return LogData end,
		'__class', "CombatLogWindow",
		'Id', "idCombatLog",
		'HAlign', "left",
		'VAlign', "top",
		'HandleMouse', true,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', nil, {
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(570152647072, --[[XTemplate CombatLog Text]] "SNYPE"),
						}),
						}),
					}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "CombatLogButtonInactive",
						'Translate', true,
						'Text', T(550523949729, --[[XTemplate CombatLog Text]] "Debug"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XTextButton",
						'Id', "idClose",
