	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				local function lIsStanceArrowEnabled(stance, stanceFrom)
				...
				if not diag.targeting_blackboard or not diag.targeting_blackboard.movement_avatar then return end
				...
				-- Check if stance currently set to is still enabled
				...
				--check if down can be performed
				...
				if GetKeepStanceOption(attacker) then
					...
					keepStanceText:SetText(T{595461566177, "<style PDARolloverText>[<ShortcutButton('MovementKeepStance')>]</style> Locked: Moving <stanceName>", stanceName = stanceName})
				else
			...
			PlaceObj('XTemplateWindow', {
				'comment', "rollover observer",
				'__context', function (parent, context) return "RolloverWin" end,
			...
			PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(672642461625, --[[XTemplate MovementAvatarRollover Text]] "STANCE"),
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XText",
								'Id', "idRightLabel",
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(406455992177, --[[XTemplate MovementAvatarRollover Text]] "Take less damage from attacks from the side of the cover."),
						}),
						}),
					}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'TextStyle', "UIDlgTitle",
								'Translate', true,
								'Text', T(445719955623, --[[XTemplate MovementAvatarRollover Text]] "COVER"),
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XText",
								'Id', "idRightLabel",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							'__context', function (parent, context) return "keep_stance_changed" end,
							'__class', "XText",
							'Id', "idShortcutKeepStance",
							'HAlign', "left",
							'UseClipBox', false,
							'TextStyle', "SatelliteContextMenuKeybind",
							'Translate', true,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'OnContextUpdate', function (self, context, ...)
							...
							self:SetText(T{567391043458, "<a> Move <b> Exit Movement Mode", a = a, b = b})
						end,
						'Translate', true,
						'WordWrap', false,
					}),
