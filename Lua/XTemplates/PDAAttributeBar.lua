...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'RolloverTemplate', "PDAAttributeRollover",
		...
		'OnContextUpdate', function (self, context, ...)
			if not self.Attribute then return end
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'MaxHeight', 8,
						'Visible', false,
						'Background', RGBA(42, 173, 228, 255),
					}),
					}),
				PlaceObj('XTemplateWindow', nil, {
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Id', "idNumber",
							'Margins', box(2, 0, 0, 0),
							'TextStyle', "PDABrowserTextLightBold",
							'Translate', true,
							'Text', T(978537317768, --[[XTemplate PDAAttributeBar Text]] "3"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XContextImage",
							'Id', "idChangeImage",
					...
					PlaceObj('XTemplateWindow', {
						'comment', "placeholder for case where it is 100 or 99 with increase",
						'LayoutMethod', "HList",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							...
							'TextStyle', "PDABrowserTextLightBold",
							'Translate', true,
							'Text', T(680431107320, --[[XTemplate PDAAttributeBar Text]] "99"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XImage",
							'Margins', box(2, 0, 0, 0),
