...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ExitMode",
			'ActionName', T(741395989540, --[[XTemplate IModeAIDebug ActionName]] "Exit Mode"),
		...
		PlaceObj('XTemplateWindow', {
			'__class', "XTextButton",
			'Margins', box(0, 0, 20, 20),
			'HAlign', "right",
			'VAlign', "bottom",
			'Background', RGBA(84, 74, 72, 255),
			'OnPressEffect', "action",
			'OnPressParam', "ExitMode",
			'TextStyle', "ActionBarButtonYellowBig",
			'Text', "Close",
		}),
		PlaceObj('XTemplateWindow', {
			...
			'MinWidth', 300,
			'MinHeight', 500,
			'Background', RGBA(52, 45, 41, 255),
			'HandleKeyboard', false,
			'ChildrenHandleMouse', false,
			'TextStyle', "CombatLogButtonActive",
		}),
		}),
})
