...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "WeaponComponentWindowClass",
		'IdNode', true,
		'HAlign', "left",
		'VAlign', "bottom",
		'UseClipBox', false,
			...
			PlaceObj('XTemplateWindow', {
				...
				'OnContextUpdate', function (self, context, ...)
					...
					if not noErr and err == "blocked" then
						errText = T{637344314280, "<newline><newline><BlockedByError(param)>", param = errParam}
					end
				...
				'FXPress', "WeaponModificationCategoryClick",
				...
				PlaceObj('XTemplateFunc', {
					'name', "CreateRolloverWindow(self, gamepad, context, pos)",
					'func', function (self, gamepad, context, pos)
						-- Allow only gamepad rollovers in gamepad mode when the choice popup is open
						local componentWnd = self:ResolveId("node")
						local modifyWeaponDlg = componentWnd and componentWnd:ResolveId("node")
						if modifyWeaponDlg and modifyWeaponDlg.idChoicePopup then
							if not gamepad and GetUIStyleGamepad() then return end
						end
