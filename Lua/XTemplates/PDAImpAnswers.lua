...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(363374219327, --[[XTemplate PDAImpAnswers name]] "HeaderButtonId"),
	}),
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				if context and context.question then
					...
					self.idQuestionTitle:SetText(T{319761572184, "Question <idx>", idx = context.question})
				end
			end,
		}, {
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateForEach', {
							'array', function (parent, context) return context and context.preset.answers end,
										...
										if toggled then
											if not prev then
												...
												if item_idx then
													...
													g_ImpTest.answers[#g_ImpTest.answers+1] = {id = preset_id, idx = self.idx}
												end
											end
											for i=1,#answers do
												if i~= self.idx then
