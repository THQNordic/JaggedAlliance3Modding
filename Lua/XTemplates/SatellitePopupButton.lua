...
PlaceObj('XTemplate', {
	__content = function (parent, context) return parent.idParent end,
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'HandleMouse', false,
				'TextStyle', "Satellite_MercList_PopupMember",
				'Translate', true,
				'Text', T(140375097334, --[[XTemplate SatellitePopupButton Text]] "<display_name>"),
			}),
			PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
			'Id', "idArrow",
			'Padding', box(0, 0, 15, 0),
			'HAlign', "right",
			'VAlign', "center",
			'UseClipBox', false,
			'Visible', false,
			'Image', "UI/Icons/arrow",
			'Columns', 2,
		}),
		PlaceObj('XTemplateFunc', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(650179990112, --[[XTemplate SatellitePopupButton name]] "Translate"),
		'help', T(388424695756, --[[XTemplate SatellitePopupButton help]] "Whether to translate the text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Text",
		...
		'name', T(698725388757, --[[XTemplate SatellitePopupButton name]] "Text"),
		'help', T(237322778424, --[[XTemplate SatellitePopupButton help]] "Button Text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Arrow",
		...
		'name', T(852092291608, --[[XTemplate SatellitePopupButton name]] "Arrow Icon"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Selected",
		...
		'name', T(302769111263, --[[XTemplate SatellitePopupButton name]] "Selected"),
		'help', T(602603338992, --[[XTemplate SatellitePopupButton help]] "Whether to use the selected style."),
	}),
})
