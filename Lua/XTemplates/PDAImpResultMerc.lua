				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(960500439279, --[[XTemplate PDAImpResultMerc Text]] "Personal perks 1/1"),
						}),
						PlaceObj('XTemplateWindow', {
							'Margins', box(72, 8, 72, 0),
							'LayoutMethod', "HList",
							'LayoutHSpacing', 46,
						}, {
							PlaceObj('XTemplateForEach', {
								'comment', "personal perks",
								'array', function (parent, context) return ImpGetPersonalPerks() end,
								...
								PlaceObj('XTemplateWindow', {
									...
									'OnContextUpdate', function (self, context, ...)
										...
										text:SetText(T{620340048482, "Personal perks <max>/1", max = perk and 1 or 0})
									...
									PlaceObj('XTemplateFunc', {
										...
										'func', function (self, pos, button)
											if button == "L" then
												...
												personal = personal.perk==self.perk and {} or {perk = self.perk}
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(747438157331, --[[XTemplate PDAImpResultMerc Text]] "Tactical perks 2/2"),
						}),
						PlaceObj('XTemplateWindow', {
							'Margins', box(72, 8, 72, 0),
							'LayoutMethod', "Grid",
							...
							PlaceObj('XTemplateForEach', {
								'array', function (parent, context) return Presets.CharacterEffectCompositeDef["Perk-Specialization"] end,
								'__context', function (parent, context, item, i, n) return context.unit_data end,
								'run_after', function (child, context, item, i, n, last)
								...
								PlaceObj('XTemplateWindow', {
									...
									'OnContextUpdate', function (self, context, ...)
										...
										local selected = self.perk==(tactical[1] and tactical[1].perk or "") or 
																	self.perk==(tactical[2] and tactical[2].perk or "")
										self.idimgPerk:SetTransparency(selected and 0 or 125)
										self.idimgPerk:SetDesaturation(selected and 0 or 255)
										self.idBack:SetTransparency(selected and 125 or 200)
										local text = self:ResolveId("node").idTacticalPerk
										text:SetText(T{540824911540, "Tactical perks <max>/2", max = #tactical})
										...
										'func', function (self, pos, button)
											if button == "L" then
												...
												elseif tactical[1] and tactical[2] then
													...
													tactical[2] = {perk = self.perk}
												elseif tactical[1] and not tactical[2] then
													tactical[2] = {perk = self.perk}
												else	
													tactical[1] = {perk = self.perk}
												end
