			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'RolloverTemplate', "RolloverGeneric",
						'RolloverAnchor', "center-top",
						'RolloverText', T(952592503809, --[[XTemplate SatelliteViewMapContextMenu RolloverText]] "Local Loyalty will affect Operation and service costs in the current Sector."),
						'RolloverOffset', box(10, 10, 10, 10),
						'RolloverTitle', T(836506718468, --[[XTemplate SatelliteViewMapContextMenu RolloverTitle]] "Loyalty"),
						'Id', "idLoyalty",
						'Margins', box(5, 0, 5, 0),
						'FoldWhenHidden', true,
						'TextStyle', "PDASectorInfo_Green",
