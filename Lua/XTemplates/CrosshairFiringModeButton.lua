...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "CrosshairCircleButton",
		'RolloverTemplate', "CombatActionRollover",
		'RolloverAnchorId', "idContainer",
		'RolloverOffset', box(20, 20, 20, 20),
		'HAlign', "left",
		'VAlign', "top",
		'UseClipBox', false,
		...
		'FXMouseIn', "CrosshairCircleButtonRollover",
		'FXPress', "CrosshairCircleButtonPress",
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, gamepad, context, pos)
				...
				if rollover then
					...
					rollover.SetBox = function(self, ...)
						oldFunc(self, ...)
						if not self.termUI then return end
						local anchor = self:GetAnchor()
						local x = self.box:minx()
						local onTheLeft = x < anchor:minx()
				
						local below = self.box:miny() > anchor:maxy()
						if below then onTheLeft = false end
		...
		PlaceObj('XTemplateWindow', {
			'Id', "idTextContainer",
			'Margins', box(0, 6, -15, 6),
			'Padding', box(4, 0, 20, 0),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'DrawOnTop', true,
				'Image', "UI/Hud/target_icon_circle",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Id', "idInner",
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'DrawOnTop', true,
				'Image', "UI/PDA/T_UnavailableOption",
