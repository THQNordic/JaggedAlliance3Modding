...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
			'Dock', "box",
			'Image', "UI/PDA/WEBSites/mortuary_background",
			'ImageFit', "stretch",
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'MaxWidth', 150,
					'MaxHeight', 100,
					'TextStyle', "PDAMortuaryBottomButton",
					'Translate', true,
					'Text', T(644249787339, --[[XTemplate PDABrowserMortuary Text]] "Send Flowers"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAMortuaryBottomButton",
					'Translate', true,
					'Text', T(516677551626, --[[XTemplate PDABrowserMortuary Text]] "Casket & Urn Collection"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAMortuaryBottomButton",
					'Translate', true,
					'Text', T(629738455462, --[[XTemplate PDABrowserMortuary Text]] "Cremation Services"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAMortuaryBottomButton",
					'Translate', true,
					'Text', T(129496128595, --[[XTemplate PDABrowserMortuary Text]] "Pre-Funeral Planing Services"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAMortuaryBottomButton",
					'Translate', true,
					'Text', T(269232160182, --[[XTemplate PDABrowserMortuary Text]] "Funeral Etiquette"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				}),
