...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return "travel_mode_changed" end,
		...
		PlaceObj('XTemplateWindow', {
			'comment', "sector info",
			'__context', function (parent, context) return g_SatelliteUI and g_SatelliteUI.travel_mode end,
			'__condition', function (parent, context) return context end,
			'__class', "XContextFrame",
			'HandleMouse', true,
			'Image', "UI/PDA/os_background",
			'FrameBox', box(2, 2, 56, 56),
			'ContextUpdateOnOpen', true,
			'OnContextUpdate', function (self, context, ...)
				local route = context.route
				if not route or not next(route) then return end
				...
				self.idSectorId:SetText(T{764093693143, "<SectorIdColored(id)>", id = destSector.Id})
				...
				if total.travelTime then
					...
					self.idTotalTime:SetValueText(T{647718470101, "<timeDuration(travelTime)>", total})
				...
				local startDestStr = T{555461885941, "<clrStart><SectorId(startId)></color> > <clrEnd><SectorId(endId)></color>",
				   clrStart = colorStart,
			...
			PlaceObj('XTemplateWindow', {
				...
				'FrameBox', box(2, 2, 37, 37),
			}, {
				PlaceObj('XTemplateWindow', {
					'Id', "idSectorSquare",
					'Margins', box(20, 0, 10, 1),
					'Dock', "left",
					'VAlign', "center",
					'MinWidth', 26,
				}, {
				...
				PlaceObj('XTemplateWindow', {
					...
					'FoldWhenHidden', true,
					'HandleMouse', false,
					'TextStyle', "PDASectorInfo_Sector",
					'Translate', true,
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'comment', "sector image",
				'__class', "XImage",
				'Id', "idSectorImage",
				'Margins', box(30, 10, 10, 5),
				'Dock', "top",
				'HAlign', "center",
				'MinWidth', 334,
				'MaxWidth', 334,
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'RolloverTemplate', "SquadRollover",
					'RolloverText', T(382336604236, --[[XTemplate PDASatelliteTravelPanel RolloverText]] "<u(Name)>"),
					'RolloverTitle', T(787181340357, --[[XTemplate PDASatelliteTravelPanel RolloverTitle]] "<u(Name)>"),
					'LayoutMethod', "HList",
					'LayoutHSpacing', 5,
					'HandleMouse', true,
					...
					PlaceObj('XTemplateTemplate', {
						'__template', "SatelliteIconCombined",
						'Id', "idLogo",
						'ScaleModifier', point(625, 625),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'Id', "idName",
						...
						'VAlign', "center",
						'FoldWhenHidden', true,
						'TextStyle', "PDASectorInfo_Yellow",
						'Translate', true,
						'Text', T(473906174896, --[[XTemplate PDASatelliteTravelPanel Text]] "<u(Name)> [<u(SquadMemberCount())>]"),
						'TextVAlign', "center",
					}),
					}),
				PlaceObj('XTemplateWindow', {
					...
					'Margins', box(0, 0, 8, 0),
					'Dock', "right",
					'Image', "UI/PDA/T_Icon_Play",
					'ImageColor', RGBA(215, 161, 87, 255),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'Padding', box(40, 0, 20, 0),
				'Dock', "top",
				'LayoutMethod', "VList",
			}, {
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'HAlign', "left",
						'TextStyle', "PDASectorInfo_Green_Large",
						'Translate', true,
						'Text', T(433123255268, --[[XTemplate PDASatelliteTravelPanel Text]] "ROUTE"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'Id', "idRouteStartDest",
						'HAlign', "right",
						'TextStyle', "PDASectorInfo_ValueLight_Large",
						'ContextUpdateOnOpen', true,
						'Translate', true,
					}),
					}),
				...
				PlaceObj('XTemplateWindow', {
					'__context', function (parent, context) return { t = Game.CampaignTime } end,
					'__class', "XNameValueText",
					'RolloverTemplate', "RolloverGeneric",
					'Id', "idArrivalTime",
					'Margins', box(0, 0, 0, -5),
					...
					'NameText', T(813357299773, --[[XTemplate PDASatelliteTravelPanel NameText]] "Arrival Time"),
					'TextStyle', "PDASectorInfo_ValueDark",
					'TextStyleRight', "PDASectorInfo_ValueLight",
				}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateForEach', {
							'comment', "travel time modifier",
							'condition', function (parent, context, item, i) return item.Category == "squad" end,
							'run_after', function (child, context, item, i, n, last)
								child:SetNameText(item.Text)
								child:SetValueText(T{516091070257, "<percentWithSign(val)>", val = item.Value})
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Toolbar', "TravelActionBar",
					'Show', "text",
					'ButtonTemplate', "PDACommonButton",
				}),
				PlaceObj('XTemplateAction', {
					'ActionId', "idClosePanel",
					'ActionName', T(647445591978, --[[XTemplate PDASatelliteTravelPanel ActionName]] "Cancel"),
					'ActionToolbar', "TravelActionBar",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateForEach', {
							...
							PlaceObj('XTemplateWindow', {
								'__class', "XText",
								'Margins', box(0, -2, 0, 5),
								'TextStyle', "PDASectorInfo_ValueRed",
								'Translate', true,
								'TextVAlign', "center",
							}),
							}),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'__class', "XText",
							'Margins', box(0, -2, 0, 5),
							'TextStyle', "PDASectorInfo_ValueLight",
							'Translate', true,
							'Text', T(905777769691, --[[XTemplate PDASatelliteTravelPanel Text]] "Shift + <image UI/Icons/left_click> Place Waypoint"),
							'TextVAlign', "center",
						}),
						}),
					}),
				PlaceObj('XTemplateForEach', {
					'comment', "route terrain type",
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'RolloverTemplate', "RolloverGeneric",
								'Id', "idTerrainType",
								'ValueText', T(185901378984, --[[XTemplate PDASatelliteTravelPanel ValueText]] "<timeDuration(travelTime)>"),
								'TextStyle', "PDASectorInfo_ValueLight",
								'TextStyleRight', "PDASectorInfo_ValueLight",
							}),
							PlaceObj('XTemplateForEach', {
								'comment', "travel time modifier",
								'array', function (parent, context) return context.travelTimeBreakdown end,
								'condition', function (parent, context, item, i) return item.Category == "sector" end,
								'run_after', function (child, context, item, i, n, last)
									child:SetNameText(item.Text)
									...
									if item.ValueType == "money" then
										...
										if cantAfford then
											child:SetValueText(T{544831255685, "<color PDACommonButtonRed><money(val)></color>", val = item.Value})
										else
											child:SetValueText(T{181698541846, "<money(val)>", val = item.Value})
										end
