...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'RolloverText', T(387236887162, --[[XTemplate NewGameJoinCode RolloverText]] "Copies the join code to the clipboard. Another player can use this code to join your game via the <em>Join by Code</em> option from the Multiplayer section in the Main Menu."),
		'RolloverOffset', box(25, 0, 0, 0),
		'RolloverTitle', T(261271998143, --[[XTemplate NewGameJoinCode RolloverTitle]] "Join Code"),
		'MinHeight', 64,
		'MaxHeight', 64,
		'LayoutMethod', "HList",
		...
		'OnContextUpdate', function (self, context, ...)
			self.idName:SetText(T{648952937285, "Join Code: <u(code)>", code = GetNetGameJoinCode()})
		end,
