	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'HandleMouse', false,
				'TextStyle', "InventoryToolbarButtonShortcut",
				'Translate', true,
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				...
				'UseClipBox', false,
				'HandleMouse', false,
				'TextStyle', "InventoryToolbarButton",
				'Translate', true,
			}),
			}),
			...
			'func', function (self, value)
				...
				if name then
					if self.action.OnShortcutUp then
						self.idBtnShortcut:SetText(T{385406869936, "<style InventoryToolbarButton>Hold</style> <name>", name = short_cut})
					else
						self.idBtnShortcut:SetText(short_cut)
					end	
				else
