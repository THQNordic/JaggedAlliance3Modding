	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return IsKindOf(context, "IModeCommonUnitControl") end,
					...
					PlaceObj('XTemplateTemplate', {
						...
						'OnPressParam', "actionToggleSatellite",
						'Text', T(154855056952, --[[XTemplate StartButtonContextMenu Text]] "Sat View"),
					}),
					PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'MaxHeight', 28,
						'OnPressEffect', "action",
						'OnPressParam', "actionOpenBrowser",
					}),
					PlaceObj('XTemplateTemplate', {
						'__template', "StartMenuNotesButton",
					}),
					PlaceObj('XTemplateWindow', {
						'comment', "separator line",
						'__class', "XFrame",
						'Margins', box(18, 5, 18, 6),
						'Image', "UI/PDA/separate_line_vertical",
						'FrameBox', box(5, 0, 5, 0),
						'SqueezeY', false,
					}, {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'MaxHeight', 28,
						'OnPressEffect', "action",
						'OnPressParam', "idSquadManagement",
					}),
					PlaceObj('XTemplateTemplate', {
						'__template', "ContextMenuButton",
						'MinHeight', 28,
						'MaxHeight', 28,
						'OnPressEffect', "action",
						'OnPressParam', "actionOpenCharacter",
					}),
					PlaceObj('XTemplateTemplate', {
						'__template', "ContextMenuButton",
						'MinHeight', 28,
					...
					PlaceObj('XTemplateTemplate', {
						...
						'MaxHeight', 28,
						'OnPressEffect', "action",
						'OnPressParam', "OpenHelp",
						'Text', T(587856262711, --[[XTemplate StartButtonContextMenu Text]] "Help Center"),
					}, {
						PlaceObj('XTemplateTemplate', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'MaxHeight', 28,
						'OnPressEffect', "action",
						'OnPressParam', "actionInGameMainMenu",
						'Text', T(186976597220, --[[XTemplate StartButtonContextMenu Text]] "Menu"),
					}),
					PlaceObj('XTemplateFunc', {
				...
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return IsKindOf(context, "XSatelliteDialog") end,
					'__class', "XContentTemplateList",
					'IdNode', false,
					'BorderWidth', 0,
					'Padding', box(0, 10, 0, 10),
				...
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return IsKindOf(context, "PDAClass") end,
					'__class', "XContentTemplateList",
					'IdNode', false,
					'BorderWidth', 0,
					'Padding', box(0, 10, 0, 10),
					...
					PlaceObj('XTemplateTemplate', {
						...
						'MouseCursor', "UI/Cursors/Pda_Hand.tga",
						'OnPressEffect', "action",
						'OnPressParam', "PDACloseOrBackTab",
						'Text', T(333111343721, --[[XTemplate StartButtonContextMenu Text]] "Back"),
					}, {
						PlaceObj('XTemplateCode', {
							'run', function (self, parent, context)
				...
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return context == GetDialog("FullscreenGameDialogs") end,
					'__class', "XContentTemplateList",
					'IdNode', false,
					'BorderWidth', 0,
					'Padding', box(0, 10, 0, 10),
				...
				PlaceObj('XTemplateFunc', {
					'comment', "link actions and buttons",
					'name', "ApplyButtonData(self)",
					'func', function (self)
						local popup = self:ResolveId("node")
						for i, b in ipairs(self[1]) do
							if not IsKindOf(b, "XTextButton") then goto continue end
							if b.OnPressEffect ~= "action" then goto continue end
							...
							if GetUIStyleGamepad() then
								...
								b.idBinding:SetText(T{818767796398, "[<key>] ", key = shortcut or ""})
							end
							...
							if not actionState then actionState = "enabled" end
							
							b:SetEnabled(actionState == "enabled")
							b:SetId(action.ActionId)
							
							b.OnPress = function(self)
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(954918167848, --[[XTemplate StartButtonContextMenu Text]] "<date()>"),
				}),
				PlaceObj('XTemplateWindow', {
