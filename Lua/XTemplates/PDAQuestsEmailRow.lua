		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if selected then
					...
					--self:SetRolloverBackground(RGBA(215, 159, 80, 255))
			...
			PlaceObj('XTemplateWindow', {
				...
				'MinWidth', 192,
				'MaxWidth', 192,
				'TextStyle', "PDAQuests_EmailSender",
				'ContextUpdateOnOpen', true,
				'OnContextUpdate', function (self, context, ...)
					local preset = Emails[context.id]
			...
			PlaceObj('XTemplateWindow', {
				...
				'MinWidth', 548,
				'MaxWidth', 548,
				'TextStyle', "PDAQuests_EmailTitle",
				'ContextUpdateOnOpen', true,
				'OnContextUpdate', function (self, context, ...)
					if context.read then
					...
					local preset = Emails[context.id]
					self:SetText(T{preset.title, context.context})
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(354457286355, --[[XTemplate PDAQuestsEmailRow Text]] "<EmailDate()>"),
				'WordWrap', false,
				'Shorten', true,
				'TextVAlign', "center",
			}),
