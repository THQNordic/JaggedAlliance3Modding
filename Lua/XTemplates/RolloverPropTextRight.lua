...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "SetBindTo(self, prop, prop_id)",
			'func', function (self, prop, prop_id)
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, context, prop_meta, value)
				if not prop_meta then return end
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				if unit then return unit.session_id end
		...
		PlaceObj('XTemplateWindow', {
			...
			'TextStyleRight', "PDABrowserTextHighlight",
		}),
		PlaceObj('XTemplateFunc', {
			'name', "Open(self,...)",
			'func', function (self,...)
				self.idPropVal:SetTextStyle("PDABrowserFlavorMedium")
				self.idPropVal:SetTextStyleRight("PDABrowserTextHighlight")--"PDAActivityDescriptionWounds")
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(177816837351, --[[XTemplate RolloverPropTextRight name]] "Reverse value"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "Text",
		'editor', "text",
		...
		'name', T(408976862738, --[[XTemplate RolloverPropTextRight name]] "Text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "Scroll",
		'id', "MaxProgress",
		...
		'name', T(867981954422, --[[XTemplate RolloverPropTextRight name]] "Max Progress"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "Scroll",
		'id', "PercentValue",
		...
		'name', T(150385534483, --[[XTemplate RolloverPropTextRight name]] "Percent value"),
		'help', T(631923950366, --[[XTemplate RolloverPropTextRight help]] "Show percent symbol"),
	}),
})
