...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'OnContextUpdate', function (self, context, ...)
			...
			-- Dont display conflict elements if the conflict dialog is open
			-- because the waiting state is kind of undefined there.
			local conflictDlg = GetDialog("SatelliteConflict")
			local conflictDlgOpen = conflictDlg and conflictDlg.window_state ~= "destroying"
			
			--self.idConflictText:SetVisible(inConflict)
			...
			local rolloverText = inConflict and T(716696128257, "Can't unpause at this time - an ongoing conflict requires your attention") or 
				T(953037675369, "Start/Pause Sat View time. Upcoming events can be seen in the timeline to the right")
				...
				if shouldHavePauseThread then
					...
					self:CreateThread("pause-blink", function()
						while self.window_state ~= "destroying" do
							...
							self.idTime:SetText(blinkOn and
								T(103382034079, "<dayNightIcon()> <style TimelineLabel_BlinkOn><time()></style> <day_name()>, <DateFormatted()>")
								or
		...
		PlaceObj('XTemplateWindow', {
			'__class', "XFrame",
			'Id', "idPausedFrame",
			'Margins', box(19, 0, 22, 4),
			'Dock', "box",
			'FadeInTime', 300,
			'FadeOutTime', 300,
			'Image', "UI/PDA/pause_border",
			'FrameBox', box(9, 9, 9, 9),
		}),
		PlaceObj('XTemplateWindow', {
			'comment', "cursor hint text",
			'Id', "idCursorHintText",
			'IdNode', true,
			...
			PlaceObj('XTemplateFunc', {
				'name', "DrawWindow(self, clip_box)",
				'func', function (self, clip_box)
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(404650097901, --[[XTemplate PDASatellite Text]] "Sat View"),
				'TextHAlign', "right",
			}),
			PlaceObj('XTemplateWindow', {
				'LayoutMethod', "HList",
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDARolloverText",
					'Translate', true,
					'Text', T(586207290890, --[[XTemplate PDASatellite Text]] "2km"),
				}),
				PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'__context', function (parent, context) return "ui_player_squads" end,
					'__class', "XContentTemplate",
					'IdNode', false,
					'LayoutMethod', "VList",
				}, {
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return GetGroupedSquads(false, false) end,
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self, ...)
								...
								-- For some reason the size of this changing doesn't affect the combat log button.
								local node = self:ResolveId("node")
					...
					PlaceObj('XTemplateFunc', {
						...
						'func', function (self)
							...
							-- Init will call SelectSquad before our override.
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(657654851208, --[[XTemplate PDASatellite Text]] "<ShortcutName('actionPrevSquad')>/<ShortcutName('actionNextSquad')> Previous/Next Squad"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'comment', "Tac view",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(779675776433, --[[XTemplate PDASatellite Text]] "<ShortcutButton('actionToggleSatellite')> Tactical View"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(624562623158, --[[XTemplate PDASatellite Text]] "<ShortcutButton('actionOpenCharacter')> Character Screen"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'comment', "Inventory",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(386416906518, --[[XTemplate PDASatellite Text]] "<ShortcutButton('idInventory')> Inventory"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(937883176892, --[[XTemplate PDASatellite Text]] "<ShortcutButton('', 'LeftTrigger-DPadUp')> Zoom In"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(365302771940, --[[XTemplate PDASatellite Text]] "<ShortcutButton('', 'LeftTrigger-DPadDown')> Zoom Out"),
							'WordWrap', false,
						}),
						}),
					}),
		...
		PlaceObj('XTemplateTemplate', {
			'__template', "PDASatelliteTravelPanel",
			'Id', "idTravelPanel",
		}),
		PlaceObj('XTemplateWindow', {
			'Padding', box(0, 6, 0, 0),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Id', "idConflictText",
					'Padding', box(40, 0, 40, 0),
					'HAlign', "center",
					'VAlign', "top",
					'Background', RGBA(191, 67, 77, 255),
					'TextStyle', "SatelliteMode",
					'Translate', true,
					'Text', T(997436410314, --[[XTemplate PDASatellite Text]] "CONFLICT"),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'Id', "idNormalMode",
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "SatelliteMode",
					'Translate', true,
					'Text', T(834405160995, --[[XTemplate PDASatellite Text]] "PAUSED"),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'Id', "idPausedIcon",
				...
				PlaceObj('XTemplateWindow', {
					...
					'MaxWidth', 20,
					'MaxHeight', 50,
					'Background', RGBA(195, 189, 172, 120),
				}),
				PlaceObj('XTemplateWindow', {
					'HAlign', "left",
					'VAlign', "top",
		...
		PlaceObj('XTemplateWindow', {
			...
			'Translate', true,
			'Text', T(582492723577, --[[XTemplate PDASatellite Text]] "CAN'T UNPAUSE DURING ONGOING CONFLICT"),
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XText",
			'Id', "idNoMercsText",
			...
			'TextStyle', "SatelliteRed",
			'Translate', true,
			'Text', T(299478088097, --[[XTemplate PDASatellite Text]] "CAN'T UNPAUSE - NO CURRENT MERC CONTRACTS"),
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XText",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(442467444132, --[[XTemplate PDASatellite Text]] "<dayNightIcon()> <time()> <day_name()>, <DateFormatted()>"),
						'UpdateTimeLimit', 150,
					}),
					PlaceObj('XTemplateWindow', {
						'Id', "idSpeedControls",
						...
						PlaceObj('XTemplateTemplate', {
							...
							'RolloverOffset', box(0, 0, 0, 45),
							'Id', "idPlay",
							'VAlign', "top",
							'MinHeight', 24,
							'MaxHeight', 24,
							'FXPress', "SpeedControl",
							'OnPress', function (self, gamepad)
								...
								if conflictSector then
									assert(CampaignPauseReasons["SatelliteConflict"])
									OpenSatelliteConflictDlg(conflictSector)
								end
							end,
							'Image', "UI/PDA/os_system_buttons_yellow",
							'CenterImage', "UI/PDA/T_Icon_Play",
							'CenterImageColorization', RGBA(52, 55, 61, 255),
						}),
						PlaceObj('XTemplateTemplate', {
							'__template', "PDASmallButton",
							'RolloverTemplate', "RolloverGeneric",
						...
						PlaceObj('XTemplateTemplate', {
							...
							'CenterImage', "UI/PDA/T_Icon_FastForward",
							'CenterImageColorization', RGBA(52, 55, 61, 255),
						}),
						PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__class', "SatelliteTimeline",
					}),
					PlaceObj('XTemplateWindow', {
						'comment', "start indicator flag",
						'__class', "XImage",
				...
				PlaceObj('XTemplateWindow', {
					'__class', "SatelliteTimelineIconBase",
					'Id', "idTimelineFutureEvent",
					'Margins', box(-18, -10, -25, 0),
					'HAlign', "right",
					'VAlign', "top",
				}, {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return Game end,
						'__class', "XText",
						'RolloverTemplate', "PDAMoneyRollover",
						'RolloverAnchor', "center-top",
						'RolloverText', T(196336798796, --[[XTemplate PDASatellite RolloverText]] "<placeholder>"),
						'RolloverOffset', box(0, 0, 0, 18),
						'RolloverTitle', T(988235259400, --[[XTemplate PDASatellite RolloverTitle]] "<placeholder>"),
						'Id', "idPredictedIncome",
						'HAlign', "center",
						'TextStyle', "TimelineLabel",
						'Translate', true,
						'Text', T(629107118633, --[[XTemplate PDASatellite Text]] "<money(Money)> <style TimelineLabelAccent><GetDailyMoneyChange()></style>"),
					}),
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return "gv_SatelliteView" end,
						'__template', "PDACommonButton",
						'RolloverTemplate', "RolloverGeneric",
						'RolloverAnchor', "center-top",
						'RolloverText', T(169477433361, --[[XTemplate PDASatellite RolloverText]] "You can assign mercs in this sector to different Operations like healing wounds, repairing items or training. Operations take time and often require additional resources in the sector."),
						'RolloverOffset', box(0, 0, 0, 45),
						'Id', "idOperationsBtn",
						'VAlign', "bottom",
						'MinHeight', 30,
						...
						'OnPressParam', "idOperations",
						'Text', T(835363512903, --[[XTemplate PDASatellite Text]] "OPERATIONS"),
					}, {
						PlaceObj('XTemplateCode', {
							'run', function (self, parent, context)
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'OnContextUpdate', function (self, context, ...)
					...
					if not mode then mode = "default" end
					for i, b in ipairs(self) do
						local selected = b.OnPressParam == mode
						b:SetSelected(selected)
					end
				...
				PlaceObj('XTemplateTemplate', {
					...
					'CenterImage', "UI/PDA/SatelliteFilters/Default",
				}),
				PlaceObj('XTemplateTemplate', {
					'__template', "PDAFilterSmallButton",
					'RolloverText', T(958800089413, --[[XTemplate PDASatellite RolloverText]] "Notes"),
					'RolloverOffset', box(0, 5, 15, 0),
					'Id', "idTasks",
					'OnPressParam', "quests",
					'OnPress', function (self, gamepad)
					...
					'CenterImage', "UI/PDA/SatelliteFilters/Quests",
				}),
				PlaceObj('XTemplateTemplate', {
					'__template', "PDAFilterSmallButton",
					'RolloverText', T(995776296311, --[[XTemplate PDASatellite RolloverText]] "Squads and Operations"),
					'RolloverOffset', box(0, 5, 15, 0),
					'Id', "idSquads",
					'OnPressParam', "squads",
					'OnPress', function (self, gamepad)
					...
					'CenterImage', "UI/PDA/SatelliteFilters/Squads",
				}),
				PlaceObj('XTemplateTemplate', {
					'__template', "PDAFilterSmallButton",
					'RolloverText', T(496606825348, --[[XTemplate PDASatellite RolloverText]] "Items & Stash"),
					'RolloverOffset', box(0, 5, 15, 0),
					'Id', "idStash",
					'OnPressParam', "stash",
					'OnPress', function (self, gamepad)
					...
					'CenterImage', "UI/PDA/SatelliteFilters/Stash",
				}),
				PlaceObj('XTemplateTemplate', {
					'__template', "PDAFilterSmallButton",
					'RolloverText', T(756927934064, --[[XTemplate PDASatellite RolloverText]] "Buildings"),
					'RolloverOffset', box(0, 5, 15, 0),
					'Id', "idBuildings",
					'OnPressParam', "buildings",
					'OnPress', function (self, gamepad)
						if not g_SatelliteUI then return end
						g_SatelliteUI:ToggleFilterMode(self.OnPressParam)
					end,
					'CenterImage', "UI/PDA/SatelliteFilters/Buildings",
				}),
				}),
			}),
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if not gv_DebugShowSatelliteAggro then return end
	...
	PlaceObj('XTemplateAction', {
		'ActionId', "idClose",
		'ActionName', T(986732433213, --[[XTemplate PDASatellite ActionName]] "CloseSatellite"),
		'ActionState', function (self, host)
			if CabinetInTravelMode() then return "disabled" end
			return "enabled"
		end,
		'OnAction', function (self, host, source, ...)
			if not CanCloseSatelliteView() then -- eat the click!
				return
			end
