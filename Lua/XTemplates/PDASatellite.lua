			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return GetGroupedSquads(false, false, true) end,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(937883176892, --[[XTemplate PDASatellite Text]] "<ShortcutButton('', 'LeftTrigger-DPadUp')> Max Zoom In"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(365302771940, --[[XTemplate PDASatellite Text]] "<ShortcutButton('', 'LeftTrigger-DPadDown')> Max Zoom Out"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
							...
							'TextStyle', "GamepadHint",
							'Translate', true,
							'Text', T(779675776433, --[[XTemplate PDASatellite Text]] "<ShortcutButton('actionOpenCharacter')> Character Screen"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XText",
