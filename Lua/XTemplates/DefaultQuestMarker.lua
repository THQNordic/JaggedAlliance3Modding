...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'comment', "combat observer",
			'__context', function (parent, context) return "CombatChanged" end,
			'__class', "XContextWindow",
		...
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return "VisibilityUpdate" end,
			'__class', "XContextWindow",
			'OnContextUpdate', function (self, context, ...)
				self.parent:UpdateVisibility()
			end,
		...
		PlaceObj('XTemplateWindow', {
			...
			'VAlign', "top",
			'UseClipBox', false,
			'Image', "UI/Hud/iw_quest",
		}),
		PlaceObj('XTemplateFunc', {
			'name', "SetLayoutSpace(self, space_x, space_y, space_width, space_height)",
			'func', function (self, space_x, space_y, space_width, space_height)
