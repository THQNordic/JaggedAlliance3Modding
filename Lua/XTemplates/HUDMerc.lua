...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "HUDMercClass",
		'RolloverTemplate', "PDAMercRollover",
		'RolloverAnchor', "right",
		'RolloverAnchorId', "idContent",
		'RolloverText', T(952760179338, --[[XTemplate HUDMerc RolloverText]] "<placeholder>"),
		'Margins', box(-8, 7, 0, 0),
		'HAlign', "left",
		'VAlign', "top",
		'LayoutMethod', "HList",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'DisabledBackground', RGBA(42, 43, 47, 255),
				...
				PlaceObj('XTemplateWindow', {
					'__context', function (parent, context) return context.session_id end,
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'BackgroundRectGlowColor', RGBA(230, 222, 202, 255),
						}, {
							PlaceObj('XTemplateWindow', {
								'__class', "XImage",
								'Id', "idStatIcon",
				...
				PlaceObj('XTemplateWindow', {
					'comment', "level up indicator",
					'__class', "XContextWindow",
					'RolloverTemplate', "RolloverGeneric",
					'RolloverAnchor', "right",
					'RolloverAnchorId', "idContent",
					'RolloverText', T(742027784972, --[[XTemplate HUDMerc RolloverText]] "Choose a level-up perk"),
					'RolloverOffset', box(30, 0, 0, 0),
					'RolloverTitle', T(846149633796, --[[XTemplate HUDMerc RolloverTitle]] "Level up"),
					'Id', "idLevelUp",
					'IdNode', true,
					'Margins', box(0, 0, 3, 0),
					'HAlign', "right",
					...
					'OnContextUpdate', function (self, context, ...)
						...
						if not enabled then haveLevelUp = false end
						if IsKindOfClasses(context, "Unit", "UnitData") and context:IsDead() then haveLevelUp = false end
						...
						if animationId and haveLevelUp ~= levelUpAnimationWasShown then
							if haveLevelUp and not levelUpAnimationWasShown then
								-- Animation: Shrink from grown while fading in (183012)
								local time = 500
			...
			PlaceObj('XTemplateTemplate', {
				'__condition', function (parent, context) return IsKindOf(context, "UnitProperties") and (context.team and context.team.control == "UI") or (gv_Squads[context.Squad] and gv_Squads[context.Squad].Side == "player1") end,
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'__class', "XFrame",
					'Margins', box(0, 0, 0, -5),
					'Image', "UI/PDA/os_portrait_selection_bottom",
					'FrameBox', box(5, 1, 5, 5),
					'SqueezeX', false,
					'SqueezeY', false,
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(512369062263, --[[XTemplate HUDMerc Text]] "<DisplayName>"),
						'WordWrap', false,
						'TextVAlign', "bottom",
					}),
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return "attached_talking_head" end,
						'__class', "XContextImage",
						'Id', "idRadioAnim",
						'HAlign', "center",
						'VAlign', "center",
						'Visible', false,
						'Image', "UI/Hud/radio_call_small",
						'Rows', 3,
						'Columns', 6,
						'Animate', true,
						'FPS', 15,
						...
						'OnContextUpdate', function (self, context, ...)
							...
							local haveTh = playingNow and type(playingNow.CustomLogic) == "table" and
												rawget(playingNow.CustomLogic, "merc_id") == merc
							if haveTh then
								haveTh = #g_ActiveBanters == 0 or not playingNow.SuppressAll
							end
