...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'comment', "bkg frame",
			'Background', RGBA(76, 130, 127, 255),
		}),
		PlaceObj('XTemplateWindow', {
			'Margins', box(55, 18, 0, 0),
			'HAlign', "left",
			'VAlign', "top",
			'LayoutMethod', "VList",
			'LayoutVSpacing', 20,
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Image', "UI/PDA/Quest/flavor_icon_01",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Image', "UI/PDA/Quest/flavor_icon_02",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Image', "UI/PDA/Quest/flavor_icon_03",
			}),
			}),
		PlaceObj('XTemplateWindow', {
			'comment', "content frame",
			'HAlign', "center",
			'VAlign', "center",
			'MinWidth', 1470,
			'MinHeight', 880,
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__class', "XImage",
						'Margins', box(0, 2, 0, 5),
						'Image', "UI/PDA/Quest/aim_tracker_logo",
						'ImageFit', "height",
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'Translate', true,
						'Text', T(283279957142, --[[XTemplate PDANotes Text]] "A.I.M. <valign bottom -1><style PDAQuests_HeaderSmall>TRACKER</style>"),
						'TextVAlign', "bottom",
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Margins', box(0, 0, 25, 2),
					'HAlign', "right",
					'VAlign', "bottom",
					'TextStyle', "PDAQuests_HeaderVersion",
					'Text', "V2.0C",
					'TextVAlign', "bottom",
				}),
				}),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(237294065940, --[[XTemplate PDANotes Text]] "File"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XTextButton",
							'Background', RGBA(0, 0, 0, 0),
							...
							'TextStyle', "PDAQuests_MenuItem",
							'Translate', true,
							'Text', T(924049884138, --[[XTemplate PDANotes Text]] "View"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XTextButton",
							'Id', "idAbout",
							...
							'TextStyle', "PDAQuests_MenuItem",
							'Translate', true,
							'Text', T(164209181738, --[[XTemplate PDANotes Text]] "About"),
						}),
						}),
					PlaceObj('XTemplateWindow', {
						'comment', "secured tracking",
						...
						PlaceObj('XTemplateWindow', {
							...
							'TextStyle', "PDAQuests_MenuItem",
							'Translate', true,
							'Text', T(672138345598, --[[XTemplate PDANotes Text]] "Secured Tracking"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XImage",
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									'__class', "XImage",
									'Image', "UI/PDA/Quest/flavor_icon_04",
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XImage",
									'Image', "UI/PDA/Quest/flavor_icon_05",
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XImage",
									'Image', "UI/PDA/Quest/flavor_icon_06",
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XImage",
									'Image', "UI/PDA/Quest/flavor_icon_07",
								}),
								}),
							}),
						PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							'comment', "tab buttons",
							'__context', function (parent, context) return "quests_tab_changed" end,
							...
							PlaceObj('XTemplateTemplate', {
								'__template', "PDAQuestsTabButton",
								'MouseCursor', "UI/Cursors/Pda_Hand.tga",
								'OnContextUpdate', function (self, context, ...)
									self.idUnread:SetVisible(GetAnyQuestUnread())
								end,
								'Text', T(887669003209, --[[XTemplate PDANotes Text]] "Notes"),
								'Image', "UI/PDA/Quest/tab_tasks",
							}, {
								PlaceObj('XTemplateTemplate', {
									'__template', "PDAQuestUnreadIndicator",
									'Margins', box(0, 0, 45, 20),
									'HAlign', "center",
									'MinWidth', 10,
									'MaxWidth', 10,
									'Visible', true,
							...
							PlaceObj('XTemplateTemplate', {
								...
								'OnContextUpdate', function (self, context, ...)
									...
									self.idUnread:SetVisible(unreadMails and #unreadMails > 0)
								end,
								'Text', T(134810804001, --[[XTemplate PDANotes Text]] "E-mail"),
							...
							PlaceObj('XTemplateTemplate', {
								'__template', "PDAQuestsTabButton",
								'MouseCursor', "UI/Cursors/Pda_Hand.tga",
								'Text', T(552219169558, --[[XTemplate PDANotes Text]] "History"),
								'Image', "UI/PDA/Quest/tab_history",
							}),
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(281386940388, --[[XTemplate PDANotes Text]] "<LeftTrigger> <RightTrigger> - Change category"),
							}),
							PlaceObj('XTemplateAction', {
								'ActionId', "idNextTabRight",
								'ActionGamepad', "RightTrigger",
								'OnAction', function (self, host, source, ...)
									local dlg = host.idContent
									local subContent = dlg.idSubContent
									if not subContent then return end
						...
						PlaceObj('XTemplateWindow', {
							...
							'HAlign', "right",
							'VAlign', "center",
							'Image', "UI/PDA/Quest/aim_tracker_logo_2",
						}),
						}),
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'HostInParent', true,
							'InitialMode', "tasks",
							'InternalModes', "tasks, email, history",
						}, {
							PlaceObj('XTemplateFunc', {
								'name', "OnDialogModeChange(self, ...)",
								'func', function (self, ...)
