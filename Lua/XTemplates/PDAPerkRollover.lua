...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "PDATermClarifyingRollover",
		'BorderWidth', 0,
		'LayoutMethod', "Box",
		'UseClipBox', false,
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				-- requirements
				if not control.ShowPerkRequirements then return end
				...
				if not perksDlg:CanUnlockPerk(context, perk) then
					...
					if context[perk.Stat] < perk.StatValue then
						...
						self.idStatText:SetText(T{358818089889, "Required <stat>", stat = statName})
						self.idStatValueText:SetText(T{481242531729, "<stat>", stat = perk.StatValue})
					end
					if perk.Tier == "Silver" and #context:GetPerksByStat(perk.Stat) < const.RequiredPerksForSilver then
						...
						self.idPerksText:SetText(T{295162270293, "Required <stat> Perks", stat = statName})
						self.idPerksValueText:SetText(T{227251647374, "<value>", value = const.RequiredPerksForSilver})
					elseif perk.Tier == "Gold" and #context:GetPerksByStat(perk.Stat) < const.RequiredPerksForGold then
						self.idPerksReq:SetVisible(true)
						self.idPerksText:SetText(T{295162270293, "Required <stat> Perks", stat = statName})
						self.idPerksValueText:SetText(T{227251647374, "<value>", value = const.RequiredPerksForGold})
					end
				end
			end,
		}, {
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return context and context.control and context.control.yellow end,
				'__class', "XFrame",
				'Id', "idYellowBackground",
				'IdNode', false,
				'Margins', box(-7, -5, -7, -7),
				'Dock', "box",
				'LayoutMethod', "VList",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Id', "idStatText",
						'FoldWhenHidden', true,
						'TextStyle', "PDARolloverRequirements",
						'Translate', true,
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverRequirements",
						'Translate', true,
						'Text', T(946936053464, --[[XTemplate PDAPerkRollover Text]] "2"),
						'HideOnEmpty', true,
						'TextHAlign', "right",
					}),
					}),
