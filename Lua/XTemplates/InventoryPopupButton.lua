...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'HandleMouse', false,
				'TextStyle', "InventoryActionsText",
				'Translate', true,
				'Text', T(975999935851, --[[XTemplate InventoryPopupButton Text]] "<display_name>"),
			}),
			}),
		PlaceObj('XTemplateWindow', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(263940886905, --[[XTemplate InventoryPopupButton name]] "Translate"),
		'help', T(187378468427, --[[XTemplate InventoryPopupButton help]] "Whether to translate the text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Text",
		...
		'name', T(118055494822, --[[XTemplate InventoryPopupButton name]] "Text"),
		'help', T(758649721820, --[[XTemplate InventoryPopupButton help]] "Button Text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Selected",
		...
		'name', T(919280735506, --[[XTemplate InventoryPopupButton name]] "Selected"),
		'help', T(933411012014, --[[XTemplate InventoryPopupButton help]] "Whether to use the selected style."),
	}),
})
