	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, rollover)
				...
				--self.idMerc:SetBackgroundRectGlowColor(selected and selectedColored or noClr)
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return context.merc and context.merc.class ~= "empty" and context.merc.class ~= "free_space" end,
			'__class', "XContextWindow",
			'RolloverText', T(738623694504, --[[XTemplate OperationMerc RolloverText]] "<placeholder>"),
			'Id', "idContent",
			'LayoutMethod', "VList",
			'HandleMouse', true,
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if IsMerc(gv_UnitData[merc.class]) then					
					...
					if stat then
						...
						local stat_name = prop_meta.name--GetStatAllCapsName(prop_meta.id)
						...
						node.idStatVal:SetEnabled(false)
						node.idStat:SetEnabled(false)
						node.idStat:SetVisible(false)
						node.idStatVal:SetVisible(false)
					end
				end
				...
				if prof=="Student" then
					...
					if t_stat<=merc[stat] or merc[stat]>max_stat then
						...
						node.idAddIconImg:SetContext({Description = T(602903443457, "Too Skilled")})
					...
					node.idWounds:SetContext({DisplayName = T(508854975168, "Learning"), Description = T(201575967168, "Students learn faster the greater the difference between teacher's and students stats is")})
					node.idWounds:SetImage(icon)		
					node.idWounds:SetImageColor(GameColors.J)					
					node.idWounds:SetHAlign("right")
					--node.idWounds:SetRolloverTemplate("")
				end
				if merc.prof=="Militia" then
					...
					node.idAddIconImg:SetContext({DisplayName = unit_def.Name, Description = ""})
					node.idAddIconImg:SetImage(icon)		
					node.idAddIcon:SetHAlign("right")
					node.idAddIcon:SetRolloverText(unit_def.Name)
					node.idStat:SetVisible(false)
					node.idCountIcon:SetVisible(merc.count>1)
				...
				if operation_id=="RAndR" then
					...
					if merc:HasStatusEffect("Wounded")  then
						...
						if count>0 then
							...
							node.idWounds:SetRolloverText(T{effect.Description, effect})
						end
					end
				end
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'ImageColor', RGBA(218, 104, 8, 255),
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XContextImage",
								'RolloverTemplate', "RolloverGenericOperation",
								'RolloverText', T(295550387427, --[[XTemplate OperationMerc RolloverText]] "<Description>"),
								'RolloverTitle', T(738866002832, --[[XTemplate OperationMerc RolloverTitle]] "<DisplayName>"),
								'Id', "idWounds",
								'IdNode', false,
								'Padding', box(2, 2, 2, 2),
								'HAlign', "right",
								...
								'HandleMouse', true,
								'Image', "UI/Hud/Status effects/wounded",
								...
								PlaceObj('XTemplateWindow', {
									...
									'VAlign', "top",
									'FoldWhenHidden', true,
									'TextStyle', "PDAActivityDescriptionWounds",
									'TextHAlign', "right",
								}),
								}),
							}),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							'__context', function (parent, context) return gv_UnitData[context.merc.class] or g_Classes[context.merc.class] end,
							'__class', "XText",
							'Id', "idName",
							'Margins', box(2, 0, 0, 0),
							'HAlign', "left",
							...
							'TextStyle', "PDAActivityMercNameCard_Light",
							'Translate', true,
							'Text', T(581954270351, --[[XTemplate OperationMerc Text]] "<Nick>"),
							'WordWrap', false,
							'Shorten', true,
							'TextVAlign', "bottom",
						}),
						PlaceObj('XTemplateWindow', {
							...
							'OnContextUpdate', function (self, context, ...)
								...
								progress = max>0 and MulDivRound(operation:ProgressCurrent(merc, sector,  "Patient") or 0, 100, max)
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(329015606733, --[[XTemplate OperationMerc Text]] "x8"),
						}),
						}),
					}),
				}),
			PlaceObj('XTemplateWindow', {
				'__context', function (parent, context) return gv_UnitData[context.merc.class] end,
				'__class', "XText",
				'Id', "idText",
				'Margins', box(2, 0, 0, 0),
				'HAlign', "center",
				...
				'HandleMouse', false,
				'ChildrenHandleMouse', false,
				'TextStyle', "PDAActivityMercNameCard_Text",
				'Translate', true,
				'HideOnEmpty', true,
				'TextHAlign', "center",
				'TextVAlign', "bottom",
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return next(context) and context.merc.class == "empty" and context.merc.prof == "Militia" end,
			'__class', "XContextWindow",
			'RolloverText', T(738623694504, --[[XTemplate OperationMerc RolloverText]] "<placeholder>"),
			'Id', "idContent",
			'HandleMouse', true,
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return context.merc.class == "empty" and context.merc.prof ~= "Militia" end,
			'__class', "XContextWindow",
			'RolloverText', T(738623694504, --[[XTemplate OperationMerc RolloverText]] "<placeholder>"),
			'Id', "idContent",
			'Margins', box(0, 0, 0, 28),
			'HandleMouse', true,
		}, {
			PlaceObj('XTemplateWindow', {
				'Id', "idEmptyBack",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'HAlign', "center",
						'VAlign', "center",
						'Image', "UI/PDA/T_Icon_Plus_Large",
						'ImageScale', point(600, 600),
						'ImageColor', RGBA(75, 80, 89, 255),
					}),
					}),
				}),
			}),
