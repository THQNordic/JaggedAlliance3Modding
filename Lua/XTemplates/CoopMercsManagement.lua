...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, ...)
				...
				CreateRealTimeThread(function()
					if GetDialog("InGameMenu") then self:SetVisible(false) end
					while GetDialog("InGameMenu") do Sleep(10) end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idGive",
			'ActionName', T(347076926373, --[[XTemplate CoopMercsManagement ActionName]] "Give"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idTake",
			'ActionName', T(273444338004, --[[XTemplate CoopMercsManagement ActionName]] "Take"),
			'ActionToolbar', "ActionBarCenter",
			'ActionShortcut', "Insert",
			'ActionGamepad', "ButtonY",
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idClose",
			'ActionName', T(749856723587, --[[XTemplate CoopMercsManagement ActionName]] "Close"),
			'ActionToolbar', "ActionBarCenter",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				'Id', "idTitle",
				'Margins', box(14, 5, 0, 0),
				'TextStyle', "PDAActivitiesSubTitleDark",
				'Translate', true,
				'Text', T(420527131948, --[[XTemplate CoopMercsManagement Text]] "Mercs Control"),
			}),
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return NetIsHost() end,
				'__class', "XText",
				'Id', "idControlText",
				'Margins', box(0, 7, 14, 0),
				'HAlign', "right",
			...
			PlaceObj('XTemplateWindow', {
				...
				'TextStyle', "CombatTask_MercName",
				'Translate', true,
				'Text', T(775562201682, --[[XTemplate CoopMercsManagement Text]] "Mercs you can control "),
			}),
			PlaceObj('XTemplateWindow', {
				'__context', function (parent, context) return GetSquadCoopManagementSquads() end,
				'__class', "XContentTemplate",
				'Id', "idContent",
				'Margins', box(14, 40, 14, 40),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateForEach', {
							...
							'run_after', function (child, context, item, i, n, last)
								...
								child.idSector:SetText(T{764093693143, "<SectorIdColored(id)>", id = sector})
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateForEach', {
										'map', function (parent, context, array, i)
											if not array then return "empty" end
										...
										PlaceObj('XTemplateTemplate', {
											'__condition', function (parent, context) return context ~= "empty" end,
											'__template', "HUDMerc",
											'Margins', box(0, 7, 0, 0),
											...
											PlaceObj('XTemplateFunc', {
												...
												'func', function (self, pos, button)
													if not NetIsHost() then return end
										...
										PlaceObj('XTemplateWindow', {
											'__condition', function (parent, context) return context== "empty" end,
											'__class', "XContextWindow",
											'RolloverText', T(144072081433, --[[XTemplate CoopMercsManagement RolloverText]] "<placeholder>"),
											'IdNode', true,
											'Margins', box(5, 0, 5, 0),
										}, {
											PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'HAlign', "left",
					'VAlign', "bottom",
					'TextStyle', "PDASectorInfo_Section",
					'Translate', true,
					'Text', T(146497207387, --[[XTemplate CoopMercsManagement Text]] "<style UIDlgTitleLogo>[<left_click>x2]</style>Give/Take Merc"),
				}, {
					PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(604117134370, --[[XTemplate CoopMercsManagement Text]] "Waiting on <u(GetOtherPlayerNameFormat())> to make a decision"),
				}),
				PlaceObj('XTemplateTemplate', {
					'__condition', function (parent, context) return NetIsHost() end,
					'__template', "InventoryActionBarCenter",
					'Margins', box(0, 0, 0, -5),
					'Dock', false,
					'HAlign', "right",
					'VAlign', "bottom",
					'OnLayoutComplete', function (self)
						...
						for _, btn in ipairs(list) do
							...
							btn.idBtnShortcut:SetText(T{302963337924, "[<actionShortcut>]", actionShortcut = GetShortcutButtonT(buttonAction) })
