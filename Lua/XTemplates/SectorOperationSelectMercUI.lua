...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return GetOperationMercsListContext(context, GetActionsHost(parent, true).mode_param) end,
						...
						PlaceObj('XTemplateForEach', {
							...
							'run_after', function (child, context, item, i, n, last)
								...
								if n~=1 then
									...
									local time = 0
									if next(mercs) then
										time = GetOperationTimeLeft(mercs[1], operation_id, {mercs = mercs ,prediction = true, all =true})
									end	
									if time<0 then time=0 end
									title = title.. T{818535186344, "<right><GameColorF><image UI/SectorOperations/T_Icon_Activity_Resting 1500 130 128 120><timeDuration(time)>",  time= time}
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'OnContextUpdate', function (self, context, ...)
										...
										self.idNotAvailableMercs:SetText(T(896654085057, --[[XTemplate SectorOperationSelectMercUI Text]] "Аll mercs are assigned to other Operations. "))
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateForEach', {
												...
												'run_after', function (child, context, item, i, n, last)
													...
													local to_add_mercs = #GetOperationMercsListContext(dlg_context,SubContext(context, {assign_merc = true, profession= context.list_as_prof}))[1].mercs
													...
													PlaceObj('XTemplateFunc', {
														...
														'func', function (self, pos, button)
															...
															if merc.class == "empty" then
																...
																local context = {sector = host.context, assign_merc = true, operation = operation, profession = merc.prof, operation_slot_idx = self.slot_idx, other_free_slots = other_free_slots, selected = {}}
									...
									PlaceObj('XTemplateWindow', {
										'comment', "no mercs text",
										'__class', "XText",
										'Id', "idNotAvailableMercs",
										'Margins', box(0, 180, 0, 0),
										'HAlign', "left",
										'VAlign', "bottom",
										'LayoutMethod', "HList",
										'FoldWhenHidden', true,
										...
										'Translate', true,
										'Text', T(896654085057, --[[XTemplate SectorOperationSelectMercUI Text]] "Аll mercs are assigned to other Operations. "),
										'TextVAlign', "bottom",
									}),
									}),
								}),
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'TextStyle', "PDAActivitiesSubTitleDark",
											'Translate', true,
											'Text', T(931984554766, --[[XTemplate SectorOperationSelectMercUI Text]] "Active Militia"),
											'HideOnEmpty', true,
											'TextVAlign', "center",
										}),
										PlaceObj('XTemplateWindow', {
											...
											'TextStyle', "PDAActivitiesSubTitleDark",
											'Translate', true,
											'Text', T(355331223587, --[[XTemplate SectorOperationSelectMercUI Text]] "In Training"),
											'HideOnEmpty', true,
											'TextVAlign', "center",
										}),
										}),
