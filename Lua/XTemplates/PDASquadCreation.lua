		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(302893776540, --[[XTemplate PDASquadCreation Text]] "SQUAD LOGO"),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'__class', "XFrame",
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateForEach', {
								'array', function (parent, context) return g_SquadLogos end,
								'item_in_context', "logoImagePath",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'MaxWidth', 84,
										'MaxHeight', 96,
										'BorderColor', RGBA(195, 189, 172, 255),
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateAction', {
							'ActionId', "idClose",
							'ActionName', T(217933113825, --[[XTemplate PDASquadCreation ActionName]] "Close"),
