...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(781809329109, --[[XTemplate PDAImpGallery name]] "HeaderButtonId"),
	}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(361347984095, --[[XTemplate PDAImpGallery Text]] "GALLERY"),
				}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateForEach', {
						'array', function (parent, context) return {1,2,3,4,5,6,7,8} end,
						'run_after', function (child, context, item, i, n, last)
							...
							child.idImageSize:SetText(T{254295447571, "<size>KB", size = randomSize})
						...
						PlaceObj('XTemplateWindow', {
							...
							'OnPress', function (self, gamepad)
								...
								local mercWindow = XTemplateSpawn("PDAImpGalleryBig", popupHost, {name = self.name, name_big = self.name_big, size = self.size})
								mercWindow:Open()
							end,
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "PDAIMPGalleryBottom",
					'Translate', true,
					'Text', T(509636760606, --[[XTemplate PDAImpGallery Text]] "Last updated Fri, Jan 21:39:09 2001"),
				}),
				}),
			}),
		}),
