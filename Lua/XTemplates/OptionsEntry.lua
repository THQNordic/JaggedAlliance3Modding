...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__condition', function (parent, context) return context.prop_meta.separator and (context.prop_meta.category == "Keybindings" or context.prop_meta.category == "Mod") end,
