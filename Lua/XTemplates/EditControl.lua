...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateFunc', {
				'comment', "spawn and setup an Edit control",
				'name', "Open",
				'func', function (self, ...)
					...
					edit_ctrl.OnSetFocus = function(this, ...)
					...
					edit_ctrl.OnKillFocus = function(this, ...)
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(638591891287, --[[XTemplate EditControl name]] "Focused Text"),
		'help', T(201250189360, --[[XTemplate EditControl help]] "Will be blinking when the text field is focused."),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "InitialText",
		...
		'name', T(177266495989, --[[XTemplate EditControl name]] "Initial Text"),
		'help', T(193129633000, --[[XTemplate EditControl help]] "The edit control will be filled with this text upon creation."),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "UnfocusedText",
		...
		'name', T(732771389157, --[[XTemplate EditControl name]] "Unfocused Text"),
		'help', T(335703474650, --[[XTemplate EditControl help]] "Will be displayed when the text field is not focused."),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Multiline",
		...
		'name', T(724383084999, --[[XTemplate EditControl name]] "Multi-line"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "MaxLen",
		...
		'name', T(834795715045, --[[XTemplate EditControl name]] "Max Length"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "TextStyle",
		'editor', "text",
		'default', "PDAActivityDescription",
		'items', function (self) return Presets.TextStyle end,
		'translate', false,
		'Set', function (self, value)
		...
		'name', T(389299955934, --[[XTemplate EditControl name]] "Text Style"),
	}),
})
