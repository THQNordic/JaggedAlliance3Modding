...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateLayer', {
			'__condition', function (parent, context) return not IsInMultiplayerGame() end,
			'layer', "XPauseLayer",
		}),
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				if self:GetThread("close-later") then return end
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateAction', {
				'comment', "--gamepad close the menu",
				'ActionId', "idClose",
				'ActionGamepad', "Start",
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateAction', {
					'ActionId', "idBack",
					'ActionName', T(482997512259, --[[XTemplate InGameMenu ActionName]] "BACK"),
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateTemplate', {
					'__template', "SaveLoadGameDialog",
				}),
				PlaceObj('XTemplateAction', {
					'ActionId', "idClose",
					'ActionName', T(374427918878, --[[XTemplate InGameMenu ActionName]] "Close"),
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateTemplate', {
					'__template', "SetMercHireStatusList",
				}),
				PlaceObj('XTemplateAction', {
					'ActionId', "idClose",
					'ActionName', T(374427918878, --[[XTemplate InGameMenu ActionName]] "Close"),
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateTemplate', {
					'__template', "CheatsList",
				}),
				}),
			PlaceObj('XTemplateMode', {
				'mode', "SetLoyaltyCheat",
			}, {
				PlaceObj('XTemplateTemplate', {
					'__template', "SetLoyaltyCheat",
				}),
				PlaceObj('XTemplateAction', {
					'ActionId', "idClose",
					'ActionName', T(374427918878, --[[XTemplate InGameMenu ActionName]] "Close"),
