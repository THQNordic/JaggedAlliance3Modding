...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return GetOperationMercsListContext(context, GetActionsHost(parent, true).mode_param, "in progress") end,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateForEach', {
							...
							'run_after', function (child, context, item, i, n, last)
								...
								if item.infinite_slots then
									if item.occupied_slots then
										title = title .. T{577121182372, "<right><GameColorF><occupied_slots></GameColorF>", item}
									end
								elseif item.occupied_slots then
									local count = table.count(item.mercs) - (item.free_space or 0) 
									title = title .. T{137933144149, "<right><GameColorF><occupied_slots></GameColorF>/<GameColorD><count></GameColorD>", count =  count, item}
								elseif item.mercs then
									title = title .. T{571633925764, "<right><GameColorF><count(mercs)></GameColorF>", item}
								end
							...
							PlaceObj('XTemplateWindow', {
								'comment', "non militia sections",
								'__condition', function (parent, context) return context.operation ~= "MilitiaTraining" or context.list_as_prof=="Trainer" end,
								'VAlign', "top",
								'LayoutMethod', "VList",
								'Clip', "parent & self",
							}, {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateForEach', {
												'comment', "item",
												'array', function (parent, context) return context.mercs end,
												'condition', function (parent, context, item, i) return item.class~="empty" and item.class~="free_slot" end,
												'__context', function (parent, context, item, i, n) return {list_as_prof = context.list_as_prof, merc = item, click = context.click, operation = context.operation} end,
												'run_after', function (child, context, item, i, n, last)
												...
												PlaceObj('XTemplateTemplate', {
													...
													PlaceObj('XTemplateFunc', {
														...
														'func', function (self, rollover)
															...
															if class == "free_space" then return end
									...
									PlaceObj('XTemplateWindow', {
										...
										'HAlign', "right",
										'Transparency', 125,
										'Target', "idPortraitsList",
										'AutoHide', true,
									}),
									}),
								}),
							PlaceObj('XTemplateWindow', {
								'comment', "militia section",
								'__condition', function (parent, context) return context.operation == "MilitiaTraining" and not context.list_as_prof end,
								'VAlign', "top",
								'LayoutMethod', "VList",
								'Clip', "parent & self",
							}, {
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'TextStyle', "PDAActivitiesSubTitleDark",
											'Translate', true,
											'Text', T(284267057178, --[[XTemplate SectorOperationSelectMercProgressUI Text]] "Active Militia"),
											'HideOnEmpty', true,
											'TextVAlign', "center",
										}),
										PlaceObj('XTemplateWindow', {
											...
											'TextStyle', "PDAActivitiesSubTitleDark",
											'Translate', true,
											'Text', T(740578488287, --[[XTemplate SectorOperationSelectMercProgressUI Text]] "In Training"),
											'HideOnEmpty', true,
											'TextVAlign', "center",
										}),
										}),
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateForEach', {
												...
												'array', function (parent, context)
													return table.ifilter(context.mercs, function(idx, m) return not m.in_progress end)
												end,
												'__context', function (parent, context, item, i, n) return {list_as_prof = context.list_as_prof, merc = item, click = false, operation = context.operation} end,
												'run_after', function (child, context, item, i, n, last)
													rawset(child, "slot_idx", i)
												end,
											}, {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateForEach', {
												'comment', "item",
												'array', function (parent, context)
													return table.ifilter(context.mercs, function(idx, m) return not not m.in_progress end)
												end,
												'__context', function (parent, context, item, i, n) return {list_as_prof = context.list_as_prof, merc = item, click = false, operation = context.operation} end,
												'run_after', function (child, context, item, i, n, last)
													rawset(child, "slot_idx", i)
					...
					PlaceObj('XTemplateWindow', {
						...
						'__condition', function (parent, context) local operation = context.operation or context[1] and context[1].operation  return  IsCraftOperation(operation) end,
						'LayoutMethod', "VList",
					}, {
						PlaceObj('XTemplateWindow', {
							'comment', "items queue",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "PDAActivitiesSubTitleDark",
									'Translate', true,
									'Text', T(417907734731, --[[XTemplate SectorOperationSelectMercProgressUI Text]] "Queued Items"),
									'HideOnEmpty', true,
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'OnContextUpdate', function (self, context, ...)
									...
									node.idQueuedText:SetText(T{539301898339, "Queued Items<right><GameColorF><res_icon> <res>  <image UI/SectorOperations/T_Icon_Activity_Resting 1500 130 128 120><timeDuration(time)>", res_icon = "<image ".. itm_res_icon.." 2500 130 128 120>",res = SectorOperation_ItemsCalcRes(sector_id,operation_id), time= time})
								end,
							}, {
								PlaceObj('XTemplateWindow', {
									'__class', "XDragContextWindow",
									'Id', "idList",
									'Margins', box(0, 10, 0, 0),
									'GridStretchX', false,
									'GridStretchY', false,
									...
									PlaceObj('XTemplateForEach', {
										'comment', "item",
										'array', function (parent, context) local sector = GetDialog(parent).context.Id return SectorOperationItems_GetItemsQueue(sector, context[1].operation) or empty_table end,
										'__context', function (parent, context, item, i, n) return SectorOperation_FindItemDef(item) end,
										'run_after', function (child, context, item, i, n, last)
											rawset(child, "slot_idx", i)
											...
											child.idItem.idText:SetText(T{641971138327, "<style InventoryItemsCountMax><amount></style>", amount = item.amount})
										end,
									}, {
										PlaceObj('XTemplateWindow', {
											'__class', "XContextWindow",
											...
											PlaceObj('XTemplateWindow', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														'__class', "OperationProgressBar",
														'Id', "idOperationProgressBar",
														'IdNode', false,
														'HAlign', "stretch",
														'VAlign', "bottom",
														'MinHeight', 5,
														...
														'OnContextUpdate', function (self, context, ...)
															...
															if progress<=0 or progress>=max_condition then
																self:SetVisible(false)
																return
															end
