...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'VAlign', "center",
			'MouseCursor', "UI/Cursors/Hand.tga",
			'Image', "UI/Common/slider_cursor",
		}),
		PlaceObj('XTemplateAction', {
			'ActionId', "gamepadScrollLeft",
		...
		PlaceObj('XTemplateFunc', {
			'name', "ScrollAction(self, shortcut)",
			'func', function (self, shortcut)
				local slider = self
		...
		PlaceObj('XTemplateFunc', {
			'name', "ScrollActionUnbound(self, shortcut)",
			'func', function (self, shortcut)
				local slider = self
