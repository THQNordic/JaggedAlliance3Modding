	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Id', "idDayBullet",
					'Padding', box(16, 8, 0, 0),
					'Image', "UI/PDA/Quest/bullet",
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XContextWindow",
					'Id', "idDayBackground",
					...
					PlaceObj('XTemplateWindow', {
						...
						'OnContextUpdate', function (self, context, ...)
							if context and context[1] then
								self:SetText(T{147546503736, "<month(t)> <day(t)> <year(t)>", t = context[1].time})
							end
							return XContextControl.OnContextUpdate(self, context)
						end,
						'Translate', true,
		...
		PlaceObj('XTemplateForEach', {
			...
			PlaceObj('XTemplateTemplate', {
				'__template', "PDAQuestsHistoryOccurenceRow",
			}),
			}),
		}),
})
