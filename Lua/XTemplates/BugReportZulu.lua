	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Margins', box(50, 25, 50, 25),
				'Dock', "box",
				'LayoutMethod', "VList",
			}, {
				PlaceObj('XTemplateWindow', {
					'comment', 'keep this id "idScrollArea"',
					'Id', "idScrollArea",
					'IdNode', true,
					'LayoutMethod', "VList",
					'LayoutVSpacing', 20,
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self, ...)
								...
								text_fld.OnTextChanged = function(this)
					...
					PlaceObj('XTemplateWindow', {
						...
						'FocusedBackground', RGBA(0, 0, 0, 255),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'HAlign', "center",
							'FoldWhenHidden', true,
							'TextStyle', "BugReporterScreenshot",
							'Translate', true,
							'Text', T(473218230166, --[[XTemplate BugReportZulu Text]] "Click to draw, right-click to clear."),
						}),
						}),
					PlaceObj('XTemplateWindow', {
						'comment', "send",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'RolloverBorderColor', RGBA(255, 255, 255, 255),
								'PressedBorderColor', RGBA(255, 255, 255, 255),
								...
								PlaceObj('XTemplateWindow', {
									...
									'Background', RGBA(0, 0, 0, 255),
									'FocusedBackground', RGBA(0, 0, 0, 255),
									'DisabledBorderColor', RGBA(134, 134, 134, 255),
									'DisabledBackground', RGBA(134, 134, 134, 255),
									'TextStyle', "PDAShortcutText",
									'Translate', true,
									'Text', T(737086872205, --[[XTemplate BugReportZulu Text]] "Ent"),
									'TextHAlign', "center",
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
									...
									'Translate', true,
									'Text', T(377270367615, --[[XTemplate BugReportZulu Text]] "Send"),
									'TextHAlign', "center",
									'TextVAlign', "center",
								}),
								}),
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "PDAShortcutText",
									'Translate', true,
									'Text', T(971728004927, --[[XTemplate BugReportZulu Text]] "ESC"),
									'TextHAlign', "center",
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "PDACommonButtonWithRollover",
									'Translate', true,
									'Text', T(745484059274, --[[XTemplate BugReportZulu Text]] "Close"),
									'TextHAlign', "center",
									'TextVAlign', "center",
								}),
								}),
