			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(548684733743, --[[XTemplate PDAAimEvaluation Text]] "A.I.M. EVALUATION"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'Translate', true,
						'Text', T(324205023460, --[[XTemplate PDAAimEvaluation Text]] "v.1.1B"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__class', "XFrame",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(276501397506, --[[XTemplate PDAAimEvaluation Text]] "Secured connection"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XImage",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateAction', {
									...
									'ActionSortKey', "1030",
									'ActionName', T(550449531084, --[[XTemplate PDAAimEvaluation ActionName]] "Previous"),
								...
								PlaceObj('XTemplateAction', {
									'ActionId', "idNextMerc",
									'ActionSortKey', "1040",
									'ActionName', T(655064233565, --[[XTemplate PDAAimEvaluation ActionName]] "Next"),
									'ActionShortcut', "Tab",
								...
								PlaceObj('XTemplateAction', {
									...
									'ActionSortKey', "1060",
									'ActionName', T(905658355422, --[[XTemplate PDAAimEvaluation ActionName]] "Mercs"),
									'ActionToolbar', "ActionBar",
									'ActionShortcut', "M",
									'ActionState', function (self, host)
										local dlg = GetDialog(host)
								...
								PlaceObj('XTemplateAction', {
									...
									'ActionSortKey', "1070",
									'ActionName', T(187868415093, --[[XTemplate PDAAimEvaluation ActionName]] "Close"),
									'ActionToolbar', "ActionBar",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateTemplate', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(238402790013, --[[XTemplate PDAAimEvaluation Text]] "<LB>"),
										}),
										}),
									PlaceObj('XTemplateWindow', {
										'comment', "class icon",
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(562902609255, --[[XTemplate PDAAimEvaluation Text]] "<Name>"),
										}),
										PlaceObj('XTemplateWindow', {
											'Margins', box(0, -6, 0, 0),
											'LayoutMethod', "HList",
											...
											PlaceObj('XTemplateWindow', {
												...
												'Translate', true,
												'Text', T(749158490275, --[[XTemplate PDAAimEvaluation Text]] "<MercSpec()>"),
											}),
											PlaceObj('XTemplateWindow', {
												'comment', "class info",
												...
												'Translate', true,
												'Text', T(459016279300, --[[XTemplate PDAAimEvaluation Text]] "/ Daily Salary"),
											}),
											PlaceObj('XTemplateWindow', {
												'comment', "class info",
												'__condition', function (parent, context) return GetMercCurrentDailySalary(context.session_id) > 0 end,
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'ContextUpdateOnOpen', true,
											'Translate', true,
											'Text', T(738913633555, --[[XTemplate PDAAimEvaluation Text]] "<MercLevel()>"),
										}),
										PlaceObj('XTemplateWindow', {
											'__class', "XText",
											...
											'TextStyle', "PDABrowserSubtitle",
											'Translate', true,
											'Text', T(267299905081, --[[XTemplate PDAAimEvaluation Text]] "LEVEL"),
										}),
										}),
									PlaceObj('XTemplateTemplate', {
										'comment', "next",
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(995932052424, --[[XTemplate PDAAimEvaluation Text]] "<RB>"),
										}),
										}),
									}),
								PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(769722208341, --[[XTemplate PDAAimEvaluation Text]] "Stats"),
									}),
									PlaceObj('XTemplateWindow', {
										'comment', "attributes",
										'Margins', box(3, 0, 0, 0),
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(961479643645, --[[XTemplate PDAAimEvaluation Text]] "Talent"),
										}),
										PlaceObj('XTemplateWindow', {
											'Margins', box(0, 0, 8, 4),
											'LayoutMethod', "HList",
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'TextStyle', "PDABrowserNameSmall",
											'Translate', true,
											'Text', T(861228350946, --[[XTemplate PDAAimEvaluation Text]] "Traits"),
										}),
										PlaceObj('XTemplateWindow', {
											'LayoutMethod', "HList",
											'LayoutHSpacing', 8,
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "PDABrowserNameSmall",
										'Translate', true,
										'Text', T(236089097173, --[[XTemplate PDAAimEvaluation Text]] "Perks"),
									}),
									PlaceObj('XTemplateWindow', {
										'LayoutMethod', "HWrap",
										'LayoutHSpacing', 8,
							...
							PlaceObj('XTemplateMode', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(210141140528, --[[XTemplate PDAAimEvaluation Text]] "History"),
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XTextButton",
										'Id', "idStatsTab",
										...
										'TextStyle', "PDABrowserTabSelected",
										'Translate', true,
										'Text', T(113987221030, --[[XTemplate PDAAimEvaluation Text]] "Statistics"),
									}),
									PlaceObj('XTemplateWindow', {
										'comment', "gamepad hint",
										'__context', function (parent, context) return "GamepadUIStyleChanged" end,
											...
											PlaceObj('XTemplateMode', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														...
														'Translate', true,
														'Text', T(731522640052, --[[XTemplate PDAAimEvaluation Text]] "Connecting to A.I.M. servers...\nSecurity check... <em>Confirmed!</em>\n------------------------------------"),
													}),
													PlaceObj('XTemplateForEach', {
											...
											PlaceObj('XTemplateMode', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														...
														'TextStyle', "PDABrowserText",
														'Translate', true,
														'Text', T(959513065473, --[[XTemplate PDAAimEvaluation Text]] "Connecting to A.I.M. servers...\nSecurity check... <em>Confirmed!</em>\n-----------------------------------------------"),
													}),
													PlaceObj('XTemplateForEach', {
