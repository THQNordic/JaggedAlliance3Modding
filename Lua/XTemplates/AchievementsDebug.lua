...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'Id', "idMain",
			'Margins', box(2, 12, 2, 12),
			'BorderWidth', 1,
			'Padding', box(32, 8, 32, 8),
			'HAlign', "center",
			'VAlign', "center",
			'MaxWidth', 1400,
			'LayoutMethod', "HList",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateForEach', {
					'comment', "Achievement Group",
					'array', function (parent, context) return PresetGroupNames("Achievement") end,
					...
					PlaceObj('XTemplateForEach', {
						'comment', "Achievement",
						'array', function (parent, context) return Presets.Achievement[context.group] end,
						'__context', function (parent, context, item, i, n) return SubContext(item, { idx = context.startIdx + i }) end,
					}, {
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'TextStyle', "HUDHeader",
								'Translate', true,
								'Text', T(360726316855, --[[XTemplate AchievementsDebug Text]] "<idx>. <display_name>"),
								'TextVAlign', "center",
							}),
							PlaceObj('XTemplateWindow', {
								'__context', function (parent, context) return context.id end,
								'__class', "XText",
								'Id', "idUnlocked",
								'Margins', box(4, 0, 4, 0),
								'Padding', box(0, 0, 0, 0),
							...
							PlaceObj('XTemplateWindow', {
								...
								'TextStyle', "HUDHeader",
								'Translate', true,
								'Text', T(646769292817, --[[XTemplate AchievementsDebug Text]] "<description>"),
								'TextVAlign', "center",
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XTextButton",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idClose",
			'ActionName', T(918170694445, --[[XTemplate AchievementsDebug ActionName]] "Close"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idResetAllAchievements",
			'ActionName', T(529182464517, --[[XTemplate AchievementsDebug ActionName]] "Reset all Achievements"),
			'ActionToolbar', "Toolbar",
			'ActionShortcut', "R",
