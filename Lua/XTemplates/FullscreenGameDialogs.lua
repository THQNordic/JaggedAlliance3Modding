...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'Id', "idFullscreenHost",
		'ZOrder', 3,
		'Background', RGBA(32, 35, 47, 225),
		'MouseCursor', "UI/Cursors/Cursor.tga",
		'InitialMode', "inventory",
		'InternalModes', "inventory, empty",
	}, {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, ...)
				...
				local text = self.desktop.idInventoryMouseText
				if text then text:delete() end	
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__parent', function (parent, context) return parent.desktop end,
				'__class', "XText",
				'Id', "idInventoryMouseText",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
							'Margins', box(80, 98, 80, 88),
							'Image', "UI/Inventory/T_Backpack_Background",
						}),
						PlaceObj('XTemplateWindow', {
							'comment', "inventory frame",
							'__class', "XFrame",
							'IdNode', false,
							'HAlign', "center",
							'VAlign', "center",
							'Image', "UI/Inventory/T_Backpack_Frame",
							'SqueezeX', false,
							'SqueezeY', false,
						}, {
							PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Id', "idVignette",
				'Dock', "box",
				'Image', "UI/Inventory/inventory_vignette",
				'ImageFit', "stretch",
			}),
			}),
		}),
