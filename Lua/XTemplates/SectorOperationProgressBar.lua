...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'MaxWidth', 190,
			'MaxHeight', 9,
			'SeparatorImage', "UI/Hud/weapon_marker_black",
		}, {
			PlaceObj('XTemplateWindow', {
				'Margins', box(6, 0, 0, 0),
				'LayoutMethod', "HList",
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context)
						local max =  context.max_array or 50 local t = {} for i=1,max do t[i]=i end return t
					end,
				}, {
					PlaceObj('XTemplateWindow', {
						'HAlign', "left",
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(986419598057, --[[XTemplate SectorOperationProgressBar name]] "Bar Width"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "Layout",
		'id', "Height",
