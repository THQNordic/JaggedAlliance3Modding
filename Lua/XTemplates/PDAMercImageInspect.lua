...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'Background', RGBA(32, 35, 47, 120),
	}, {
		PlaceObj('XTemplateWindow', {
			'Margins', box(0, 24, 0, 48),
			'Dock', "box",
			'HAlign', "center",
			'VAlign', "center",
			'MinWidth', 682,
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(944265936250, --[[XTemplate PDAMercImageInspect Text]] "<Nick>'s profile"),
						'TextVAlign', "bottom",
					}),
					PlaceObj('XTemplateTemplate', {
						...
						'CenterImage', "UI/PDA/Event/T_Icon_Close",
					}),
					PlaceObj('XTemplateTemplate', {
						'__template', "PDASmallButton",
						'Margins', box(0, 0, 2, 1),
						...
						'MaxWidth', 20,
						'MaxHeight', 20,
						'CenterImage', "UI/PDA/Event/T_Icon_Help",
					}),
					}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'OnContextUpdate', function (self, context, ...)
								...
								self:SetText(T{254295447571, "<size>KB", size = randomSize})
							end,
							'Translate', true,
						}),
						}),
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'HAlign', "center",
							'VAlign', "center",
							'TextStyle', "PDABrowserFlavorBig",
							'Translate', true,
							'Text', T(743006454152, --[[XTemplate PDAMercImageInspect Text]] "40%"),
							'TextVAlign', "center",
						}),
						}),
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'OnContextUpdate', function (self, context, ...)
								...
								self:SetText(T{319320644886, "<date_mdy(m, d, y)>", m = randomMonth, d = randomDay, y = randomYear})
							end,
							'Translate', true,
						}),
						PlaceObj('XTemplateWindow', {
							...
							'OnContextUpdate', function (self, context, ...)
								...
								self:SetText(T{815629925333, "<hour>:<min>", hour = randomHour, min = randomMinute})
							end,
							'Translate', true,
							'TextHAlign', "right",
						}),
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'MaxWidth', 634,
							'MaxHeight', 830,
							'HScroll', "idImageScrollH",
							'VScroll', "idImageScrollV",
							'MouseScroll', false,
						}, {
							PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				if scale:x() < 1000 then
					...
					self:ResolveId("idScalePercent"):SetText(T{487196026340, "<percent(scale)>",scale = newScale:x()/10})
				end
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "OnMouseWheelBack(self)",
			'func', function (self)
				local portrait = self:ResolveId("idPortrait")
				local scale = portrait:GetScaleModifier()
				if scale:x() > 400 then
