...
PlaceObj('XTemplate', {
	...
	group = "Zulu",
	id = "PopupNotificationBaseTemplate",
	PlaceObj('XTemplateWindow', {
		'__class', "PopupNotificationBase",
		'ZOrder', 100000,
		...
		PlaceObj('XTemplateLayer', {
			'__condition', function (parent, context) return not netInGame end,
			'layer', "XPauseLayer",
		}),
		PlaceObj('XTemplateLayer', {
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2000",
			'ActionName', T(925891429380, --[[XTemplate PopupNotificationBaseTemplate ActionName]] "Close"),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(689585864477, --[[XTemplate PopupNotificationBaseTemplate Text]] "A.I.M. Help Center"),
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Margins', box(0, -3, 0, 0),
					'Dock', "box",
					'Image', "UI/PDA/Event/T_Event_Background",
					'FrameBox', box(5, 5, 5, 5),
				}),
				PlaceObj('XTemplateWindow', {
					'Margins', box(14, 24, 14, 0),
				}, {
					PlaceObj('XTemplateWindow', {
						'comment', "inner content (image, text etc)",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
							'Dock', "box",
						...
						PlaceObj('XTemplateWindow', {
							'__class', "XImage",
							'Id', "idNotificationImageBg",
							'IdNode', false,
							'Margins', box(0, 14, 14, 14),
							'Dock', "right",
							'HAlign', "left",
							'VAlign', "top",
							'MinWidth', 260,
							'MaxWidth', 260,
							'FoldWhenHidden', true,
							'Image', "UI/PDA/Event/T_Event_ImageBackground",
						}, {
							PlaceObj('XTemplateWindow', {
								'__class', "XImage",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(579438469731, --[[XTemplate PopupNotificationBaseTemplate Text]] "<title>"),
								'TextVAlign', "center",
							}),
							PlaceObj('XTemplateWindow', {
								'LayoutMethod', "HList",
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateForEach', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateFunc', {
														'name', "SetStyle(self, style)",
														'func', function (self, style)
															local textStyle = "PDAQuests_Label"
															local dlg = GetDialog(self)
															local read = dlg:IsHintRead(self.context)
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Margins', box(0, -2, 0, 0),
										'HandleMouse', false,
										'TextStyle', "SatelliteEventText",
										'Translate', true,
										'Text', T(352815754839, --[[XTemplate PopupNotificationBaseTemplate Text]] "<text>"),
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "MessengerScrollbar",
										'Id', "idTextScrollBar",
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Toolbar', "ActionBarPopupNotification",
						}, {
							PlaceObj('XTemplateFunc', {
								'name', "OnButtonCreated(self, button)",
							}),
							}),
						}),
					}),
