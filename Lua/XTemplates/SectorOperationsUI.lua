	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnLayoutComplete', function (self)
				if not g_SatTimelineUI then return end
				
				-- Hack to pull the UI up when it will intersect with the timeline on
				-- some resolutions
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						'__template', "SectorOperationTopUI",
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XContextWindow",
						'Margins', box(20, 16, 20, 57),
						'Dock', "box",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
							...
							PlaceObj('XTemplateMode', {
								...
								PlaceObj('XTemplateAction', {
									'ActionId', "idAbortAll",
									'ActionSortKey', "10",
									'ActionName', T(919358300788, --[[XTemplate SectorOperationsUI ActionName]] "Stop All"),
								...
								PlaceObj('XTemplateAction', {
									'ActionId', "idClose",
									'ActionSortKey', "9",
									'ActionName', T(378882267964, --[[XTemplate SectorOperationsUI ActionName]] "Close"),
									'ActionToolbar', "ActionBar",
								...
								PlaceObj('XTemplateTemplate', {
									'__template', "SectorOperationsListUI",
								}),
								}),
							PlaceObj('XTemplateMode', {
								'mode', "Operation",
								...
								PlaceObj('XTemplateAction', {
									'ActionId', "idClose",
									'ActionSortKey', "8",
									'ActionName', T(831318011207, --[[XTemplate SectorOperationsUI ActionName]] "Back"),
									'ActionToolbar', "ActionBar",
									'ActionShortcut', "Escape",
									'ActionGamepad', "ButtonB",
									'OnActionEffect', "back",
								...
								PlaceObj('XTemplateTemplate', {
									'__template', "SectorOperationMainUI",
								}),
								}),
							}),
						}),
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				'Id', "idVersion",
				'Margins', box(20, 0, 0, 16),
				'HAlign', "left",
				'VAlign', "bottom",
				'UseClipBox', false,
				'TextStyle', "PDAActivityVersion",
				'Text', "© A.I.M. 2001",
			}),
			PlaceObj('XTemplateWindow', {
