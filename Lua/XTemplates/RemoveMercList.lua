...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateTemplate', {
			...
			'Id', "idTitle",
			'Text', T(161192036978, --[[XTemplate RemoveMercList Text]] "REMOVE MERCENARY"),
		}),
		PlaceObj('XTemplateWindow', {
			'HAlign', "center",
			'VAlign', "center",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateForEach', {
							'comment', "merc",
							'array', function (parent, context) return Selection[1] and Selection[1].team.units or empty_table end,
							...
							PlaceObj('XTemplateTemplate', {
								...
								'Text', T(593405095038, --[[XTemplate RemoveMercList Text]] "<Nick>"),
							}),
							}),
						PlaceObj('XTemplateAction', {
							'ActionId', "Back",
							'ActionName', T(971567621541, --[[XTemplate RemoveMercList ActionName]] "BACK"),
