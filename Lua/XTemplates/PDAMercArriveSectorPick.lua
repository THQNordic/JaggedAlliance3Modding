		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(126059744065, --[[XTemplate PDAMercArriveSectorPick Text]] "MERCS HIRED"),
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(343415410397, --[[XTemplate PDAMercArriveSectorPick Text]] "The new hires will arrive in <newline><em>Grand Chien</em> in <MercArrivalTimeHours()> hours. <newline>Choose a landing spot:<newline>"),
							}),
							}),
						PlaceObj('XTemplateWindow', {
							'__class', "XList",
							...
							PlaceObj('XTemplateForEach', {
								'array', function (parent, context) return context.sectors end,
								...
								PlaceObj('XTemplateTemplate', {
									...
									'OnPress', function (self, gamepad)
										...
										for i, m in ipairs(node.context.mercs) do
											if m.Operation == "Arriving" then -- Sanity
