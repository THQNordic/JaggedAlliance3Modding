...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "XDialog",
		'gamestate', "pregame_menu",
	}, {
		PlaceObj('XTemplateWindow', {
			'comment', "change sharpness to 0 on open and reset on close",
			'__class', "XHROption",
			'Option', "Sharpness",
			'Value', 0,
		}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateAction', {
					'ActionId', "idBack",
					'ActionName', T(116709606999, --[[XTemplate PreGameMenu ActionName]] "BACK"),
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateTemplate', {
					...
					'__template', "ModManagerDialog",
				}),
				PlaceObj('XTemplateTemplate', {
					'__template', "ModManagerActions",
				}),
				}),
			PlaceObj('XTemplateMode', {
				'mode', "Multiplayer",
