...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', nil, {
		PlaceObj('XTemplateForEach', {
			...
			'condition', function (parent, context, item, i) return not prop_eval(item.no_edit, nil, item) and item.id ~= "Credits" end,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idBack",
			'ActionName', T(849407578275, --[[XTemplate OptionsActions ActionName]] "BACK"),
