...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__condition', function (parent, context) return not context.control.dontShowRollover end,
		'__class', "PDARolloverClass",
		'Margins', box(30, 1, 0, 0),
		'UseClipBox', false,
		...
		PlaceObj('XTemplateTemplate', {
			...
			'__condition', function (parent, context) return not context:IsDead() and context:HasVisibleEffects() end,
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(672790549048, --[[XTemplate PDAMercRollover Text]] "<Nick><valign bottom -1><style SatelliteContextMenuDate> / <MercClass()></style>"),
					'TextVAlign', "bottom",
				}),
				PlaceObj('XTemplateWindow', {
					'comment', "ap indicator",
					'__condition', function (parent, context) return not context:IsDead() end,
					'__class', "XText",
					...
					'OnContextUpdate', function (self, context, ...)
						...
						if g_Combat then
							...
							local ctx = SubContext(context, { current = currentAP, bonus = bonus, max = maxAP })
							if bonus >= 1000 then
								text = T{158709477285, "<apn(max)>+<apn(bonus)>", ctx}
							else
								text = T{263805086279, "<apn(current)>", ctx}
							end
						else
							local maxAP = context:GetMaxActionPoints()
							text = T{330002924751, "<apn(maxActionPoints)>", maxActionPoints = maxAP}
						end
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'OnContextUpdate', function (self, context, ...)
							...
							--	text = T{505183358375, "HP: <HitPoints>/<maxHp>(<positiveMaxHp>)",  maxHp = maxHp, positiveMaxHp = positiveMaxHp}
							--else
							--	text = T{995385072414, "HP: <HitPoints>/<maxHp>",  maxHp = maxHp}
							--end
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return context.Affiliation ~= "Secret" and context.HiredUntil end,
						'__class', "XText",
						'Id', "idContract",
						'VAlign', "center",
						'Clip', false,
						...
						'Translate', true,
						'Text', T(161690410358, --[[XTemplate PDAMercRollover Text]] "Contract Duration <right><style PDABrowserTextLightBold><MercContractTime()></style>"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'VAlign', "center",
						...
						'TextStyle', "SatelliteContextMenuKeybind",
						'Translate', true,
						'Text', T(997240698559, --[[XTemplate PDAMercRollover Text]] "Energy<right><style PDABrowserTextLightMedium><EnergyStatusEffect()></style>"),
					}),
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return IsKindOf(context, "Unit") end,
						'__class', "XText",
						'VAlign', "center",
						'Clip', false,
						'UseClipBox', false,
						'TextStyle', "SatelliteContextMenuKeybind",
						'Translate', true,
						'Text', T(258629704073, --[[XTemplate PDAMercRollover Text]] "Morale<right><style PDABrowserTextLightMedium><MercMoraleText()></style>"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'comment', "attributes label",
					'__class', "XText",
					'Margins', box(8, 0, 0, 0),
					'MinHeight', 34,
					'Clip', false,
					...
					'Translate', true,
					'Text', T(488971610056, --[[XTemplate PDAMercRollover Text]] "ATTRIBUTES"),
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					'__context', function (parent, context) return MercStatsItems(context) end,
					'__class', "XContextWindow",
					'Padding', box(14, 4, 14, 4),
					'Background', RGBA(32, 35, 47, 255),
				}, {
					PlaceObj('XTemplateWindow', {
						'LayoutMethod', "Grid",
						...
						PlaceObj('XTemplateForEach', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'RolloverText', T(320297314817, --[[XTemplate PDAMercRollover RolloverText]] "<help>"),
								'RolloverTitle', T(801789803619, --[[XTemplate PDAMercRollover RolloverTitle]] "<name>"),
								'IdNode', true,
							}, {
								PlaceObj('XTemplateWindow', {
									'__class', "XImage",
				...
				PlaceObj('XTemplateWindow', {
					...
					'__condition', function (parent, context) return context:HasVisibleEffects() end,
					'LayoutMethod', "VList",
				}, {
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDABrowserNameSmall",
						'Translate', true,
						'Text', T(686039592936, --[[XTemplate PDAMercRollover Text]] "STATUS EFFECTS"),
						'TextVAlign', "center",
					}),
					PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return context:IsDead() end,
				'LayoutMethod', "VList",
				'LayoutVSpacing', 6,
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XContextWindow",
					'Padding', box(14, 8, 14, 8),
					'LayoutMethod', "VList",
					'Background', RGBA(32, 35, 47, 255),
				}, {
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(201768379411, --[[XTemplate PDAMercRollover Text]] "HP: <HitPoints>/<GetModifiedMaxHitPoints()>"),
					}),
					PlaceObj('XTemplateWindow', {
						'comment', "killed text",
						'__class', "XText",
						...
						'TextStyle', "PDARolloverText",
						'Translate', true,
						'Text', T(342894139693, --[[XTemplate PDAMercRollover Text]] "Killed in action"),
					}),
					}),
				}),
			}),
