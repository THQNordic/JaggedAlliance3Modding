...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return GetGroupedMercsForCheats(false, true) end,
		'__class', "XDialog",
		'HandleMouse', true,
		'InitialMode', "groups",
		'InternalModes', "groups,mercs, statuses",
	}, {
		PlaceObj('XTemplateTemplate', {
			'__template', "DialogTitle",
			'Id', "idTitle",
			'Text', T(905807858555, --[[XTemplate SetMercHireStatusList Text]] "ADD MERCENARY"),
		}),
		PlaceObj('XTemplateWindow', {
			'HAlign', "center",
			'VAlign', "center",
			...
			PlaceObj('XTemplateWindow', nil, {
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateForEach', {
							...
							PlaceObj('XTemplateTemplate', {
								...
								'Text', T(856726520328, --[[XTemplate SetMercHireStatusList Text]] "<display_name>"),
							}),
							}),
						PlaceObj('XTemplateAction', {
							'ActionId', "Back",
							'ActionName', T(386121150408, --[[XTemplate SetMercHireStatusList ActionName]] "BACK"),
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateForEach', {
							...
							PlaceObj('XTemplateTemplate', {
								...
								'Text', T(907077938378, --[[XTemplate SetMercHireStatusList Text]] "<Nick>"),
							}),
							}),
						PlaceObj('XTemplateAction', {
							'ActionId', "cancel",
							'ActionName', T(790097322938, --[[XTemplate SetMercHireStatusList ActionName]] "CANCEL"),
							'ActionToolbar', "ActionBar",
							'ActionShortcut', "Escape",
							'ActionGamepad', "ButtonB",
							'OnActionEffect', "back",
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateForEach', {
							'comment', "status",
							'array', function (parent, context) return PresetGroupCombo("MercHireStatus", "Default", nil, "no_empty")() end,
							'__context', function (parent, context, item, i, n) return item end,
						...
						PlaceObj('XTemplateTemplate', {
							...
							'Text', T(503920453697, --[[XTemplate SetMercHireStatusList Text]] "Hired, but Rehire Available"),
						}),
						PlaceObj('XTemplateAction', {
							'ActionId', "cancel",
							'ActionName', T(790097322938, --[[XTemplate SetMercHireStatusList ActionName]] "CANCEL"),
