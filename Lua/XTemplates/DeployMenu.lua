	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Text', T(681328009294, --[[XTemplate DeployMenu Text]] "Tags"),
				}, {
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return "gv_DeploymentShowIntelUI" end,
						'__class', "XText",
						'Id', "idOnOff",
						'Dock', "right",
						'HAlign', "right",
						'MinWidth', 40,
						'FoldWhenHidden', true,
						'TextStyle', "SatelliteContextMenuTextBold",
						'ContextUpdateOnOpen', true,
						'OnContextUpdate', function (self, context, ...)
							self:SetText(gv_DeploymentShowIntelUI and T(818751046757, "ON") or T(470426548424, --[[XTemplate DeployMenu Text]] "OFF"))
						end,
						'Translate', true,
						'Text', T(470426548424, --[[XTemplate DeployMenu Text]] "OFF"),
					}),
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(444757356610, --[[XTemplate DeployMenu Text]] "<ButtonX>"),
					}),
					PlaceObj('XTemplateFunc', {
						...
						'func', function (self, rollover)
							...
							if node.window_state == "destroying" then return end
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(335038499846, --[[XTemplate DeployMenu Text]] "<DPadUp> <DPadDown>"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable()",
						'func', function ()
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return GetAvailableDeploymentMarkers() end,
					...
					'run_after', function (child, context, item, i, n, last)
						...
						child.OnPress = function()
							if item.Type == "Entrance" then
								local exitZone = GetExitZoneInteractableFromMarker(item)
								if exitZone then
									item = exitZone
								end
							end
				...
				PlaceObj('XTemplateWindow', {
					'comment', "separator line",
					'__context', function (parent, context) return GetDeploymentUIPOIs() end,
					'__condition', function (parent, context) return #(context or empty_table) > 0 end,
					'__class', "XFrame",
					'Margins', box(18, 10, 18, 10),
					'Image', "UI/PDA/separate_line_vertical",
					'FrameBox', box(5, 0, 5, 0),
					'SqueezeY', false,
				}, {
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return GetDeploymentUIPOIs() end,
					'condition', function (parent, context, item, i) return not IsKindOf(item, "ImplicitIntelMarker") or not item.DontShowInList end,
					'__context', function (parent, context, item, i, n) return item end,
					'run_after', function (child, context, item, i, n, last)
						child:SetText(GetDeploymentPOIName(item))
						--child.idBinding:SetText(T{818767796398, "[<key>] ", key = Untranslated(tostring(i)) })
						child.OnPress = function()
							SnapCameraToObj(item, "force")
						end
					end,
				...
				PlaceObj('XTemplateFunc', {
					'name', "OnShortcut(self, shortcut, source, gamepadId)",
					'func', function (self, shortcut, source, gamepadId)
						-- We dont want to handle keyboard input in this menu so they
						-- dont block the camera BUT XList recursively calls itself
						-- with a keyboard source when using gamepad
						-- so we check for a gamepad id too to detect these cases.
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'HAlign', "left",
					'VAlign', "center",
					'TextStyle', "SatelliteContextMenuDate",
					'Translate', true,
					'Text', T(758649482420, --[[XTemplate DeployMenu Text]] "<date()>"),
				}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateForEach', {
						'array', function (parent, context) return GetEnvironmentEffects() end,
						'__context', function (parent, context, item, i, n) return item end,
						'run_after', function (child, context, item, i, n, last)
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'HAlign', "left",
				'VAlign', "center",
				'TextStyle', "PDA_SquadNameBig",
				'Translate', true,
				'Text', T(833184721972, --[[XTemplate DeployMenu Text]] "Intel"),
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				'Margins', box(10, 0, 0, 0),
				...
				'Translate', true,
				'Text', T(543887468878, --[[XTemplate DeployMenu Text]] "When you have gained intel for a sector you will get additional information about locations in the tactical view and can see special objects such as machine gun emplacements and spotlights. You can gain Intel by doing tasks or the scouting operation."),
			}),
			PlaceObj('XTemplateFunc', {
				'comment', "puts the rollover part above or below the first item",
				...
				'func', function (self)
					...
					if content.box:sizey() < height then
		...
		PlaceObj('XTemplateWindow', {
			'comment', "overview mode observer",
			'__context', function (parent, context) return "CameraTacOverviewModeChanged" end,
			'__class', "XContextWindow",
			'ContextUpdateOnOpen', true,
			'OnContextUpdate', function (self, context, ...)
