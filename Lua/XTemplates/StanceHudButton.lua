...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'OnContextUpdate', function (self, context, ...)
			...
			local shortcuts = { upShortcuts[1], downShortcuts[1] }
			...
			-- Format F1, F2, F3 shortcuts into F1-3
			...
			if allF then
				self.idStanceIcon:SetText(T{726076428124, "[F<first>-<last>]", first = Untranslated(firstNum), last = Untranslated(lastNum)})
			else
				shortcuts = table.map(shortcuts, function(s) return s and s or "" end)
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'FocusedBackground', RGBA(34, 35, 39, 255),
					'DisabledBorderColor', RGBA(0, 0, 0, 0),
					'LeftThumbScroll', false,
					'GamepadInitialSelection', false,
				}, {
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return { action = CombatActions.StanceStanding } end,
						'__template', "SmallStanceHudButton",
					}),
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return { action = CombatActions.StanceCrouch } end,
						'__template', "SmallStanceHudButton",
						'Margins', box(0, -2, 0, 0),
					}),
					PlaceObj('XTemplateTemplate', {
						'__context', function (parent, context) return { action = CombatActions.StanceProne } end,
						'__template', "SmallStanceHudButton",
						'Margins', box(0, -2, 0, 0),
					}),
					...
					PlaceObj('XTemplateFunc', {
						...
						'func', function (self, shortcut, source, ...)
							if shortcut == "-ButtonA" then
								...
								if not selectedButton then return false end
