...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'MaxWidth', 1100,
			'MaxHeight', 480,
			'Image', "UI/Common/message_background_green",
			'ImageFit', "stretch",
		}),
		PlaceObj('XTemplateWindow', {
			'Margins', box(-15, 140, 0, 5),
			'Dock', "top",
			'HAlign', "center",
			'VAlign', "top",
			'LayoutMethod', "VList",
			...
			PlaceObj('XTemplateWindow', {
				...
				'MaxHeight', 100,
				'HandleMouse', false,
				'TextStyle', "DescriptionTextWhite",
				'Translate', true,
				'Text', T(665239190000, --[[XTemplate RehireMerc Text]] "<text>"),
				'TextVAlign', "center",
			}),
			}),
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateForEach', {
				'array', function (parent, context) return context.choices end,
