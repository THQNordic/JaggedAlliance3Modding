				...
				PlaceObj('XTemplateForEach', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'RolloverText', T(840234458060, --[[XTemplate UIWeaponDisplay RolloverText]] "placeholder"),
							...
							PlaceObj('XTemplateWindow', {
								...
								'__class', "XImage",
								'RolloverText', T(370682405601, --[[XTemplate UIWeaponDisplay RolloverText]] "placeholder"),
								'Id', "idModIcon",
								'Margins', box(5, 8, 0, 0),
								'HAlign', "left",
								'VAlign', "top",
							...
							PlaceObj('XTemplateForEach', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "HUDHeader",
										'Translate', true,
										'Text', T(151637075934, --[[XTemplate UIWeaponDisplay Text]] "<bullets()>"),
									}),
									}),
								}),
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateForEach', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'RolloverAnchorId', "idWeaponUI",
											'RolloverOffset', box(20, 0, 0, 0),
											'RolloverTitle', T(338106303761, --[[XTemplate UIWeaponDisplay RolloverTitle]] "Reload"),
							...
							PlaceObj('XTemplateForEach', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(383846607575, --[[XTemplate UIWeaponDisplay Text]] "<percent(Condition)>"),
										'TextHAlign', "right",
									}),
									}),
								}),
