...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return "pda_tab" end,
		'__class', "XSelectableTextButton",
		'LayoutMethod', "Box",
		...
		'Image', "UI/PDA/T_PDA_TabButton",
		'FrameBox', box(5, 5, 5, 5),
		'TextStyle', "HeaderButton",
		'ColumnsUse', "abcca",
	}, {
		PlaceObj('XTemplateFunc', {
			'name', "UpdateState(self)",
			'func', function (self)
	...
	PlaceObj('XTemplateProperty', {
		...
		'editor', "text",
		'translate', false,
		'name', T(733344557098, --[[XTemplate PDAHeaderButton name]] "GoToTab"),
	}),
})
