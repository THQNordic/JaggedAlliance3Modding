...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "TutorialPopupClass",
		'Margins', box(5, 5, 5, 5),
		'MinWidth', 280,
		'MinHeight', 100,
		'BorderColor', RGBA(0, 0, 0, 0),
		'Background', RGBA(191, 67, 77, 0),
		...
		PlaceObj('XTemplateWindow', {
			'Margins', box(20, 20, 20, 23),
			'Dock', "box",
		}, {
			PlaceObj('XTemplateWindow', {
				'__class', "XFrame",
				'Dock', "box",
				'Image', "UI/PDA/th_background",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Margins', box(5, 0, 0, 0),
						'MaxWidth', 280,
						'TextStyle', "PDARolloverTutorialTitle",
						'Translate', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XTextButton",
						...
						'TextStyle', "PDARolloverTutorialCross",
						'Text', "X",
					}, {
						PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(617313399753, --[[XTemplate TutorialPopup Text]] "<ButtonB> Close"),
				}),
				}),
			}),
		PlaceObj('XTemplateWindow', {
