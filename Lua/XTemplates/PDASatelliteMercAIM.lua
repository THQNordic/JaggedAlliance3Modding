		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "MercTooExpensive",
						'Translate', true,
						'Text', T(474052898772, --[[XTemplate PDASatelliteMercAIM Text]] "$"),
						'TextVAlign', "center",
					}),
					}),
				PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(746980318390, --[[XTemplate PDASatelliteMercAIM Text]] "OFFLINE"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(168293618443, --[[XTemplate PDASatelliteMercAIM Text]] "<Nick>"),
					'TextVAlign', "bottom",
				}),
				}),
			}),
