...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'RolloverTemplate', "CrosshairAttackRollover",
		'RolloverAnchorId', "idContainer",
		'RolloverText', T(429409916961, --[[XTemplate CrosshairCustomBodyPart RolloverText]] "placeholder"),
		...
		PlaceObj('XTemplateWindow', {
			'Id', "idTextContainer",
			'Margins', box(-15, 6, 0, 6),
			'Padding', box(20, 0, 4, 0),
