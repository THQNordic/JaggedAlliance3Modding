...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'ConsoleKeyboardDescription', T(886360378099, --[[XTemplate SaveEntryEdit ConsoleKeyboardDescription]] "Enter Save Name"),
		'WordWrap', false,
		'AllowPaste', false,
		'AllowEscape', false,
		'MaxVisibleLines', 1,
			...
			'func', function (self, shortcut, source, ...)
				...
				elseif shortcut == "Enter" then
					...
					CreateRealTimeThread(function(obj)
						-- Run the text input's focus losing logic first
						-- since it will refocus the button, regardless of whether
