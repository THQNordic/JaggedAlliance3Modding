...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateGroup', {
			'__context', function (parent, context) return GetCurrentResourcesContext(context.operation, context.sector) end,
		}, {
			PlaceObj('XTemplateWindow', {
				'comment', "resources",
			...
			PlaceObj('XTemplateWindow', {
				'comment', "line",
				'__condition', function (parent, context) return not next(context) end,
				'__class', "XFrame",
				'Dock', "top",
				'VAlign', "top",
		...
		PlaceObj('XTemplateTemplate', {
			'__template', "SectorOperationTrainMercsDescritionUI",
		}),
		PlaceObj('XTemplateTemplate', {
			'__condition', function (parent, context) return GetDialog(parent).Mode == "pick_item" end,
			'__template', "SectorOperationCraftResTableUI",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return context and  context.operation and context.sector and context.sector.operations_prev_data and  context.sector.operations_prev_data.prev_start_time and GetDialog(parent).Mode ~= "pick_item" end,
				'__class', "XText",
				'Id', "idConfirmation",
				'Margins', box(0, 0, 0, 18),
				'MaxWidth', 366,
				'FoldWhenHidden', true,
				'HandleMouse', false,
				'TextStyle', "PDAActivityDescription",
				'Translate', true,
				'Text', T(176366347160, --[[XTemplate SectorOperationDescrUI Text]] "<GameColorI>If confirmed, the operation will restart with the new parameters. Resources and end time may change based on this.</GameColorI>"),
				'HideOnEmpty', true,
			}),
			PlaceObj('XTemplateWindow', {
				...
				'TextStyle', "PDAActivityDescription",
				'Translate', true,
				'Text', T(425929996411, --[[XTemplate SectorOperationDescrUI Text]] "<description>"),
				'Shorten', true,
			}, {
				PlaceObj('XTemplateCode', {
					'run', function (self, parent, context)
