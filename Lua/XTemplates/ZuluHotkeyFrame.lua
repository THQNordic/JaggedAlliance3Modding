...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Clip', false,
			'UseClipBox', false,
			'TextStyle', "HotkeyIndicator",
			'Translate', true,
		}),
		}),
	PlaceObj('XTemplateProperty', {
		'id', "GamepadShortcutOverride",
		'editor', "text",
		'translate', false,
		...
		'name', T(388617198664, --[[XTemplate ZuluHotkeyFrame name]] "Gamepad Button Override"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "ActionName",
		'editor', "text",
		...
		'name', T(550964649987, --[[XTemplate ZuluHotkeyFrame name]] "Action Name"),
	}),
})
