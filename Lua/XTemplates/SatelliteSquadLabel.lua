			...
			PlaceObj('XTemplateWindow', {
				...
				'OnContextUpdate', function (self, context, ...)
					...
					for i, s in ipairs(context.units) do
						...
						if ud.Operation == "Idle" then goto continue end
				...
				PlaceObj('XTemplateFunc', {
					'name', "UpdateDrawCache(self, width, height, force)",
					'func', function (self, width, height, force)
