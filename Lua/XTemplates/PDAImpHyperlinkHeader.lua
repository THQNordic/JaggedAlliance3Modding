...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return "update link" end,
		...
		PlaceObj('XTemplateWindow', {
			...
			'HAlign', "left",
			'VAlign', "center",
			'TextStyle', "PDAIMPContentTitleActive",
			'Translate', true,
		}),
	...
	PlaceObj('XTemplateProperty', {
		...
		'help', T(800244591703, --[[XTemplate PDAImpHyperlinkHeader help]] "Link Id to save clicked links"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "dlg_mode",
		...
		'name', T(905236412897, --[[XTemplate PDAImpHyperlinkHeader name]] "Mode"),
		'help', T(884925934366, --[[XTemplate PDAImpHyperlinkHeader help]] "Change dialog mode"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "Text",
		...
		'name', T(127827187720, --[[XTemplate PDAImpHyperlinkHeader name]] "Text"),
		'help', T(122819879657, --[[XTemplate PDAImpHyperlinkHeader help]] "Links' text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "General",
		'id', "TextHAlign",
		'editor', "choice",
		'default', "center",
		'items', function (self) return {"left", "center", "right"} end,
		'Set', function (self, value)
	...
	PlaceObj('XTemplateProperty', {
		...
		'editor', "choice",
		'default', "center",
		'items', function (self) return {"top", "center", "bottom"} end,
		'Set', function (self, value)
