...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'Id', "idAttachmentWindow",
		'IdNode', true,
		'ZOrder', 100,
		'Margins', box(416, 0, 0, 0),
		'Dock', "box",
		'HAlign', "center",
		'VAlign', "center",
		'MinWidth', 836,
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(294802212474, --[[XTemplate PDAQuestsEmailAttachment Text]] "A.I.M. <valign bottom -1><style PDAQuests_HeaderSmall>VIEWER</style>"),
					'TextVAlign', "bottom",
				}),
				}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'MinHeight', 44,
				'MaxHeight', 44,
				'TextStyle', "PDAQuests_AttachmentText",
				'ContextUpdateOnOpen', true,
				'Translate', true,
				'Text', T(522188795966, --[[XTemplate PDAQuestsEmailAttachment Text]] "<name>"),
				'TextHAlign', "center",
				'TextVAlign', "center",
			}),
			PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'VAlign', "center",
					'GridX', 2,
					'TextStyle', "PDAQuests_AttachmentTextBig",
					'ContextUpdateOnOpen', true,
					'OnContextUpdate', function (self, context, ...)
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(761034571924, --[[XTemplate PDAQuestsEmailAttachment Text]] "800x420x24bpp"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'Padding', box(0, 0, 0, 0),
						...
						'Translate', true,
						'Text', T(962997734955, --[[XTemplate PDAQuestsEmailAttachment Text]] "82kb"),
						'TextHAlign', "right",
					}),
					}),
				}),
