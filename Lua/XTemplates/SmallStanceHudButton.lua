...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'FXMouseIn', "StanceButtonRollover",
		'FXPress', "StanceButtonPress",
		'FXPressDisabled', "StanceButtonDisabled",
		'FocusedBorderColor', RGBA(52, 55, 60, 255),
		'FocusedBackground', RGBA(255, 255, 255, 0),
		'DisabledBorderColor', RGBA(52, 55, 60, 255),
		'OnPress', function (self, gamepad)
			if #(Selection or "") > 0 then
				self.context.action:UIBegin(Selection)
				
				if gamepad then
					if self.context.action:GetUIState(Selection) == "enabled" then
		...
		'RolloverBorderColor', RGBA(52, 55, 60, 255),
		'PressedBackground', RGBA(255, 255, 255, 0),
		'PressedBorderColor', RGBA(52, 55, 60, 255),
	}, {
		PlaceObj('XTemplateWindow', {
			'Id', "idInner",
			'HAlign', "center",
		...
		PlaceObj('XTemplateFunc', {
			'name', "UpdateSelectionState(self, selected)",
			'func', function (self, selected)
