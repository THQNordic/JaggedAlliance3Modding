			...
			'OnContextUpdate', function (self, context, ...)
				...
				if IsEquipSlot(name) then
					...
					if not is_weapon or unit.current_weapon==name then	
						title = T{947705095257, "<title> <style PDAActivitiesButtonSmall><GameColorK>(Equipped)</GameColorK></style>", title= title}
					elseif is_weapon and unit.current_weapon~=name then	
						title = T{446557690587, "<title> <style PDAActivitiesButtonSmall><GameColorK>(Equipped)</GameColorK></style>", title= title}
					end
				end
		...
		PlaceObj('XTemplateTemplate', {
			...
			'OnContextUpdate', function (self, context, ...)
				...
				if IsEquipSlot(name) then
					...
					local is_weapon  = item:IsWeapon()
					if not is_weapon or unit.current_weapon==name then	
						title = T{465580833787, "<title> <style PDAActivitiesButtonSmall><GameColorK>(<equipped>)</GameColorK></style>", equipped = name=="Handheld A" and T(850044659556, "Loadout I") or name=="Handheld B" and T(471776201807, "Loadout II") or T(987350124807, "Equipped") ,title= title}
					elseif is_weapon and unit.current_weapon~=name then	
						title = T{465580833787, "<title> <style PDAActivitiesButtonSmall><GameColorK>(<equipped>)</GameColorK></style>", equipped = name=="Handheld A" and T(850044659556, "Loadout I") or name=="Handheld B" and T(471776201807, "Loadout II") or T(987350124807, "Equipped") ,title= title}
					end
				end
