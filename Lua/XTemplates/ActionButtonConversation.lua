...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'FadeInTime', 300,
		'FadeOutTime', 300,
		'FXMouseIn', "activityHover_Conversation",
		'FXPress', "activityButtonPress_ConversationSelect",
		...
		PlaceObj('XTemplateFunc', {
			'name', "OnPressButtonFn(self)",
			'func', function (self)
				local dlg = GetDialog(self)
				if dlg:IsUIControllable() then
					if dlg.window_state ~= "destroying" 
						and dlg.phrase_start_time and now() > dlg.phrase_start_time + const.UIButtonPressDelay + dlg:GetAnimStart() 
						and not dlg.phrase_chosen
					   and not dlg.anim_hide
					then
		...
		PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', nil, {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'DrawOnTop', true,
							'HandleMouse', false,
							'TextStyle', "ConversationChoiceNormal",
							'Translate', true,
							'TextVAlign', "center",
						}, {
							PlaceObj('XTemplateFunc', {
								'name', "SetStarImage(self, rollover)",
						...
						PlaceObj('XTemplateWindow', {
							...
							'FoldWhenHidden', true,
							'DrawOnTop', true,
							'Image', "UI/Conversation/T_Choice_Star",
							'ImageFit', "stretch",
							'DisabledImageColor', RGBA(195, 189, 172, 77),
						}, {
							PlaceObj('XTemplateFunc', {
								'name', "OnSetRollover(self, rollover)",
								'func', function (self, rollover)
			...
			PlaceObj('XTemplateTemplate', {
				'__context', function (parent, context) return "g_CoOpConversationOptionAdvice" end,
		...
		PlaceObj('XTemplateFunc', {
			'name', "SetRolloverMode(self, rollover)",
			'func', function (self, rollover)
