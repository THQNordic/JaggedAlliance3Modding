	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'FocusedBackground', RGBA(32, 35, 47, 255),
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Margins', box(0, 0, 0, 0),
					'Dock', false,
					'Text', T(662905161298, --[[XTemplate CheatsList Text]] "MAPS"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEachAction', {
					'toolbar', "cheats",
					'condition', function (parent, context, action, i) return Platform.developer and action.ActionToolbarSection == "MAPS" end,
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Dock', false,
					'GridX', 2,
					'Text', T(416706301043, --[[XTemplate CheatsList Text]] "GENERAL"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEachAction', {
					'toolbar', "cheats",
					'condition', function (parent, context, action, i) return action.ActionToolbarSection == "GENERAL" end,
					'run_after', function (child, context, action, n)
						child:SetText(action.ActionName)
						child:SetOnPressParam(action.ActionId)
						child:SetGridY(n + 1)
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Dock', false,
					'GridX', 3,
					'Text', T(261152057685, --[[XTemplate CheatsList Text]] "COMBAT"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEachAction', {
					'toolbar', "cheats",
					'condition', function (parent, context, action, i) return action.ActionToolbarSection == "COMBAT" end,
					'run_after', function (child, context, action, n)
						child:SetText(action.ActionName)
						child:SetOnPressParam(action.ActionId)
						child:SetGridY(n + 1)
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Dock', false,
					'GridX', 4,
					'Text', T(486183100390, --[[XTemplate CheatsList Text]] "HIRING"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEachAction', {
					'toolbar', "cheats",
					'condition', function (parent, context, action, i) return action.ActionToolbarSection == "HIRING" end,
					'run_after', function (child, context, action, n)
						child:SetText(action.ActionName)
						child:SetOnPressParam(action.ActionId)
						child:SetGridY(n + 1)
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Dock', false,
					'GridX', 5,
					'Text', T(275856763974, --[[XTemplate CheatsList Text]] "LIGHTING"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return Platform.developer and GetCheatsWeatherTOD() or {} end,
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Dock', false,
					'GridX', 6,
					'Text', T(825265755855, --[[XTemplate CheatsList Text]] "SETPIECES"),
				}, {
					PlaceObj('XTemplateFunc', {
						'name', "IsSelectable(self)",
						'func', function (self)
				...
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return Presets.SetpiecePrg.Trailers end,
					'run_after', function (child, context, item, i, n, last)
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idClose",
				'ActionName', T(535988861706, --[[XTemplate CheatsList ActionName]] "Close"),
