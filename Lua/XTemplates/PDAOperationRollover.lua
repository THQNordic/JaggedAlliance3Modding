		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(593850847736, --[[XTemplate PDAOperationRollover Text]] "<Name>"),
				}),
				PlaceObj('XTemplateWindow', {
					'HAlign', "right",
					'VAlign', "center",
