...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, context, prop_meta, value)
				...
				--local reverse =self:GetReverseBar() 
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(815344385251, --[[XTemplate RolloverPropText name]] "Reverse value"),
	}),
	PlaceObj('XTemplateProperty', {
		'id', "Text",
		'editor', "text",
		...
		'name', T(822067705386, --[[XTemplate RolloverPropText name]] "Text"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "Scroll",
		'id', "MaxProgress",
		...
		'name', T(329896981912, --[[XTemplate RolloverPropText name]] "Max Progress"),
	}),
	PlaceObj('XTemplateProperty', {
		'category', "Scroll",
		'id', "PercentValue",
		...
		'name', T(435070720727, --[[XTemplate RolloverPropText name]] "Percent value"),
		'help', T(862953060002, --[[XTemplate RolloverPropText help]] "Show percent symbol"),
	}),
})
