		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(942962706825, --[[XTemplate PDASquadManagement Text]] "SQUAD MANAGEMENT"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
			...
			PlaceObj('XTemplateWindow', nil, {
											...
											PlaceObj('XTemplateWindow', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														...
														'Translate', true,
														'Text', T(321445201647, --[[XTemplate PDASquadManagement Text]] "NEW SQUAD"),
													}),
													}),
												}),
											PlaceObj('XTemplateForEach', {
												...
												PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														...
														PlaceObj('XTemplateWindow', {
															...
															PlaceObj('XTemplateWindow', {
																...
																'Translate', true,
																'Text', T(132729641765, --[[XTemplate PDASquadManagement Text]] " "),
																'TextVAlign', "bottom",
															}),
															}),
														PlaceObj('XTemplateWindow', {
													...
													PlaceObj('XTemplateWindow', {
														...
														'Translate', true,
														'Text', T(736930395887, --[[XTemplate PDASquadManagement Text]] "DRAG A MERC"),
														'TextHAlign', "center",
														'TextVAlign', "center",
													}),
													}),
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(131695298527, --[[XTemplate PDASquadManagement Text]] "<style AimCopyrightTextC><copyright></style> A.I.M. 2001"),
					}),
					PlaceObj('XTemplateWindow', nil),
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateAction', {
							'ActionId', "idFilters",
							'ActionName', T(421561301721, --[[XTemplate PDASquadManagement ActionName]] "View"),
						...
						PlaceObj('XTemplateAction', {
							'ActionId', "idClose",
							'ActionName', T(918444511505, --[[XTemplate PDASquadManagement ActionName]] "Close"),
							'ActionToolbar', "ActionBar",
