		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', nil, {
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(478539744445, --[[XTemplate PDAMoneyRollover Text]] "Finances"),
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					'Margins', box(5, 0, 0, 0),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(670968933606, --[[XTemplate PDAMoneyRollover Text]] "Income"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'OnContextUpdate', function (self, context, ...)
							...
							local text = T{225569119592, "<money(income)>/Day", income = income}
							self:SetText(text)
						end,
						'Translate', true,
						'HideOnEmpty', true,
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverText",
						'Translate', true,
						'Text', T(974729983146, --[[XTemplate PDAMoneyRollover Text]] "Burn Rate"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'OnContextUpdate', function (self, context, ...)
							...
							local text = T{105101286891, "<money(burnRate)>/Day", burnRate = burnRate}
							self:SetText(text)
						end,
						'Translate', true,
						'HideOnEmpty', true,
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDARolloverText",
						'Translate', true,
						'Text', T(461157338926, --[[XTemplate PDAMoneyRollover Text]] "14D Estimate "),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'OnContextUpdate', function (self, context, ...)
							...
							if value >= 0 then
								text = T{149250925651, "<moneyRounded(value)>", value = value}
							else
