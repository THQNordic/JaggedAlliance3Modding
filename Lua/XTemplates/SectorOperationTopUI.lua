	...
	PlaceObj('XTemplateWindow', {
		...
		'OnContextUpdate', function (self, context, ...)
			...
			if sector then
				...
				self.idSectorId:SetText(T{333114402012, "<SectorId(sector_Id)>", sector_Id = sector.Id})
			end
		end,
	}, {
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Translate', true,
			'Text', T(600389692781, --[[XTemplate SectorOperationTopUI Text]] "SECTOR OPERATIONS"),
			'TextVAlign', "center",
		}),
		}),
})
