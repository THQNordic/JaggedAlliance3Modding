...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "XPopupSnapToWidth",
		'Margins', box(0, 0, 0, 5),
		'BorderWidth', 2,
		'BorderColor', RGBA(52, 55, 61, 230),
		'Background', RGBA(32, 35, 47, 230),
		'FocusedBorderColor', RGBA(52, 55, 61, 230),
		'FocusedBackground', RGBA(32, 35, 47, 230),
		'DisabledBorderColor', RGBA(52, 55, 61, 230),
		'DisabledBackground', RGBA(32, 35, 47, 230),
	}, {
		PlaceObj('XTemplateWindow', nil, {
			PlaceObj('XTemplateWindow', {
				'__class', "XList",
				'Id', "idChoiceActionsContainer",
				'IdNode', false,
				'BorderWidth', 0,
				...
				'LayoutHSpacing', 2,
				'Clip', false,
				'BorderColor', RGBA(177, 22, 14, 0),
				'Background', RGBA(177, 22, 14, 0),
				'FocusedBackground', RGBA(0, 0, 0, 0),
			}, {
				PlaceObj('XTemplateForEach', {
					'__context', function (parent, context, item, i, n) return item.uiCtx end,
					'run_after', function (child, context, item, i, n, last)
						...
						local state = item.action:GetUIState({item.unit}, { target = item.target })
						...
						function child:OnSetRollover(rollover, ...)
							...
							if not IsValid(item.target) then return end
					...
					PlaceObj('XTemplateWindow', {
						...
						'RolloverAnchorId', "idChoiceActionsContainer",
						'MinHeight', 55,
						'MaxHeight', 55,
					}, {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCloseChoiceMenu",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCloseChoiceMenuTwo",
