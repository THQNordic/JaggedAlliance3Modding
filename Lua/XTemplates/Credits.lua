	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnLayoutComplete', function (self)
				...
				miny = box:miny()+miny
				maxy = box:maxy()-maxy
				self.effect_shader_params = {BoxMinX = (box:minx()) * 1000, BoxMaxX = (box:maxx()*1000), BoxMaxY = (maxy) * 1000, BoxMinY = (miny)*1000 }
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Id', "idImageLeft",
				'Margins', box(65, 0, 0, 0),
				'HAlign', "left",
				'VAlign', "center",
				'Visible', false,
				'FadeInTime', 600,
				'FadeOutTime', 600,
				'Image', "UI/Common/cr_photo_01",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Id', "idImageRight",
				'Margins', box(0, 0, 65, 0),
				'HAlign', "right",
				'VAlign', "center",
				'Visible', false,
				'FadeInTime', 600,
				'FadeOutTime', 600,
				'Image', "UI/Common/cr_photo_02",
			}),
			}),
		PlaceObj('XTemplateWindow', {
			'__class', "XImage",
			'Dock', "box",
			'Image', "UI/Common/cr_vignette",
			'ImageFit', "stretch",
		}),
		PlaceObj('XTemplateTemplate', {
			'__template', "InventoryActionBarCenter",
			'ZOrder', 10,
			'Margins', box(0, 0, 80, 50),
			'HAlign', "right",
		}),
