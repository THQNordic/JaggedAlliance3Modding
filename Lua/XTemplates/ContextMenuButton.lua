...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'comment', "since this is not a class it cannot be overriden propertly",
			'name', "base_OnSetRollover(self, rollover)",
			'func', function (self, rollover)
				...
				XTextButtonZulu.OnSetRollover(self, rollover)
			end,
		}),
		PlaceObj('XTemplateFunc', {
