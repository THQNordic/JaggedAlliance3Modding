		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(657753827058, --[[XTemplate PDABrowserLanding Text]] "<style AimCopyrightTextC><copyright></style> A.I.M. 2001"),
				}),
				PlaceObj('XTemplateTemplate', {
					...
					'Text', T(196572239600, --[[XTemplate PDABrowserLanding Text]] "About Us"),
				...
				PlaceObj('XTemplateTemplate', {
					...
					'TextStyle', "WebLinkButton_Hiring",
					'Text', T(591945544080, --[[XTemplate PDABrowserLanding Text]] "Terms of Service"),
					'ActiveTextStyle', "WebLinkButton_Hiring_Heavy",
				}),
				}),
			PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(977617334059, --[[XTemplate PDABrowserLanding Text]] "WELCOME TO THE A.I.M. RECRUITMENT WEBSITE"),
				}),
				PlaceObj('XTemplateWindow', {
					'comment', "main txt",
					'__class', "XText",
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(326877401379, --[[XTemplate PDABrowserLanding Text]] "Hit the continue button below to browse our catalogue!"),
					'TextHAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					'comment', "button",
