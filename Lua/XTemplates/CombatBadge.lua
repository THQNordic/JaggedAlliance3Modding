...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'RolloverText', T(327307292756, --[[XTemplate CombatBadge RolloverText]] "STATUS EFFECTS"),
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(865071357285, --[[XTemplate CombatBadge Text]] "OUT OF AMMO"),
			}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "BadgeName",
					'Translate', true,
					'Text', T(459179278354, --[[XTemplate CombatBadge Text]] "<DisplayName>"),
				}),
