...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "OnDelete",
			'func', function (self, ...)
				-- this is needed because although the properties are volatile and vanish with PDABrowser, the state of PDABrowserTabState does not; I do not believe we want to make the flavour tabs permanent however, so here I am "resetting" their state
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', nil, {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'TextStyle', "URLLabel",
							'Translate', true,
							'Text', T(420589943681, --[[XTemplate PDABrowser Text]] "URL:"),
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XButton",
							'IdNode', false,
							...
							PlaceObj('XTemplateWindow', {
								...
								'TextStyle', "URLText",
								'Translate', true,
								'Text', T(299661233439, --[[XTemplate PDABrowser Text]] "<PDAUrl()>"),
							}),
							}),
						}),
					}),
				PlaceObj('XTemplateWindow', {
					'comment', "tab buttons",
					'__context', function (parent, context) return "pda browser tabs" end,
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self, ...)
								...
								if not pdaBrowser then return end
						...
						PlaceObj('XTemplateForEach', {
							'array', function (parent, context) return PDABrowserTabData end,
							'condition', function (parent, context, item, i) return not PDABrowserTabState[item.id] or not PDABrowserTabState[item.id].locked end,
							...
							PlaceObj('XTemplateTemplate', {
								'__template', "PDABrowserButton",
								'VAlign', "center",
								'FXPress', "AIMTabsClick",
							}, {
								PlaceObj('XTemplateWindow', {
									'__class', "XText",
									'Id', "idUnread",
									...
									'Text', "<color PDACommonButtonRed>!</color>",
								}),
								}),
							}),
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(448834517294, --[[XTemplate PDABrowser Text]] "<LeftTrigger> <RightTrigger> - Change tab"),
						}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateAction', {
					...
					'ActionName', T(288117422463, --[[XTemplate PDABrowser ActionName]] "Close"),
				...
				PlaceObj('XTemplateTemplate', {
					'__condition', function (parent, context) return GetDialog(parent).mode_param == "PDABrowserAskThieves" end,
					'__template', "PDABrowserAskThieves",
				}),
				PlaceObj('XTemplateTemplate', {
					'__condition', function (parent, context) return GetDialog(parent).mode_param == "PDABrowserBobbyRay" end,
					'__template', "PDABrowserBobbyRay",
					'IgnoreMissing', true,
				}),
				PlaceObj('XTemplateTemplate', {
					'__condition', function (parent, context) return GetDialog(parent).mode_param == "PDABrowserSunCola" end,
					'__template', "PDABrowserSunCola",
				}),
				PlaceObj('XTemplateTemplate', {
					'__condition', function (parent, context) return GetDialog(parent).mode_param == "PDABrowserMortuary" end,
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateAction', {
					'ActionId', "idCloseAction",
					'ActionName', T(458886616804, --[[XTemplate PDABrowser ActionName]] "Close"),
					'ActionShortcut', "Escape",
					'ActionGamepad', "ButtonB",
					'OnAction', function (self, host, source, ...)
						local pda = GetDialog("PDADialog")
