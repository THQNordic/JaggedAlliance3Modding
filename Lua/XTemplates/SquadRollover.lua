	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(779614644688, --[[XTemplate SquadRollover Text]] "<SquadNameColored()> <color HUDHeaderGrey>[<SquadMemberCount()>]</color>"),
				'TextVAlign', "center",
			}),
			PlaceObj('XTemplateWindow', {
				'comment', "power",
				...
				'Translate', true,
				'Text', T(909161685756, --[[XTemplate SquadRollover Text]] "<valign bottom -2>Power <valign bottom 0><style HUDHeaderBigLight><GetSquadPower()></style>"),
				'TextVAlign', "bottom",
			}),
			}),
		PlaceObj('XTemplateWindow', {
			'comment', "outer content",
			'LayoutMethod', "VList",
		}, {
			PlaceObj('XTemplateWindow', {
				'comment', "squad members",
				'__context', function (parent, context) return ResolvePropObj(context) end,
				'__class', "XContentTemplate",
				'Id', "idCurrentSquadCont",
				'Margins', box(0, 3, 0, 0),
				'FoldWhenHidden', true,
				...
				PlaceObj('XTemplateWindow', {
					'comment', "container that enforces size",
				}, {
					...
					PlaceObj('XTemplateWindow', {
						'comment', "container that centers",
						'Padding', box(20, 3, 20, 13),
						'HAlign', "center",
					}, {
						PlaceObj('XTemplateWindow', {
							'comment', "wrapping container",
							'HAlign', "left",
							'VAlign', "top",
							'LayoutMethod', "HWrap",
						}, {
							PlaceObj('XTemplateForEach', {
								...
								'array', function (parent, context) return context.Side == "player1" and context and context.units or GroupEnemyMercs({context}) end,
								'__context', function (parent, context, item, i, n) return gv_UnitData[item] or item end,
								'run_after', function (child, context, item, i, n, last)
									if IsKindOf(context, "UnitData") then return end
									
									-- Non-merc (enemy, militia) rollover context it not unitdata but a
									-- custom crafted object which contains unit counts as it is
									-- expected to have lots of duplicate units.
									...
									if context.count > 1 then
										...
										child.idCountText:SetText(T{476743244853, "<textColor>x<count></color>",
											 count = context.count,
											 textColor = textColor
										})
								...
								PlaceObj('XTemplateTemplate', {
									...
									PlaceObj('XTemplateFunc', {
										...
										'func', function (self)
											...
											self.idLevelUp:SetFoldWhenHidden(true)
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(568248221200, --[[XTemplate SquadRollover Text]] "x8"),
										}),
										}),
									PlaceObj('XTemplateWindow', {
										'__class', "XSquareWindow",
										...
										PlaceObj('XTemplateWindow', {
											...
											'RolloverText', T(799850868066, --[[XTemplate SquadRollover RolloverText]] "<Description>"),
											'RolloverTitle', T(736028978593, --[[XTemplate SquadRollover RolloverTitle]] "<DisplayName>"),
											'Id', "idTypeImg",
											'HAlign', "center",
											'VAlign', "center",
											'MinWidth', 20,
											...
											'MaxHeight', 20,
											'HandleMouse', true,
											'Image', "UI/PDA/MercPortrait/T_ClassIcon_MilitiaElite_Small",
											'ImageFit', "stretch",
											'ContextUpdateOnOpen', true,
										}),
										}),
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'__condition', function (parent, context) return IsMerc(parent.context) end,
											'__class', "XContentTemplate",
										...
										PlaceObj('XTemplateWindow', {
											'__condition', function (parent, context) return IsMerc(context) end,
											'__class', "XContextWindow",
				...
				PlaceObj('XTemplateFunc', {
					...
					'func', function (self)
						...
						assert(allSquads[1] == rolloverSquad)
				...
				PlaceObj('XTemplateFunc', {
					'name', "UpdateMultiSquadSection(self)",
					'func', function (self)
						local selectedSquad = rawget(self, "selectedSquad")
						local allSquads = rawget(self, "allSquads")
						local node = self.parent:ResolveId("node")
						node.idInputHint:SetVisible(#allSquads > 1)
						self.idCountText:SetVisible(#allSquads > 1)
						self.idCountText:SetText(T{634869128953, "Multiple Squads <style PDASelectedSquad><current>/<total></style>",
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(268179249615, --[[XTemplate SquadRollover Text]] "[<ShortcutButton('CycleSquadsInRollover')>] Cycle Squads"),
				'HideOnEmpty', true,
			}),
			}),
		}),
