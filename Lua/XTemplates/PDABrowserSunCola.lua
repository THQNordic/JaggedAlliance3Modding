...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
			...
			'func', function (self, ...)
				...
				self:CreateThread("sun_cola_animation_text", function()
					...
					while true do
						...
						tex4:SetTextStyle((i >=3 and i%2 == 1) and bigWhite or bigYellow)
		...
		PlaceObj('XTemplateWindow', {
			...
			'__class', "XImage",
			'Dock', "box",
			'Image', "UI/PDA/WEBSites/sun_cola_background",
			'ImageFit', "stretch",
		}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'HandleKeyboard', false,
				'Image', "UI/PDA/WEBSites/sun_cola_site",
			}, {
				PlaceObj('XTemplateWindow', {
					'Margins', box(0, 530, 0, 0),
					'HAlign', "center",
					'VAlign', "center",
					'MinWidth', 450,
					'MinHeight', 150,
					...
					PlaceObj('XTemplateWindow', {
						...
						'HandleKeyboard', false,
						'HandleMouse', false,
						'TextStyle', "PDABrowserColaTextNormal",
						'Translate', true,
						'Text', T(593314015120, --[[XTemplate PDABrowserSunCola Text]] "Only at Carnival!"),
						'TextHAlign', "center",
						'TextVAlign', "center",
					}),
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDABrowserColaTextNormal",
						'Translate', true,
						'Text', T(697483709058, --[[XTemplate PDABrowserSunCola Text]] "Order a service at Le Lys Rouge!"),
						'TextHAlign', "center",
						'TextVAlign', "center",
					}),
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDABrowserColaTextNormal",
						'Translate', true,
						'Text', T(882466523653, --[[XTemplate PDABrowserSunCola Text]] "Get two Sun Colas"),
						'TextHAlign', "center",
						'TextVAlign', "center",
					}),
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'HandleKeyboard', false,
							'HandleMouse', false,
							'TextStyle', "PDABrowserColaTextBig",
							'Translate', true,
							'Text', T(158977597586, --[[XTemplate PDABrowserSunCola Text]] "FOR FREE!"),
							'TextHAlign', "center",
							'TextVAlign', "center",
						}),
						}),
				...
				PlaceObj('XTemplateWindow', {
					'__class', "XImage",
					'Id', "AnimatedImage",
					'Margins', box(0, 0, 75, 240),
					'HAlign', "right",
					'VAlign', "center",
					'Background', RGBA(0, 72, 130, 0),
					'HandleKeyboard', false,
					'Image', "UI/PDA/WEBSites/sun_cola_fresh_2",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'HandleKeyboard', false,
					'HandleMouse', false,
					'TextStyle', "PDABrowserColaCopyright",
					'Translate', true,
					'Text', T(903266218528, --[[XTemplate PDABrowserSunCola Text]] "Privacy Policy | Copyright Sun Cola Company 2001"),
					'TextHAlign', "center",
				}),
				}),
			}),
