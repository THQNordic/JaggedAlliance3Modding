...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(471218052023, --[[XTemplate CombineItemPopup Text]] "COMBINE ITEMS"),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'Margins', box(8, 8, 8, 8),
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(427405118822, --[[XTemplate CombineItemPopup Text]] "+"),
					}),
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return false end,
						'__class', "RespawningButton",
						'Id', "idCombineOptions",
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self, pos, button)
								-- We gotta implement our own button logic because of ChildrenHandleMouse
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "Hiring_MercLevel",
						'Translate', true,
						'Text', T(313214069515, --[[XTemplate CombineItemPopup Text]] "="),
					}),
					PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						'__template', "Slider",
						'Id', "idSlider",
						'Margins', box(20, 10, 10, 10),
						'VAlign', "center",
						'Target', "idSliderContainer",
						'Min', 1,
						'Max', 1,
					}),
					PlaceObj('XTemplateFunc', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(199239787895, --[[XTemplate CombineItemPopup Text]] "<LB> <RB>"),
					}),
					}),
				}),
			PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Assemble",
				'ActionName', T(657879215259, --[[XTemplate CombineItemPopup ActionName]] "Confirm"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Close",
				'ActionName', T(424422676665, --[[XTemplate CombineItemPopup ActionName]] "Close"),
				'ActionToolbar', "ActionBar",
		...
		PlaceObj('XTemplateFunc', {
			'name', "SetChosenCombination(self, data)",
			'func', function (self, data)
				...
				for i, recipeItem in ipairs(resultItems) do
					...
					local item1 = data.second_idx==1 and secondItem or self.context.item	
					local item2 = data.second_idx==1 and self.context.item	or secondItem
					local item = i==1 and item1 or item2
					local condition = item.Condition
					if IsKindOf(fakeItem, "ToolItem") then
						condition = Max(0,item.Condition-MulDivRound(item.Condition, const.CombineToolConditionLose,100))
					end
					fakeItem.Condition = condition
				end
				...
				local combineText = 
				T{710966137412, "<style PDARolloverTextDark><skilltype> required:</style><right><style PDARolloverText><difficulty></style>\n<left><style PDARolloverTextDark><merc_name> (<skilltype>)</style><right><style PDARolloverText><u(mercSkill)></style>",
				...
				-- Check how many times the item can be combined
				...
				for i, ingr in ipairs(ingredients) do
					...
					if not timesCanCombine or #totalData < timesCanCombine then
						timesCanCombine = #totalData
					end
				end
				
				self.idSliderContainer:SetVisible(timesCanCombine > 1)
