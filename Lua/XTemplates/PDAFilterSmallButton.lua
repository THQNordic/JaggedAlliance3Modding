...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		...
		'RolloverAnchor', "left",
		'RolloverText', T(904623182115, --[[XTemplate PDAFilterSmallButton RolloverText]] "Main View"),
		'RolloverOffset', box(0, 0, 15, 5),
		'HAlign', "right",
		'VAlign', "bottom",
		'MinWidth', 31,
		'MinHeight', 31,
		'FXPress', "SatelliteFilterButton",
		'OnPressParam', "default",
