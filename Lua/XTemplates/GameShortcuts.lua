...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ToggleGameSessionExport",
			'ActionSortKey', "950",
			'ActionTranslate', false,
			'ActionName', "Toggle Game Session Export",
			'ActionIcon', "CommonAssets/UI/Icons/analytics document file paper report statistics",
	...
	PlaceObj('XTemplateAction', {
		...
		'OnAction', function (self, host, source, ...)
			if Platform.developer or AreCheatsEnabled() then
				ShowConsole(true)
			end
		end,
	...
	PlaceObj('XTemplateAction', {
		'ActionId', "E_SelectedGridMarker",
		'ActionMode', "Editor",
		'ActionSortKey', "1000",
		'ActionTranslate', false,
		'ActionName', "Open in Grid Marker Editor",
		...
		'OnAction', function (self, host, source, ...)
			local grid_markers = table.ifilter(editor.GetSel(), function(_, o) return IsKindOf(o, "GridMarker") end)
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			...
			PlaceObj('XTemplateForEach', {
				...
				'run_after', function (child, context, item, i, n, last)
					...
					if i == 2 then
						child:SetActionShortcuts("Ctrl-Shift-Home", nil, nil)
					end
				end,
			}, {
				PlaceObj('XTemplateAction', {
					'ActionIcon', "CommonAssets/UI/Icons/media play",
					'replace_matching_id', true,
				}),
				}),
			PlaceObj('XTemplateForEach', {
		...
		PlaceObj('XTemplateAction', {
			'comment', "Quick Test Exploration",
			'RolloverText', "Quick Test Exploration",
			'ActionId', "TestExploration",
			'ActionSortKey', "1030",
			'ActionTranslate', false,
			'ActionName', "Quick Test Exploration",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Test Ambient Life",
			'RolloverText', "Quick Test Ambient Life",
			'ActionId', "QuickTestAmbientLife",
			'ActionSortKey', "1040",
			'ActionTranslate', false,
			'ActionName', "Quick Test Ambient Life",
			'ActionIcon', "CommonAssets/UI/Icons/map.png",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Start Combat Now",
			'RolloverText', "Start Combat Now",
			'ActionId', "TestCombat",
			'ActionSortKey', "1060",
			'ActionTranslate', false,
			'ActionName', "Start Combat Now",
			'ActionIcon', "CommonAssets/UI/Icons/starburst.png",
			'OnAction', function (self, host, source, ...)
				CheatDbgStartCombat()
			end,
			'replace_matching_id', true,
		...
		PlaceObj('XTemplateAction', {
			'comment', "Achievements Debug",
			'ActionId', "AchievementsDebug",
			'ActionSortKey', "1060",
			'ActionTranslate', false,
			'ActionName', "Achievements Debug",
			'ActionIcon', "CommonAssets/UI/Icons/achievement medal winner",
			'ActionShortcut', "Alt-Shift-Y",
			'OnAction', function (self, host, source, ...)
				OpenDialog("AchievementsDebug")
			end,
		}),
		PlaceObj('XTemplateAction', {
			'comment', "Reset achievements",
			'ActionId', "ResetAchievements",
			'ActionSortKey', "1060",
			'ActionTranslate', false,
			'ActionName', "Reset Achievements",
			'ActionIcon', "CommonAssets/UI/Icons/achievement medal winner",
			'OnAction', function (self, host, source, ...)
				ResetAchievements()
			end,
		...
		PlaceObj('XTemplateAction', {
			'comment', "Select any unit",
			'RolloverText', "Can selects unit not under control - enemy, dead, controlled by another player",
			'ActionId', "SelectAnyUnit",
			'ActionSortKey', "1070",
			'ActionTranslate', false,
			'ActionName', "Select Any Unit",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'ActionShortcut', "Ctrl-Shift-MouseM",
			'OnAction', function (self, host, source, ...)
				CheatSelectAnyUnit()
			end,
		}),
		...
		PlaceObj('XTemplateAction', {
			'comment', "grant 10 ap",
			'RolloverText', "grant 10 ap to current unit",
			'ActionId', "Grant10AP",
			'ActionSortKey', "1090",
			'ActionTranslate', false,
			'ActionName', "Grant 10 AP",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "grant 100 ap",
			'RolloverText', "grant 100 ap to current unit",
			'ActionId', "Grant100AP",
			'ActionSortKey', "1100",
			'ActionTranslate', false,
			'ActionName', "Grant 100 AP",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'ActionShortcut', "Ctrl-Alt-J",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "remove 1 ap",
			'RolloverText', "remove 1 ap to current unit",
			'ActionId', "Remove1AP",
			'ActionSortKey', "1110",
			'ActionTranslate', false,
			'ActionName', "Remove 1 AP",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Adds 100 ammo of each type",
			'RolloverText', "Fills up each weapon and gives 100 ammo of each type in squad inventory.",
			'ActionId', "AddAmmo",
			'ActionSortKey', "1120",
			'ActionTranslate', false,
			'ActionName', "Add Ammo",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Add +10 merc stats",
			'RolloverText', "Add +10 to all merc stats.",
			'ActionId', "AddMercStats",
			'ActionSortKey', "1120",
			'ActionTranslate', false,
			'ActionName', "Add +10 Merc Stats",
			'ActionIcon', "UI/Icons/hf_elite",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Grants 100,000 money",
			'RolloverText', "Grants 100,000 money",
			'ActionId', "GetMoney",
			'ActionSortKey', "1130",
			'ActionTranslate', false,
			'ActionName', "Get $100 000",
			'ActionIcon', "CommonAssets/UI/Icons/accessories bra clothes clothing fashion underwear woman.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "panic selected",
			'RolloverText', "Enable God Mode",
			'ActionId', "PanicSelectedUnit",
			'ActionSortKey', "1150",
			'ActionTranslate', false,
			'ActionName', "Panic Selected Unit",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			...
			'RolloverText', "kill all enemies on the map",
			'ActionId', "KillEnemies",
			'ActionSortKey', "1160",
			'ActionTranslate', false,
			'ActionName', "Kill Enemies",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionTranslate', false,
			'ActionName', "LevelUp",
			'ActionIcon', "CommonAssets/UI/Icons/arrow double up.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "defeat villains",
			'RolloverText', "retreat/defeat lieutenants",
			'ActionId', "DefeatVillains",
			'ActionSortKey', "1190",
			'ActionTranslate', false,
			'ActionName', "Defeat Villains",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "heal mercs",
			'RolloverText', "heals all mercs",
			'ActionId', "HealMercs",
			'ActionSortKey', "1200",
			'ActionTranslate', false,
			'ActionName', "Heal Mercs",
			'ActionIcon', "CommonAssets/UI/Icons/foot print shoe sign track.png",
			'OnAction', function (self, host, source, ...)
				UIHealAllMercs()
			end,
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle hidden units",
			'RolloverText', "toggle hidden unit visibility",
			'ActionId', "ToggleHiddenUnits",
			'ActionSortKey', "1210",
			'ActionTranslate', false,
			'ActionName', "Toggle Hidden Units",
		...
		PlaceObj('XTemplateAction', {
			'comment', "reveal traps in sight",
			'RolloverText', "reveal traps in sight",
			'ActionId', "RevealTraps",
			'ActionSortKey', "1220",
			'ActionTranslate', false,
			'ActionName', "Reveal Traps",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
				local pov_team = GetPoVTeam()
				if pov_team then
		...
		PlaceObj('XTemplateAction', {
			'comment', "reveal all sectors in Satellite View",
			'RolloverText', "reveal all sectors in Satellite View",
			'ActionId', "RevealAllSectors",
			'ActionSortKey', "1230",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle shot dispersion",
			'RolloverText', "toggle shot dispersion",
			'ActionId', "ToggleShotDispersion",
			'ActionSortKey', "1240",
			'ActionTranslate', false,
			'ActionName', "Toggle Shot Dispersion",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle auto-resolve wins",
			'RolloverText', "toggle auto-resolve wins",
			'ActionId', "ToggleAutoResolveWins",
			'ActionSortKey', "1250",
			'ActionTranslate', false,
			'ActionName', "Toggle Auto Resolve Wins",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle disable discovery alert",
			'RolloverText', "toggle disable discovery alert",
			'ActionId', "ToggleDisableDiscoveryAlert",
			'ActionSortKey', "1260",
			'ActionTranslate', false,
			'ActionName', "Toggle Disable Discovery Alert",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "RespecPerkPoints",
			'ActionSortKey', "1270",
			'ActionTranslate', false,
			'ActionName', "Respec Perk Points",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Toggle Tac Camera Bounds Lock",
			'RolloverText', "Toggle Tac Camera Bounds Lock",
			'ActionId', "TTCBL",
			'ActionSortKey', "1280",
			'ActionTranslate', false,
			'ActionName', "Toggle Tac Camera Bounds Lock",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Toggle Room/Building Invisibility",
			'RolloverText', "Toggle Room/Building Invisibility",
			'ActionId', "TRBI",
			'ActionSortKey', "1290",
			'ActionTranslate', false,
			'ActionName', "Toggle Room/Building Invisibility",
			'ActionIcon', "CommonAssets/UI/Icons/home house landing page main page property real estate.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Toggle Wall Invisibility Debug",
			'ActionId', "ToggleWallInvisibilityDebug",
			'ActionSortKey', "1300",
			'ActionTranslate', false,
			'ActionName', "Toggle Wall Invisibility Debug",
			'ActionIcon', "CommonAssets/UI/Icons/home house landing page main page property real estate.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Toggle Wall Invisibility Outside of Combat",
			'ActionId', "ToggleWallInvisibilityOutsideOfCombat",
			'ActionSortKey', "1310",
			'ActionTranslate', false,
			'ActionName', "Toggle Wall Invisibility Outside of Combat",
			'ActionIcon', "CommonAssets/UI/Icons/home house landing page main page property real estate.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Track Damage to Objects",
			'ActionId', "TrackDamageToObjects",
			'ActionSortKey', "1320",
			'ActionTranslate', false,
			'ActionName', "Track Damage to Objects",
			'ActionIcon', "CommonAssets/UI/Icons/home house landing page main page property real estate.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Toggle CMT Collision Debug",
			'ActionId', "ToggleCMTCollisionDbg",
			'ActionSortKey', "1330",
			'ActionTranslate', false,
			'ActionName', "Toggle CMT Collision Debug",
			'ActionIcon', "CommonAssets/UI/Icons/box cube geometry.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Toggle Conversation Debug",
			'RolloverText', "Toggle Conversation Debug",
			'ActionId', "ToggleConversationDebug",
			'ActionSortKey', "1340",
			'ActionTranslate', false,
			'ActionName', "Toggle Conversation Debug",
			'ActionIcon', "CommonAssets/UI/Icons/conversation discussion language.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Reveals Intel for current sector",
			'RolloverText', "Reveals Intel for current sector",
			'ActionId', "RevealIntel",
			'ActionSortKey', "1350",
			'ActionTranslate', false,
			'ActionName', "Reveal Intel for current sector",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "1370",
			'ActionTranslate', false,
			'ActionName', "Record or Save Replay",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Show squads power in UI",
			'ActionId', "ShowSquadsPower",
			'ActionSortKey', "1370",
			'ActionTranslate', false,
			'ActionName', "Show squads power",
			'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "Visualize CMT Cube",
		'ActionId', "VisualizeCMTCube",
		'ActionSortKey', "1420",
		'ActionShortcut', "Ctrl-7",
		'OnAction', function (self, host, source, ...)
			VisualizeCMTCube()
		end,
		'__condition', function (parent, context) return Platform.developer end,
	...
	PlaceObj('XTemplateAction', {
		...
		'ActionId', "ToggleBlacklistEntitiesVisualization",
		'ActionSortKey', "1425",
		'ActionToolbar', "Debug",
		'ActionShortcut', "Ctrl-Shift-7",
		'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "Place AL_SitChair",
		'ActionId', "E_Place_AL_SitChair",
		'ActionSortKey', "1430",
		'ActionTranslate', false,
		'ActionName', "Place AL_SitChair",
		'ActionIcon', "CommonAssets/UI/Menu/EV_OpenFirst.tga",
		'ActionState', function (self, host)
			if IsKindOf(editor.GetSel()[1], "ChairSittable") then return end
		...
		'OnAction', function (self, host, source, ...)
			...
			if x == 0 and y == 0 and z < 0 then
				marker:SetAxisAngle(-axis, marker:GetAngle() + 180 * 60)
			end
	...
	PlaceObj('XTemplateAction', {
		'comment', "Place AL_SitChair_SleepingAtTable",
		'ActionId', "E_Place_AL_SitChair_SleepingAtTable",
		'ActionSortKey', "1440",
		'ActionTranslate', false,
		'ActionName', "Place AL_SitChair_SleepingAtTable",
		'ActionIcon', "CommonAssets/UI/Menu/EV_OpenFirst.tga",
		'ActionState', function (self, host)
			if IsKindOf(editor.GetSel()[1], "ChairSittable") then return end
	...
	PlaceObj('XTemplateAction', {
		'comment', "AL Visit Support Create",
		'ActionId', "E_AL_Marker_Visit_Support_Create",
		'ActionSortKey', "1450",
		'ActionTranslate', false,
		'ActionName', "AL Create Visit Support Set",
		'ActionIcon', "CommonAssets/UI/Menu/EV_OpenFirst.tga",
		'ActionShortcut', "Ctrl-Alt-Shift-A",
		'ActionState', function (self, host)
			...
			if not (AL_marker and other_object) then
				return "hidden"
			end
		end,
		'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "AL Visit Support Remove",
		'ActionId', "E_AL_Marker_Support_Remove",
		'ActionSortKey', "1460",
		'ActionTranslate', false,
		'ActionName', "AL Remove Visit Support Set",
		'ActionIcon', "CommonAssets/UI/Menu/EV_OpenFirst.tga",
		'ActionState', function (self, host)
	...
	PlaceObj('XTemplateAction', {
		'comment', "AL Test Marker",
		'ActionId', "E_AL_Test_Marker",
		'ActionSortKey', "1470",
		'ActionTranslate', false,
		'ActionName', "AL Test Marker",
		'ActionIcon', "CommonAssets/UI/Menu/EV_OpenFirst.tga",
		'ActionShortcut', "Alt-Shift-L",
		'ActionState', function (self, host)
			local AL_marker
			for _, obj in ipairs(editor.GetSel() or empty_table) do
				if IsKindOf(obj, "AmbientLifeMarker") then
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "1490",
			'ActionTranslate', false,
			'ActionName', "Grid Markers",
			'ActionIcon', "CommonAssets/UI/Icons/dashboard display grid view layout.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "SatelliteSectorsEditor",
			'ActionSortKey', "1500",
			'ActionTranslate', false,
			'ActionName', "Satellite Sectors",
			'ActionIcon', "CommonAssets/UI/Icons/globe 2.png",
			'OnAction', function (self, host, source, ...)
				CreateRealTimeThread(function()
					if not next(gv_Sectors) then
						if WaitQuestion(terminal.desktop, Untranslated("New Game"), Untranslated("To use this editor, a new game will be started, changing the current map.\n\nYou will lose all changes made. Continue?"), Untranslated("Yes"), Untranslated("No")) ~= "ok" then
							return
						end
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit command",
			'RolloverText', "toggle unit command",
			'ActionId', "ToggleUnitCommand",
			'ActionSortKey', "1530",
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Command",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle aim IK debug",
			'RolloverText', "toggle aim IK debug",
			'ActionId', "ToggleAimIKDebug",
			'ActionSortKey', "1540",
			'ActionTranslate', false,
			'ActionName', "Toggle Aim IK Debug",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "show the stat gaining table",
			'ActionId', "ShowStatGaining",
			'ActionSortKey', "1550",
			'ActionTranslate', false,
			'ActionName', "Show Stat Gaining",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
		...
		PlaceObj('XTemplateAction', {
			'comment', "spawns AL unit to test closest marker",
			'ActionId', "TestALMarker",
			'ActionSortKey', "1560",
			'ActionTranslate', false,
			'ActionName', "Test AL Closest Marker",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'ActionShortcut', "Alt-L",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Tests AL Zones with unchecked 'Reachable Only' property",
			'ActionId', "TestUnreachableALZones",
			'ActionSortKey', "1570",
			'ActionTranslate', false,
			'ActionName', "Test Unreachable AL Zones",
			'ActionIcon', "CommonAssets/UI/Icons/group.png",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit anim style",
			'RolloverText', "toggle unit anim style",
			'ActionId', "ToggleAppearanceLabels",
			'ActionSortKey', "1580",
			'ActionTranslate', false,
			'ActionName', "Toggle Appearance Labels",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle gas masks",
			'RolloverText', "toggle gas masks",
			'ActionId', "ToggleGasMasks",
			'ActionSortKey', "1590",
			'ActionTranslate', false,
			'ActionName', "Toggle Gas Masks",
			'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "satellite and game",
		'ActionMode', "Game, Satellite, UI, Exploration",
		'ActionSortKey', "-1",
	}, {
		PlaceObj('XTemplateAction', {
			'ActionId', "actionToggleSatellite",
			'ActionMode', "Game, Satellite, UI",
			'ActionSortKey', "1600",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
				if GetDialog("SatelliteConflict") then return "disabled" end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionLevelUpViewContextMenu",
			'ActionSortKey', "1620",
			'ActionName', T(456663890965, --[[XTemplate GameShortcuts ActionName]] "Level Up"),
			'ActionState', function (self, host)
				if not GetInGameInterfaceModeDlg() then return "hidden" end
				local contextMenu = GetInGameInterfaceModeDlg().idContextMenu
				if not contextMenu then return "hidden" end
				local unitId = contextMenu.idContent and contextMenu.idContent.context and contextMenu.idContent.context.unit_id
				if not unitId then return "hidden" end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionLevelUpView",
			'ActionSortKey', "1630",
			'ActionName', T(391831532718, --[[XTemplate GameShortcuts ActionName]] "Perks"),
			'ActionShortcut', "L",
			'ActionBindable', true,
			'ActionState', function (self, host)
				return SatelliteToggleActionState()
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionOpenCharacterContextMenu",
			'ActionSortKey', "1640",
			'ActionName', T(455134687102, --[[XTemplate GameShortcuts ActionName]] "Merc Info"),
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
				return SatelliteToggleActionState()
			end,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "OpenHelp",
			'ActionSortKey', "1650",
			'ActionName', T(156152227082, --[[XTemplate GameShortcuts ActionName]] "Show Help"),
			'ActionShortcut', "F1",
			'ActionBindable', true,
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "idInventory",
			'ActionSortKey', "1660",
			'ActionName', T(710877191741, --[[XTemplate GameShortcuts ActionName]] "Inventory"),
			'ActionShortcut', "I",
			...
			'OnAction', function (self, host, source, ...)
				...
				elseif gv_CurrentSectorId then -- Opened from another tab
				...
				if not firstUnit then
					...
					if playerSquads and #playerSquads >= 1 then
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "1670",
			'ActionName', T(705614277559, --[[XTemplate GameShortcuts ActionName]] "Toggle In Game Main Menu"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionOpenNotes",
			'ActionSortKey', "1680",
			'ActionName', T(331467263779, --[[XTemplate GameShortcuts ActionName]] "Notes"),
			'ActionShortcut', "F4",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
				if InitialConflictNotStarted() and not gv_AIMBrowserEverClosed then
					return "disabled"
				end
				
				if GetDialog("PDADialog") then return "enabled" end
				if GetDialog("SatelliteConflict") then return "disabled" end
				return SatelliteToggleActionState()
			end,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionOpenEmail",
			'ActionSortKey', "1690",
			'ActionName', T(782869854240, --[[XTemplate GameShortcuts ActionName]] "Email"),
			'ActionShortcut', "F6",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionOpenBrowser",
			'ActionSortKey', "1700",
			'ActionName', T(304830845673, --[[XTemplate GameShortcuts ActionName]] "Browser"),
			'ActionShortcut', "F2",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ModifyWeapon",
			'ActionSortKey', "1710",
			'ActionName', T(651782746273, --[[XTemplate GameShortcuts ActionName]] "Weapon Mods"),
			'ActionMouseBindable', false,
			'ActionState', function (self, host)
				if not GetMercInventoryDlg() then return "disabled" end
				if GetDialog("ModifyWeaponDlg") then return "disabled" end
				if IsInMultiplayerGame() and g_Combat then return "disabled" end
			end,
			'OnAction', function (self, host, source, ...)
				...
				if win then -- Check if mouse over a weapon
					...
					if IsKindOf(item, "Firearm") then
						...
						if not dlg then OpenDialog("ModifyWeaponDlg", nil, { weapon = item, slot = owner:GetItemPackedPos(item), owner = owner }) end
						return
					end
				end
				local inventoryUnit = GetInventoryUnit()
				if not inventoryUnit then return end
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			...
			'RolloverText', "Quick Test Combat",
			'ActionId', "ShowDebugCovers",
			'ActionSortKey', "1730",
			'ActionTranslate', false,
			'ActionName', "Show Debug Covers",
			'ActionIcon', "CommonAssets/UI/Icons/starburst.png",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Shows All Debug Covers",
			'RolloverText', "Shows All Debug Covers(No Rebuild)",
			'ActionId', "ShowDebugCoversNoRebuild",
			'ActionSortKey', "1735",
			'ActionTranslate', false,
			'ActionName', "Show Debug Covers(no Rebuild)",
			'ActionIcon', "CommonAssets/UI/Icons/starburst.png",
			'OnAction', function (self, host, source, ...)
				DbgDrawCovers(nil, nil, nil, "no rebuild")
			end,
			'replace_matching_id', true,
		}),
		PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			'comment', "Shows Debug Covers around Cursor",
		...
		PlaceObj('XTemplateAction', {
			'comment', "Select Debug Covers around Cursor",
			'ActionId', "SelectCoversInRange",
			'ActionSortKey', "1760",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle grenade volume display",
			'RolloverText', "toggle grenade volumes",
			'ActionId', "ToggleGrenadeVolumes",
			'ActionSortKey', "1770",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle fires",
			'RolloverText', "toggle fires",
			'ActionId', "ToggleFires",
			'ActionSortKey', "1780",
			'ActionTranslate', false,
			'ActionName', "Toggle Fires",
			'ActionIcon', "CommonAssets/UI/Icons/bill currency invoice money payment.png",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				ToggleFiresDebug()
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle gas debug",
			'RolloverText', "toggle fires",
			'ActionId', "ToggleGas",
			'ActionSortKey', "1790",
			'ActionTranslate', false,
			'ActionName', "Toggle Gas",
			'ActionIcon', "CommonAssets/UI/Icons/bill currency invoice money payment.png",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				ToggleGasDebug()
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle noise sources",
			'RolloverText', "toggle noise sources",
			'ActionId', "ToggleNoiseSources",
			'ActionSortKey', "1800",
			'ActionTranslate', false,
			'ActionName', "Toggle Noise Sources",
			'ActionIcon', "CommonAssets/UI/Icons/bill currency invoice money payment.png",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				ToggleNoiseSources()
		...
		PlaceObj('XTemplateAction', {
			'comment', "Toggle Weapon Noise",
			'RolloverText', "Toggle Weapon Noise",
			'ActionId', "ToggleWeaponNoise",
			'ActionSortKey', "1810",
			'ActionTranslate', false,
			'ActionName', "Toggle Weapon Noise",
			'ActionIcon', "CommonAssets/UI/Icons/bill currency invoice money payment.png",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle voxel stealth",
			'RolloverText', "toggle voxel stealth",
			'ActionId', "ToggleVoxelStealthDbgVis",
			'ActionSortKey', "1820",
			'ActionTranslate', false,
			'ActionName', "Toggle Voxel Stealth Dbg",
			'ActionIcon', "CommonAssets/UI/Icons/explore eye view vision.png",
			'ActionShortcut', "Alt-Shift-S",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				CycleVSDbgVisMode()
			end,
		...
		PlaceObj('XTemplateAction', {
			'comment', "cycle environment sounds visualization",
			'RolloverText', "cycle environment sounds visualization",
			'ActionId', "CycleEnvSndVis",
			'ActionSortKey', "1824",
			'ActionTranslate', false,
			'ActionName', "Cycle Environmental Sounds Visualization",
			'ActionIcon', "CommonAssets/UI/Icons/explore eye view vision.png",
		...
		PlaceObj('XTemplateAction', {
			'comment', "reset noise sources",
			'RolloverText', "reset noise sources",
			'ActionId', "ResetNoiseSources",
			'ActionSortKey', "1830",
			'ActionTranslate', false,
			'ActionName', "Reset Noise Sources",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				ResetNoiseSources()
			end,
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Display target dummies",
			'ActionId', "ToggleTargetDummies",
			'ActionSortKey', "1840",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Display line of sight lines from the selected objects to his enemies",
			'ActionId', "ToggleLOS",
			'ActionSortKey', "1850",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Display line of fire lines from the selected objects to his enemies",
			'ActionId', "ToggleLOF",
			'ActionSortKey', "1860",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Display line of fire lines from the selected objects eyes",
			'ActionId', "ToggleLOF_Eyes",
			'ActionSortKey', "1861",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Display line of fire lines from the selected object to his next enemy",
			'ActionId', "LOFNextEnemy",
			'ActionSortKey', "1870",
			'ActionTranslate', false,
			'ActionName', "Toggle LOF Next Enemy",
			'ActionIcon', "CommonAssets/UI/Icons/bill currency invoice money payment.png",
			'OnAction', function (self, host, source, ...)
				if not Platform.developer then return end
				DbgDrawToggleLOF()
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', "Cycles through different experimental LOS modes",
			'ActionId', "CycleLOS",
			'ActionSortKey', "1880",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle ap costs",
			'RolloverText', "toggle ap costs",
			'ActionId', "ToggleAPCosts",
			'ActionSortKey', "1890",
			'ActionTranslate', false,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ToggleDistractedDebug",
			'ActionSortKey', "2950",
			'ActionTranslate', false,
			'ActionName', "Toggle Distracted Debug",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ToggleDistanceDebug",
			'ActionSortKey', "3000",
			'ActionTranslate', false,
			'ActionName', "Toggle Distance Debug",
			'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "camera",
		'ActionMode', "Game",
		'BindingsMenuCategory', "Camera",
	}, {
		PlaceObj('XTemplateAction', {
			'ActionId', "actionPanUp",
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1900",
			'ActionName', T(860699076265, --[[XTemplate GameShortcuts ActionName]] "Pan Up"),
			'ActionShortcut', "W",
			'ActionShortcut2', "Up",
			'ActionBindable', true,
			'ActionMouseBindable', false,
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1910",
			'ActionName', T(468155182806, --[[XTemplate GameShortcuts ActionName]] "Pan Down"),
			'ActionShortcut', "S",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1920",
			'ActionName', T(628692606069, --[[XTemplate GameShortcuts ActionName]] "Pan Left"),
			'ActionShortcut', "A",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1930",
			'ActionName', T(526927962316, --[[XTemplate GameShortcuts ActionName]] "Pan Right"),
			'ActionShortcut', "D",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCamRotateWithMouse",
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1940",
			'ActionName', T(204397672331, --[[XTemplate GameShortcuts ActionName]] "Camera Rotation (Hold)"),
			'ActionShortcut', "MouseM",
			'ActionBindSingleKey', true,
		}),
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1950",
			'ActionName', T(779188867578, --[[XTemplate GameShortcuts ActionName]] "Rotate Left"),
			'ActionShortcut', "Q",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionBindSingleKey', true,
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1960",
			'ActionName', T(789644553765, --[[XTemplate GameShortcuts ActionName]] "Rotate Right"),
			'ActionShortcut', "E",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionBindSingleKey', true,
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1970",
			'ActionName', T(978592762508, --[[XTemplate GameShortcuts ActionName]] "Zoom In"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionBindSingleKey', true,
		}),
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "ForwardToC",
			'ActionSortKey', "1980",
			'ActionName', T(449821348034, --[[XTemplate GameShortcuts ActionName]] "Zoom Out"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'ActionBindSingleKey', true,
		}),
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCamFloorUp",
			'ActionSortKey', "1990",
			'ActionName', T(540203561148, --[[XTemplate GameShortcuts ActionName]] "Floor Up"),
			'ActionShortcut', "T",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCamFloorDown",
			'ActionSortKey', "2000",
			'ActionName', T(569509621088, --[[XTemplate GameShortcuts ActionName]] "Floor Down"),
			'ActionShortcut', "G",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCamOverview",
			'ActionMode', "Game",
			'ActionSortKey', "2010",
			'ActionName', T(842838970476, --[[XTemplate GameShortcuts ActionName]] "Overview Camera"),
			'ActionShortcut', "O",
			...
			'BindingsMenuCategory', "Camera",
			'OnAction', function (self, host, source, ...)
				if cameraTac.GetForceOverview() then return "disabled" end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionCamReset",
			'ActionSortKey', "2020",
			'ActionName', T(942514416310, --[[XTemplate GameShortcuts ActionName]] "Reset Camera"),
			'ActionGamepad', "LeftThumbClick",
			'ActionBindSingleKey', true,
			'OnAction', function (self, host, source, ...)
				ResetTacticalCamera()
			end,
			'__condition', function (parent, context) return Platform.trailer end,
		}),
		PlaceObj('XTemplateAction', {
			'ActionId', "actionHideAll",
			'ActionMode', "ForwardToC",
			'ActionSortKey', "2030",
			'ActionName', T(257743841672, --[[XTemplate GameShortcuts ActionName]] "Hide All Walls"),
	...
	PlaceObj('XTemplateAction', {
		'ActionId', "actionCloseTutorialPopup",
		'ActionSortKey', "31",
		'ActionGamepad', "+ButtonB",
		'ActionState', function (self, host)
			if GetDialog("InGameMenu") then return "disabled" end
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "EndTurn",
			'ActionSortKey', "2040",
			'ActionName', T(217018288574, --[[XTemplate GameShortcuts ActionName]] "End Turn"),
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionGamepad', "RightTrigger-ButtonB",
			'ActionState', function (self, host)
				return gv_DeploymentStarted and "enabled" or "disabled"
			end,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2060",
			'ActionTranslate', false,
			'ActionName', "Attack Aim",
			'ActionShortcut', "MouseR",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionAttackAimGamepadReverse",
			'ActionSortKey', "1",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "toggleHide",
			'ActionSortKey', "2070",
			'ActionName', T(665673507980, --[[XTemplate GameShortcuts ActionName]] "Sneak Mode"),
			'ActionShortcut', "H",
			'ActionBindable', true,
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'comment', "NOT IMPLEMENTED; Added so DiplayName can go into loc",
			'ActionId', "groupMove",
			'ActionSortKey', "2069",
			'ActionName', T(757832582030, --[[XTemplate GameShortcuts ActionName]] "Move squad"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
		}),
		PlaceObj('XTemplateAction', {
			'ActionId', "toggleActivePause",
			'ActionSortKey', "2069",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2080",
			'ActionTranslate', false,
			'ActionName', "Pause Game (Developer Mode)",
			'ActionGamepad', "ButtonY",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				TogglePause()
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionPauseGameKeyboard",
			'ActionSortKey', "2081",
			'ActionTranslate', false,
			'ActionName', "Pause Game (Developer Mode)",
			'ActionShortcut', "Pause",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
				TogglePause()
			end,
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2110",
			'ActionTranslate', false,
			'ActionName', "Toggle High Speed",
			'ActionShortcut', "Numpad *",
			'ActionShortcut2', "Shift-8",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Movement End Stance Up (DONT CHANGE SORT)",
			'RolloverText', T(225394721511, --[[XTemplate GameShortcuts RolloverText]] "Change Movement End Stance Up"),
			'ActionId', "MovementEndStanceUp",
			'ActionSortKey', "0",
			'ActionName', T(935905874257, --[[XTemplate GameShortcuts ActionName]] "Change Stance Up while moving"),
		...
		PlaceObj('XTemplateAction', {
			'comment', "Movement End Stance Down (DONT CHANGE SORT)",
			'RolloverText', T(972189872195, --[[XTemplate GameShortcuts RolloverText]] "Change Movement End Stance Down"),
			'ActionId', "MovementEndStanceDown",
			'ActionSortKey', "0",
			'ActionName', T(315135164705, --[[XTemplate GameShortcuts ActionName]] "Change Stance Down while moving"),
			...
			'OnAction', function (self, host, source, ...)
				local dialog = GetDialog("IModeCombatMovement")
				--do a check of the unit ap if it can do based on targeting_blackboard.last_pos AND if dialog movem avatar is true
		...
		PlaceObj('XTemplateAction', {
			'comment', "Change Stance Up",
			'RolloverText', T(261888702775, --[[XTemplate GameShortcuts RolloverText]] "Change Stance Up"),
			'ActionId', "ChangeStanceUp",
			'ActionSortKey', "2120",
			'ActionName', T(421573979767, --[[XTemplate GameShortcuts ActionName]] "Change Stance Up"),
			'ActionShortcut', "Z",
			'ActionBindable', true,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2130",
			'ActionName', T(910731295482, --[[XTemplate GameShortcuts ActionName]] "Change Stance Down"),
			'ActionShortcut', "X",
			'ActionBindable', true,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'RolloverText', T(972189872195, --[[XTemplate GameShortcuts RolloverText]] "Change Movement End Stance Down"),
			'ActionId', "MovementKeepStance",
			'ActionSortKey', "2160",
			'ActionName', T(227386015067, --[[XTemplate GameShortcuts ActionName]] "Toggle Keep Stance while Moving"),
			'ActionShortcut', "V",
			'ActionGamepad', "LeftThumbClick",
			'ActionBindable', true,
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionSortKey', "2170",
			'ActionTranslate', false,
			'ActionName', "TestCombatStartFromAltShortcut1",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "TestCombatStartFromAltShortcut2",
			'ActionSortKey', "2180",
			'ActionTranslate', false,
			'ActionName', "TestCombatStartFromAltShortcut2",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "TestCombatStartFromAltShortcut3",
			'ActionSortKey', "2190",
			'ActionTranslate', false,
			'ActionName', "TestCombatStartFromAltShortcut3",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "TestCombatStartFromAltShortcut4",
			'ActionSortKey', "2200",
			'ActionTranslate', false,
			'ActionName', "TestCombatStartFromAltShortcut4",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "TestCombatStartFromAltShortcut5",
			'ActionSortKey', "2210",
			'ActionTranslate', false,
			'ActionName', "TestCombatStartFromAltShortcut5",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "TogglePrependTranslateID",
			'ActionSortKey', "2211",
			'ActionTranslate', false,
			'ActionName', "TogglePrependTranslateID",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "Game, UI",
			'ActionSortKey', "2220",
			'ActionName', T(534421707752, --[[XTemplate GameShortcuts ActionName]] "Next Unit"),
			'ActionShortcut', "Tab",
			'ActionBindable', true,
			'ActionState', function (self, host)
				if  g_ZuluMessagePopup and #g_ZuluMessagePopup > 0 then return "disabled" end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionNextSquad",
			'ActionMode', "Game, UI",
			'ActionSortKey', "2230",
			'ActionName', T(519154837104, --[[XTemplate GameShortcuts ActionName]] "Next Squad"),
			'ActionShortcut', "Ctrl-Tab",
			...
			'OnAction', function (self, host, source, ...)
				...
				-- Select first unit from this squad.
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ViewUnit",
			'ActionSortKey', "2240",
			'ActionName', T(483343243578, --[[XTemplate GameShortcuts ActionName]] "Center on Selected Merc"),
			'ActionShortcut', "Home",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "Teleport",
			'RolloverText', "Teleport",
			'ActionId', "Teleport",
			'ActionMode', "Game",
			'ActionSortKey', "2260",
			'ActionTranslate', false,
			'ActionName', "Teleport",
			'ActionIcon', "CommonAssets/UI/Icons/gps location map my location target.png",
		...
		PlaceObj('XTemplateAction', {
			'comment', "cycle mode",
			'ActionId', "CrosshairCycleFiringMode",
			'ActionSortKey', "2270",
			'ActionName', T(853914412265, --[[XTemplate GameShortcuts ActionName]] "Cycle Firing Modes"),
			'ActionShortcut', "\\",
			'ActionBindable', true,
			'BindingsMenuCategory', "CombatActions",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateForEach', {
			'comment', "CombatActions -> Shotcut Actions",
			'array', function (parent, context) return table.keys2(CombatActions) end,
			'run_after', function (child, context, item, i, n, last)
				...
				local s1 = Platform.developer and item.ActionShortcutDev or item.ActionShortcut or nil
				local s2 = item.ActionShortcut2 or nil
				local sg = item.ActionGamepad or nil
				child:SetActionShortcuts(s1, s2, sg)
			...
			PlaceObj('XTemplateAction', {
				...
				'OnAction', function (self, host, source, ...)
					-- Only actions which are available are spawned by the action bar
					-- which means that if the shortcut got to this action, it is disabled
					PlayFX("IactDisabled")
				end,
				'IgnoreRepeated', true,
				'replace_matching_id', true,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectBasicAttack",
			'ActionMode', "Game",
			'ActionSortKey', "2280",
			'ActionName', T(573776065280, --[[XTemplate GameShortcuts ActionName]] "Primary Attack"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
				local selObj = Selection and Selection[1]
				if not selObj or not selObj.ui_actions then return "hidden" end
			...
			'OnAction', function (self, host, source, ...)
				...
				if not selObj or not selObj.ui_actions then return end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectHeavyAttack",
			'ActionMode', "Game",
			'ActionSortKey', "2290",
			'ActionName', T(964076579032, --[[XTemplate GameShortcuts ActionName]] "Heavy Weapon Attack"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "Game, UI",
			'ActionSortKey', "2300",
			'ActionName', T(499625519053, --[[XTemplate GameShortcuts ActionName]] "Reload"),
			'ActionShortcut', "R",
			'ActionGamepad', "RightTrigger-DPadLeft",
			'ActionBindable', true,
			'BindingsMenuCategory', "CombatActions",
			'OnAction', function (self, host, source, ...)
				CreateGameTimeThread(function()
					...
					if not mode_dlg or not SelectedObj then return end
					if HasCombatActionInProgress(SelectedObj) then return end
					
					-- Go through the UI and click on all the reload buttons
					...
					for i, w in ipairs(weapons) do
						if QuickReloadButton(false, w, #weapons > 1) then
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectSignatureAbility",
			'ActionSortKey', "2310",
			'ActionName', T(824740449786, --[[XTemplate GameShortcuts ActionName]] "Talent"),
			'ActionShortcut', "K",
			'ActionBindable', true,
			'ActionBindSingleKey', true,
			'BindingsMenuCategory', "CombatActions",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectOverwatch",
			'ActionSortKey', "2320",
			'ActionName', T(733210936253, --[[XTemplate GameShortcuts ActionName]] "Overwatch / Set Machine Gun"),
			'ActionShortcut', "Y",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectTakedown",
			'ActionSortKey', "2340",
			'ActionName', T(983398909721, --[[XTemplate GameShortcuts ActionName]] "Prepare Takedown"),
			'ActionShortcut', "B",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'BindingsMenuCategory', "CombatActions",
			...
			'OnAction', function (self, host, source, ...)
				...
				local action = XActionRedirectToCombatAction(self.ActionId, selObj)
				if action and action:GetVisibility(Selection)
				 == "enabled" then
					action:UIBegin(Selection)
				end
			end,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectBandage",
			'ActionSortKey', "2350",
			'ActionName', T(101582787580, --[[XTemplate GameShortcuts ActionName]] "Bandage"),
			'ActionShortcut', "N",
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'BindingsMenuCategory', "CombatActions",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectThrowGrenade",
			'ActionSortKey', "2360",
			'ActionName', T(815844645044, --[[XTemplate GameShortcuts ActionName]] "Throw"),
			'ActionShortcut', "Shift-G",
			'ActionBindable', true,
			'ActionBindSingleKey', true,
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionRedirectCancelShot",
			'ActionSortKey', "2370",
			'ActionName', T(534909737868, --[[XTemplate GameShortcuts ActionName]] "Distracting Shot"),
			'ActionBindable', true,
			'ActionMouseBindable', false,
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "HighlightInteractables",
			'ActionSortKey', "2380",
			'ActionName', T(125097084556, --[[XTemplate GameShortcuts ActionName]] "Highlight Interactables"),
			'ActionShortcut', "Alt",
			'ActionGamepad', "LeftThumbClick",
			'ActionBindable', true,
			'ActionMouseBindable', false,
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionMode', "Game",
			'ActionSortKey', "2400",
			'ActionName', T(499856472762, --[[XTemplate GameShortcuts ActionName]] "Select All Mercs in Squad"),
			'ActionShortcut', "~",
			'ActionGamepad', "ButtonX",
			'ActionBindable', true,
			'ActionBindSingleKey', true,
	...
	PlaceObj('XTemplateAction', {
		'ActionId', "rolloverMoreInfo",
		'ActionSortKey', "2410",
		'ActionName', T(615097358487, --[[XTemplate GameShortcuts ActionName]] "Rollover More Info"),
	...
	PlaceObj('XTemplateAction', {
		'ActionId', "GamepadOpenCommandMenu",
		'ActionSortKey', "2943",
		'ActionGamepad', "ButtonY",
		'ActionBindSingleKey', true,
		'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'comment', "tactical/exploration gamepad controls",
		'ActionMode', "Game",
	}, {
		PlaceObj('XTemplateAction', {
			'ActionId', "PrimaryClickUp",
			'ActionSortKey', "2420",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadTargetingExit",
			'ActionSortKey', "2489",
			'ActionGamepad', "ButtonB",
			'ActionState', function (self, host)
				if not GetUIStyleGamepad() then return "disabled" end
				if not g_GamepadTarget then return "disabled" end
			end,
			'OnAction', function (self, host, source, ...)
				local igi = GetInGameInterfaceModeDlg()
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadAimTakeCoverOrOverwatch",
			'ActionSortKey', "2480",
			'ActionGamepad', "RightTrigger-ButtonY",
			'ActionState', function (self, host)
				if not GetUIStyleGamepad() then return "disabled" end
			...
			'OnAction', function (self, host, source, ...)
				...
				if not IsKindOf(igi, "IModeCombatAttackBase") then
					...
					if action and action.AimType ~= "parabola aoe" then
						local firstTarget = GetTargetsToShowAboveActionBarSorted(unit, igi)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadChangeWeapons",
			'ActionSortKey', "2071",
			'ActionGamepad', "RightTrigger-DPadRight",
			'BindingsMenuCategory', "CombatActions",
			'ActionState', function (self, host)
				if not GetUIStyleGamepad() then return "disabled" end
			end,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadActionBarFocusLeft",
			'ActionSortKey', "1",
			'ActionGamepad', "DPadLeft",
			'ActionState', function (self, host)
				if not GetUIStyleGamepad() then return "disabled" end
				if GetDialog("PhotoMode") then return "disabled" end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadActionBarFocusRight",
			'ActionSortKey', "1",
	...
	PlaceObj('XTemplateAction', {
		...
		'ActionSortKey', "2500",
		'ActionName', T(988782431105, --[[XTemplate GameShortcuts ActionName]] "Quick Save"),
		'ActionShortcut', "Shift-F8",
		'ActionBindable', true,
		'OnAction', function (self, host, source, ...)
			QuickSave()
		end,
	...
	PlaceObj('XTemplateAction', {
		...
		'ActionSortKey', "2510",
		'ActionName', T(364634199316, --[[XTemplate GameShortcuts ActionName]] "Quick Load"),
		'ActionShortcut', "Shift-F9",
		'ActionBindable', true,
		'OnAction', function (self, host, source, ...)
			QuickLoad()
		end,
	...
	PlaceObj('XTemplateAction', {
		...
		'BindingsMenuCategory', "Satellite",
		'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			...
			'OnAction', function (self, host, source, ...)
				...
				if CampaignPauseReasons["SatelliteConflict"] then
					...
					if not conflictSector then return end
					if g_SatelliteUI.rollover_sector then g_SatelliteUI:OnSectorRollover(nil, g_SatelliteUI.rollover_sector, false) end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "GamepadCenterSquad",
			'ActionSortKey', "1",
			'OnAction', function (self, host, source, ...)
				local selSquad = gv_Squads[g_CurrentSquad]
				if not selSquad or not selSquad.CurrentSector then return end
		...
		PlaceObj('XTemplateAction', {
			...
			PlaceObj('XTemplateAction', {
				'comment', "used in the satellite context menu",
				'ActionId', "idCancelTravel",
				'ActionMode', "Satellite",
				'ActionSortKey', "2550",
				'ActionName', T(459198625487, --[[XTemplate GameShortcuts ActionName]] "Stop Travel"),
				'ActionGamepad', "ButtonB",
				'ActionMouseBindable', false,
				'ActionBindSingleKey', true,
				'ActionButtonTemplate', "PDACommonButton",
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "CycleSquadsInRollover",
				'ActionMode', "Satellite",
				'ActionSortKey', "2560",
				'ActionShortcut', "H",
				'ActionGamepad', "LeftThumbClick",
				'ActionState', function (self, host)
					...
					if not rollover then return "hidden" end
					return "enabled"
				end,
				'OnAction', function (self, host, source, ...)
					local rollover = RolloverWin and RolloverWin.idCurrentSquadCont
					...
					if currentSquad > #allSquads then currentSquad = 1 end
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionMode', "Satellite",
				'ActionSortKey', "2570",
				'ActionName', T(736577684433, --[[XTemplate GameShortcuts ActionName]] "Travel/Cancel Travel"),
				'ActionShortcut', "P",
				'ActionBindable', true,
				'ActionState', function (self, host)
				...
				'OnAction', function (self, host, source, ...)
					...
					if dlg and dlg.selected_squad then
						...
						-- Sector rollover wont be called after destination selection mode is entered.
						-- Check manually.
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idGoAboveground",
				'ActionMode', "Satellite",
				'ActionSortKey', "2590",
				'ActionName', T(443684614429, --[[XTemplate GameShortcuts ActionName]] "Go Aboveground"),
				'ActionShortcut', "Ctrl-P",
				'ActionState', function (self, host)
					local dlg = GetSatelliteDialog()
					if not dlg then return "hidden" end
					--local squad = dlg.selected_squad
					local squad, sector_id = GetSatelliteContextMenuValidSquad()
					if not squad or (not squad.CurrentSector or squad.arrival_squad) then return "disabled" end
					if gv_Sectors[squad.CurrentSector].GroundSector == sector_id then
						sector_id = squad.CurrentSector
					end
					
					if not (IsSectorUnderground(sector_id) and not IsConflictMode(sector_id)) then
						return "hidden"
					end
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idOperations",
				'ActionMode', "Satellite",
				'ActionSortKey', "2600",
				'ActionName', T(343521841000, --[[XTemplate GameShortcuts ActionName]] "<ActionName_ActivitiesCount()>"),
				'ActionShortcut', "O",
				'ActionGamepad', "RightShoulder",
				'ActionBindable', true,
				'ActionState', function (self, host)
					local squad, sector_id = GetSatelliteContextMenuValidSquad()
					if not squad then -- call from toolbar buttons
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "actionContextMenuViewSectorStash",
				'ActionMode', "Satellite",
				'ActionSortKey', "2610",
				'ActionName', T(956547202009, --[[XTemplate GameShortcuts ActionName]] "Sector Stash"),
				'ActionShortcut', "H",
				'ActionBindable', true,
				'ActionMouseBindable', false,
				'ActionState', function (self, host)
					if not g_SatelliteUI then return "disabled" end
					...
					if not sector or not sector.Map then return "hidden" end
			...
			PlaceObj('XTemplateAction', {
				'comment', "used in the satellite info panel",
				'ActionId', "idExplore",
				'ActionMode', "Satellite",
				'ActionSortKey', "2640",
				'ActionName', T(846703701561, --[[XTemplate GameShortcuts ActionName]] "Tactical View"),
				'ActionState', function (self, host)
					local squad, sector_id = GetSatelliteContextMenuValidSquad()
					if not squad then -- call from toolbar buttons
						squad, sector_id = GetSatelliteContextMenuValidSquad("selected")			
			...
			PlaceObj('XTemplateAction', {
				...
				'OnAction', function (self, host, source, ...)
					...
					if not curSelIdx then return end
					...
					if not newSquad or not g_SatelliteUI then return end
					g_SatelliteUI:SelectSquad(newSquad)
				end,
			}),
			PlaceObj('XTemplateAction', {
				'ActionId', "GamepadNextSquad",
				'ActionSortKey', "1",
				'ActionGamepad', "LeftTrigger-RightShoulder",
				'ActionState', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "SatelliteControlOverlay",
			'ActionMode', "Satellite",
			'ActionSortKey', "2630",
			'ActionTranslate', false,
			'ActionName', "Control Overlay",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "SatelliteIntelOverlay",
			'ActionMode', "Satellite",
			'ActionSortKey', "2640",
			'ActionTranslate', false,
			'ActionName', "Intel Overlay",
			'ActionMouseBindable', false,
			'OnAction', function (self, host, source, ...)
	...
	PlaceObj('XTemplateAction', {
		'__condition', function (parent, context) return Platform.developer or Platform.trailer end,
	}, {
		PlaceObj('XTemplateAction', {
	...
	PlaceObj('XTemplateAction', {
		...
		PlaceObj('XTemplateAction', {
			...
			'RolloverText', "toggle RTS camera",
			'ActionId', "ToggleRTSCamera",
			'ActionSortKey', "2700",
			'ActionTranslate', false,
			'ActionName', "Toggle RTS Camera",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit animation",
			'RolloverText', "toggle unit animation",
			'ActionId', "ToggleUnitAnimation",
			'ActionSortKey', "2710",
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Animation",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Command",
			'ActionShortcut', "Ctrl-Alt-Shift-T",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit anim duration",
			'RolloverText', "toggle unit anim duration",
			'ActionId', "ToggleUnitAnimDuration",
			'ActionSortKey', "2720",
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Anim Duration",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit anim style",
			'RolloverText', "toggle unit anim style",
			'ActionId', "ToggleUnitAnimStyle",
			'ActionSortKey', "2730",
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Anim Style",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle IK",
			'RolloverText', "toggle inverse kinematic",
			'ActionId', "IKDisabled",
			'ActionSortKey', "2740",
			'ActionTranslate', false,
			'ActionName', "Toggle IK",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle placing left hand on weapon grip",
			'RolloverText', "toggle placing left hand on weapon grip",
			'ActionId', "WeaponGripIKDisabled",
			'ActionSortKey', "2750",
			'ActionTranslate', false,
			'ActionName', "Toggle IK Weapon Grip",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle unit orientation",
			'RolloverText', "toggle unit orientation",
			'ActionId', "ToggleUnitOrientation",
			'ActionSortKey', "2770",
			'ActionTranslate', false,
			'ActionName', "Toggle Unit Orientation",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle selected unit animation",
			'RolloverText', "toggle unit animation",
			'ActionId', "ToggleSelectedUnitAnimation",
			'ActionSortKey', "2780",
			'ActionTranslate', false,
			'ActionName', "Toggle Selected Unit Animation",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle pain animation",
			'RolloverText', "toggle pain animation",
			'ActionId', "TogglePainAnimation",
			'ActionSortKey', "2790",
			'ActionTranslate', false,
			'ActionName', "Toggle Pain Animation",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle right hand grip animation",
			'RolloverText', "toggle right hand grip animation",
			'ActionId', "ToggleRightHandGripAnimation",
			'ActionSortKey', "2800",
			'ActionTranslate', false,
			'ActionName', "Toggle Right Hand Grip Animation",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle turn animation",
			'RolloverText', "toggle turn animation",
			'ActionId', "ToggleTurnAnimation",
			'ActionSortKey', "2810",
			'ActionTranslate', false,
			'ActionName', "Toggle Turn Animation",
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'comment', "toggle broken state",
			'RolloverText', "toggle broken state",
			'ActionId', "ToggleBrokenState",
			'ActionSortKey', "2820",
			'ActionTranslate', false,
			'ActionName', "Toggle Broken State",
			'OnAction', function (self, host, source, ...)
					...
					if IsValid(o) then
						...
						if cur_state ~= "broken" then
							...
							if o:HasState(new_state) then
								...
								print(o.class .. " - something broke when restoring to previous state, ¯\\_(ツ)_/¯")
							end
						end
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "MercenariesMoveStyle",
			'ActionSortKey', "3000",
			'ActionTranslate', false,
			'ActionName', "Mercenaries move style...",
			'ActionIcon', "CommonAssets/UI/Menu/folder.tga",
			'OnActionEffect', "popup",
			'replace_matching_id', true,
		}, {
			PlaceObj('XTemplateForEach', {
				'comment', "Set merc default move style",
				'array', function (parent, context) return GetMoveStyleCombo() end,
				'run_after', function (child, context, item, i, n, last)
