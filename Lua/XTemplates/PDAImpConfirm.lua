...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(857242053635, --[[XTemplate PDAImpConfirm name]] "HeaderButtonId"),
	}),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(289666038916, --[[XTemplate PDAImpConfirm Text]] "Welcome to the Institute for Mercenary Profiling (I.M.P.)"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Padding', box(0, 0, 0, 0),
					...
					'Translate', true,
					'Text', T(649913287419, --[[XTemplate PDAImpConfirm Text]] "At I.M.P. we know the mercenary trade. We can offer you advice that will help you handle the pressures that a mission can put on you, and suggest custom tailored mercenaries for your team. We know you better than yourself!"),
				}),
				}),
			}),
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDAIMPContentTitle",
						'Translate', true,
						'Text', T(859459210130, --[[XTemplate PDAImpConfirm Text]] "How much"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						'Padding', box(0, 0, 0, 0),
						...
						'TextStyle', "PDAIMPContentText",
						'Translate', true,
						'Text', T(213252108281, --[[XTemplate PDAImpConfirm Text]] "You have a group discount: for a mere <money(6999)> (down from <money(11999)>) you can take a P.E.T. (Personality Evaluation Test) and get a mercenary certificate allowing you to field a mercenary right now, free of additional charges!\n\nYour friend, your spouse or you yourself - it's only up to you to decide who gets the action!"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XContextFrame",
						'IdNode', false,
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'Icon', "UI/PDA/imp_radio_button",
									'IconRows', 2,
								}),
								PlaceObj('XTemplateWindow', {
									'Id', "idBack",
									'Margins', box(35, 4, 4, 4),
									'Dock', "box",
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XText",
									...
									'Translate', true,
									'Text', T(265050079968, --[[XTemplate PDAImpConfirm Text]] "I will take the P.E.T."),
								}, {
									PlaceObj('XTemplateFunc', {
										'name', "OnMouseButtonDown(self, pos, button)",
										'func', function (self, pos, button)
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "PDAIMPAnswer",
									'Translate', true,
									'Text', T(567105026025, --[[XTemplate PDAImpConfirm Text]] "I will skip this wonderful test and select manually"),
								}, {
									PlaceObj('XTemplateFunc', {
										'name', "OnMouseButtonDown(self, pos, button)",
										'func', function (self, pos, button)
