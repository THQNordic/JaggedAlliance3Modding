...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Image', "UI/PDA/T_Icon_Pause",
			'ImageColor', RGBA(55, 49, 49, 255),
			'DisabledImageColor', RGBA(130, 128, 120, 255),
		}),
		PlaceObj('XTemplateFunc', {
			'name', "StartBlinking(self)",
			'func', function (self)
				if self:GetThread("blink-thread") then return end
		...
		PlaceObj('XTemplateFunc', {
			'name', "StopBlinking(self, yellow)",
			'func', function (self, yellow)
	...
	PlaceObj('XTemplateProperty', {
		'id', "CenterImageColorization",
		'editor', "color",
		'default', RGBA(55, 49, 49, 255),
		'Set', function (self, value)
