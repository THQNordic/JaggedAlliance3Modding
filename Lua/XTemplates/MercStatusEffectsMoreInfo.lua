	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T(195286264466, --[[XTemplate MercStatusEffectsMoreInfo Text]] "INFO"),
				'TextVAlign', "bottom",
			}),
			}),
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return IsKindOf(context, "StatusEffectObject") and context:GetUIVisibleStatusEffects() or empty_table end,
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(110936112713, --[[XTemplate MercStatusEffectsMoreInfo Text]] "<DisplayName>"),
						}),
						}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'Clip', false,
						'UseClipBox', false,
						'TextStyle', "StatusEffectLastsUntilLabel",
						'ContextUpdateOnOpen', true,
						'OnContextUpdate', function (self, context, ...)
							...
							if g_Combat then
								...
								elseif expiresIn == 1 then
									...
									self:SetText(T{484004363812, "<num> turns left", num = expiresIn})
								end
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(798944656602, --[[XTemplate MercStatusEffectsMoreInfo Text]] "<Description>"),
					}),
					}),
				}),
			}),
