...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'comment', "table",
		'__condition', function (parent, context) return context.operation and context.operation:SectorOperationStats(context.sector, "check") end,
		...
		PlaceObj('XTemplateWindow', {
			...
			'Translate', true,
			'Text', T(273625749465, --[[XTemplate SectorOperationStatsTableUI Text]] "Sector Details"),
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XFrame",
			'VAlign', "top",
		...
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return context.operation and context.operation:SectorOperationStats(context.sector) or context end,
			'__class', "XContentTemplate",
			'Id', "idTable",
			'LayoutMethod', "VList",
		}, {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'TextStyleRight', "PDAActivityStatsValueText",
						}),
						}),
					PlaceObj('XTemplateWindow', {
						'__class', "XFrame",
