...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "PDAQuestsTabButtonClass",
		'HAlign', "left",
		'MinWidth', 130,
		'MaxWidth', 130,
		...
		'FXPress', "EmailUI buttons click sounds",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XText",
				'Id', "idText",
				'TextStyle', "PDAQuests_TabSelected",
				'Translate', true,
				'Text', T(437005377168, --[[XTemplate PDAQuestsTabButton Text]] "Notes"),
			}),
			}),
		}),
})
