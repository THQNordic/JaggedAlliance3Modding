...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "PDAMessengerClass",
		'Dock', "box",
		'Background', RGBA(30, 30, 35, 115),
	}, {
		PlaceObj('XTemplateAction', {
			'ActionId', "actionClose",
			'ActionName', T(352357046851, --[[XTemplate PDAMessenger ActionName]] "Close"),
			'ActionShortcut', "Escape",
			'ActionGamepad', "ButtonB",
			'OnAction', function (self, host, source, ...)
				if IsValidThread(host:GetThread("conversation_thread")) and not host.idClose.enabled then return "break" end
				if not host.ChildrenHandleMouse then return "break" end
				if host:GetThread("wait_close") then return "break" end
				host:CreateThread("wait_close", function()
					-- Ensure idle doesn't interrupt us.
					host:DeleteThread("idle_wait")
				
					host:ForcePlayChat("PlayerTerminates")
					Sleep(400)
					if host.pendingActionOnClose then host.pendingActionOnClose() end
					host:Close()
				end)
				return "break"
			end,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "actionAdvance",
			'ActionTranslate', false,
			'ActionName', "Advance (Unused)",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionState', function (self, host)
				...
				return not host.conversation_ended and not ending_node and "enabled" or "disabled"
			end,
			'OnAction', function (self, host, source, ...)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "gamepadMoveDurationRight",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "gamepadMoveDurationLeft",
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, ...)
				if self.anyKeyClose and 
					self.window_state ~= "destroying" and
					self.window_state ~= "closing" then
					self:Close()
				end
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self)
				...
				if not pdaDialog then return end
		...
		PlaceObj('XTemplateWindow', {
			...
			'MaxWidth', 910,
			'MaxHeight', 590,
			'Image', "UI/PDA/Chat/T_Call_Background",
			...
			PlaceObj('XTemplateWindow', {
				...
				'LayoutMethod', "HList",
				'LayoutHSpacing', 5,
				'Background', RGBA(65, 130, 158, 255),
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XFrame",
					'HAlign', "left",
					...
					PlaceObj('XTemplateWindow', {
						...
						'MaxWidth', 32,
						'MaxHeight', 32,
						'Image', "UI/PDA/snype_logo",
						'ImageFit', "stretch",
						'ImageColor', RGBA(91, 142, 169, 255),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'VAlign', "center",
					'TextStyle', "PDAMessengerHeader",
					'Translate', true,
					'Text', T(255085547679, --[[XTemplate PDAMessenger Text]] "snype"),
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					...
					'Visible', false,
					'FoldWhenHidden', true,
					'TextStyle', "PDAMessengerOtherPlayer",
					'Translate', true,
					'Text', T(341907478094, --[[XTemplate PDAMessenger Text]] "Controlled by <OtherPlayerName()>"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XTextButton",
					'Id', "idXButton",
					...
					'OnPressParam', "actionClose",
					'RolloverBackground', RGBA(0, 0, 0, 0),
					'PressedBackground', RGBA(0, 0, 0, 0),
					'TextStyle', "PDACommonButtonChatXButton",
					'Text', "X",
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					...
					'Translate', true,
					'Text', T(888523083513, --[[XTemplate PDAMessenger Text]] "<color 249 249 219>v3.02c</color>"),
				}),
				}),
			PlaceObj('XTemplateWindow', {
				'comment', "footer (this needs to be first to be considered for the box)",
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							'__condition', function (parent, context) return context.HireStatus == "Hired" end,
							'__class', "XText",
							'Padding', box(6, 0, 0, 0),
							'HAlign', "center",
							'VAlign', "center",
					...
					PlaceObj('XTemplateWindow', {
						'__context', function (parent, context) return parent:ResolveId("node") end,
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "PDACommonButton",
									'Translate', true,
									'Text', T(841161275332, --[[XTemplate PDAMessenger Text]] "Contract Duration"),
								}),
								PlaceObj('XTemplateTemplate', {
									'__template', "SliderMessenger",
									'Id', "idSlider",
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(701938343272, --[[XTemplate PDAMessenger Text]] "<DPadLeft>"),
									}),
									PlaceObj('XTemplateWindow', {
										'comment', "gamepad hint",
										'__context', function (parent, context) return "GamepadUIStyleChanged" end,
										...
										'Translate', true,
										'Text', T(523385068989, --[[XTemplate PDAMessenger Text]] "<DPadRight>"),
									}),
									}),
								}),
							PlaceObj('XTemplateWindow', {
								...
								'OnContextUpdate', function (self, context, ...)
									...
									self:SetText(T{404056356754, "<duration> Days: <HireLengthPrice()>", duration = duration})
									XContextControl.OnContextUpdate(self, context)
								end,
								'Translate', true,
							}),
							PlaceObj('XTemplateFunc', {
								'name', "OnScrollTo(self, value)",
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Margins', box(0, -5, 0, -5),
							'HAlign', "left",
							'Image', "UI/PDA/Chat/T_Call_Line_Vertical",
							'SqueezeX', false,
							'SqueezeY', false,
						}),
						PlaceObj('XTemplateWindow', {
							...
							'OnPressEffect', "action",
							'OnPressParam', "actionOffer",
							'RolloverBackground', RGBA(255, 255, 255, 0),
							'PressedBackground', RGBA(255, 255, 255, 0),
							'Icon', "UI/PDA/Chat/T_Call_Offer",
							'TextStyle', "PDACommonButtonChat",
							'Translate', true,
							'Text', T(936753275494, --[[XTemplate PDAMessenger Text]] "Offer"),
						}, {
							PlaceObj('XTemplateFunc', {
							...
							PlaceObj('XTemplateWindow', {
								'comment', "gamepad hint",
								'__context', function (parent, context) return "GamepadUIStyleChanged" end,
								'__parent', function (parent, context) return parent.idIcon end,
								'__class', "XText",
								'Margins', box(0, 0, -5, -5),
								'HAlign', "right",
								'VAlign', "bottom",
								...
								'Translate', true,
								'Text', T(733307953991, --[[XTemplate PDAMessenger Text]] "<ButtonASmall>"),
							}),
							}),
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
						...
						PlaceObj('XTemplateWindow', {
							...
							'RolloverBackground', RGBA(255, 255, 255, 0),
							'PressedBackground', RGBA(255, 255, 255, 0),
							'Icon', "UI/PDA/Chat/T_Call_Hang_Up",
							'TextStyle', "PDACommonButtonChat",
							'Translate', true,
							'Text', T(353688964417, --[[XTemplate PDAMessenger Text]] "Close"),
						}, {
							PlaceObj('XTemplateWindow', {
								'comment', "gamepad hint",
								'__context', function (parent, context) return "GamepadUIStyleChanged" end,
								...
								'Translate', true,
								'Text', T(339334409687, --[[XTemplate PDAMessenger Text]] "<ButtonBSmall>"),
							}),
							}),
						}),
					}),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Id', "idPortrait",
								'Dock', "box",
								'Image', "UI/MercsPortraits/unknown",
								'ImageFit', "height",
					...
					PlaceObj('XTemplateWindow', {
						'comment', "fluff beneath pic",
						'LayoutMethod', "HList",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
							'Dock', "box",
							'Image', "UI/PDA/Chat/T_Call_Name",
							'FrameBox', box(3, 3, 3, 3),
						}),
						PlaceObj('XTemplateWindow', {
							'comment', "merc name",
							...
							'Translate', true,
							'Text', T(436437814010, --[[XTemplate PDAMessenger Text]] "<Nick>"),
							'TextVAlign', "center",
						}),
						PlaceObj('XTemplateWindow', {
							'Dock', "right",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'HAlign', "center",
									'VAlign', "center",
									'Image', "UI/PDA/Chat/T_Call_Icon_Call",
								}),
								}),
							PlaceObj('XTemplateWindow', {
								'__class', "XFrame",
								...
								PlaceObj('XTemplateWindow', {
									...
									'VAlign', "center",
									'Transparency', 125,
									'Image', "UI/PDA/Chat/T_Call_Icon_Video",
									'Desaturation', 255,
								}),
								}),
							}),
					...
					PlaceObj('XTemplateWindow', {
						...
						'HandleMouse', true,
						'MouseCursor', "UI/Cursors/Pda_Hand.tga",
						'Image', "UI/PDA/Chat/T_Call_Ad_01",
						'ImageFit', "smallest",
					}, {
						PlaceObj('XTemplateFunc', {
							'name', "Open",
							...
							'func', function (self, pos, button)
								...
								if host then
									...
									if closeAction then
										...
										host.pendingActionOnClose = function ()
				...
				PlaceObj('XTemplateWindow', nil, {
					...
					PlaceObj('XTemplateWindow', {
						'__class', "PDAMessengerChatLog",
						'Id', "idChat",
						'Padding', box(10, 2, 10, 5),
						'Dock', "box",
						'LayoutMethod', "VList",
						'VScroll', "idScroll",
					}),
