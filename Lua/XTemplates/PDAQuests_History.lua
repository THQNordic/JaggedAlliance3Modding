...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__context', function (parent, context) return gv_HistoryOccurences end,
		'__class', "PDAHistoryClass",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Id', "idWeeks",
					'Margins', box(8, 6, 8, 10),
					'Dock', "box",
					'VScroll', "idWeeksScroll",
					'ShowPartialItems', true,
					'LeftThumbScroll', false,
				}, {
					PlaceObj('XTemplateForEach', {
						'comment', "week",
						'array', function (parent, context) return GetWeeksWithOccurences() end,
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateTemplate', {
								'__template', "PDAQuestsHistoryWeek",
							}),
							PlaceObj('XTemplateWindow', {
								'__class', "XFrame",
								'Margins', box(3, 0, 0, 0),
						...
						PlaceObj('XTemplateForEach', {
							'comment', "day in the week",
							'array', function (parent, context) return GetDaysWithOccurences(context) end,
							...
							PlaceObj('XTemplateTemplate', {
								'__template', "PDAQuestsHistoryDayButton",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateForEach', {
					'comment', "day with occurence",
					'array', function (parent, context) return GetDaysWithOccurences() end,
					'__context', function (parent, context, item, i, n) return SubContext(GetOccurencesByDay(item), {day = item}) end,
					'run_before', function (parent, context, item, i, n, last)
						-- pass a minimum height of items, to prevent too many virtual items spawning upon opening and when scrolling
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "HistoryBodyScrollDown",
			'ActionGamepad', "RightThumbDown",
			'OnAction', function (self, host, source, ...)
				local body = self.host:ResolveId("idHistoryRows")
				if body then
					body:ScrollDown()
				end
			end,
