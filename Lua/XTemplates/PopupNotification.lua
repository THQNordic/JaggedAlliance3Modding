...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionName', T(970488995700, --[[XTemplate PopupNotification ActionName]] "Close"),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(823567872501, --[[XTemplate PopupNotification Text]] "A.I.M. Help Center"),
					'TextVAlign', "center",
				}),
				}),
			PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(332696285596, --[[XTemplate PopupNotification Text]] "<title>"),
								'TextVAlign', "center",
							}),
							PlaceObj('XTemplateWindow', {
								'LayoutMethod', "HList",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											'__context', function (parent, context) return TutorialGetHelpMenuHints() end,
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(545358701817, --[[XTemplate PopupNotification Text]] "<text>"),
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "MessengerScrollbar",
										'Id', "idTextScrollBar",
