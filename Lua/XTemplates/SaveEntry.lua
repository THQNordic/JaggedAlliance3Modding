...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'HandleKeyboard', false,
			'HandleMouse', false,
			'TextStyle', "MMAutoSave",
			'Translate', true,
			'Text', T(171355595875, --[[XTemplate SaveEntry Text]] "[AUTOSAVE]"),
			'WordWrap', false,
			'TextVAlign', "center",
		}),
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			...
			'func', function (self, rollover)
				...
				if rollover then
					local editableField
					if self.parent:ResolveId("idNewSave") and
					self.parent:ResolveId("idNewSave").context.metadata.gameid == Game.id then
						editableField = true
					end
