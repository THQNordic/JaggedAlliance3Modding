...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Ok",
			'ActionName', T(116600567829, --[[XTemplate SplitStackItem ActionName]] "OK"),
		...
		PlaceObj('XTemplateAction', {
			'comment', "exit",
			'ActionId', "Cancel",
			'ActionName', T(681743213250, --[[XTemplate SplitStackItem ActionName]] "CANCEL"),
			'ActionToolbar', "ActionBarCenter",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', nil, {
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(164149727004, --[[XTemplate SplitStackItem Text]] "Split Stack"),
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
					'Margins', box(5, 0, 0, 0),
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(985890900191, --[[XTemplate SplitStackItem Text]] "<DPadLeft>"),
						'HideOnEmpty', true,
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(505001141192, --[[XTemplate SplitStackItem Text]] "<DPadRight>"),
						'HideOnEmpty', true,
					}),
					}),
				}),
			PlaceObj('XTemplateTemplate', {
				...
				'OnLayoutComplete', function (self)
					...
					for _, btn in ipairs(list) do
						...
						--btn.idBtnShortcut:SetText(T{775518317251, "[<name>]", name = _==1 and T(122085236350, "ENT") or T(939588806542, "ESC")})
