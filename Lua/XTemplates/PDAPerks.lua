			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(336562821518, --[[XTemplate PDAPerks Text]] "Perks Level up"),
						'TextVAlign', "bottom",
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XText",
						...
						'Translate', true,
						'Text', T(294890393549, --[[XTemplate PDAPerks Text]] "Available perks"),
						'TextVAlign', "bottom",
					}),
					PlaceObj('XTemplateWindow', {
						'comment', "points",
						...
						'Translate', true,
						'Text', T(311301754183, --[[XTemplate PDAPerks Text]] "<perkPoints>"),
						'TextVAlign', "center",
					}),
					}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(577935949359, --[[XTemplate PDAPerks Text]] "Stats"),
							'WordWrap', false,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(713633774841, --[[XTemplate PDAPerks Text]] "Deselect a perk to choose a new one"),
						'TextHAlign', "center",
						'TextVAlign', "center",
					}),
					}),
