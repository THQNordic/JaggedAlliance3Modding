...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'__condition', function (parent, context) return context.Guardpost and context.guardpost_obj and context.guardpost_obj.next_spawn_time or GetSectorTimer(context) end,
			'__class', "XText",
			'Id', "idCountdown",
			'HAlign', "center",
			'Clip', false,
			'UseClipBox', false,
			'DrawOnTop', true,
			'TextStyle', "DescriptionTextBigGlow",
			'Translate', true,
			'TextHAlign', "center",
		}, {
