...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateProperty', {
		...
		'name', T(298816813682, --[[XTemplate PDAImpOutcome name]] "HeaderButtonId"),
	}),
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'OnContextUpdate', function (self, context, ...)
				local texts = {}
				local max_stat = table.max(context.stats, function(m) return m.value end )
				if max_stat then
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(177052366651, --[[XTemplate PDAImpOutcome Text]] "<underline>Outcome</underline>"),
				}),
				PlaceObj('XTemplateWindow', {
					'__class', "XText",
					'Id', "idText",
