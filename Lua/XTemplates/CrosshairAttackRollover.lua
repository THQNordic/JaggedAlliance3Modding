				...
				if targetHasBodyParts then
					...
					for i, mod in ipairs(modifiers) do
						...
						if modValue then
							...
							if CthVisible() then sign = T{537019866139, "<style PDABrowserTextLightBold><percentWithSign(value)></style>", value = modValue} end
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextStyle', "PDABrowserNameSmall",
						'Translate', true,
						'Text', T(392264332209, --[[XTemplate CrosshairAttackRollover Text]] "STATUS"),
						'TextVAlign', "center",
					}),
					PlaceObj('XTemplateWindow', {
