...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "SatelliteSectorIconGuardpostClass",
		'RolloverAnchor', "center-top",
		'IdNode', true,
		'Margins', box(0, 15, 10, 0),
		'HAlign', "right",
		'VAlign', "top",
	}, {
		PlaceObj('XTemplateWindow', {
			'__class', "XContentTemplate",
			'Id', "idShieldContainer",
			...
			PlaceObj('XTemplateWindow', {
				...
				'UseClipBox', false,
				'FoldWhenHidden', true,
				'Image', "UI/PDA/guardpost_pad",
				'ImageScale', point(1500, 1500),
				'FrameBox', box(0, 0, 50, 0),
				'SqueezeY', false,
			}),
			PlaceObj('XTemplateWindow', {
				'Margins', box(40, 0, 40, 2),
				'LayoutMethod', "HList",
				'LayoutHSpacing', 10,
				'UseClipBox', false,
			}, {
				PlaceObj('XTemplateForEach', {
					'array', function (parent, context) return GetGuardpostStrength(context.sector.Id) end,
		...
		PlaceObj('XTemplateWindow', {
			'Id', "idTimer",
			'Margins', box(100, 50, 0, 0),
			'HAlign', "left",
			'UseClipBox', false,
			'FoldWhenHidden', true,
		}, {
			PlaceObj('XTemplateTemplate', {
				'__context', function (parent, context) return context.sector.guardpost_obj end,
				'__template', "GuardpostSpawnTimerTemplate",
				'FoldWhenHidden', true,
			}),
			}),
		PlaceObj('XTemplateWindow', {
			'__class', "XMapRollerableContextImage",
			'RolloverTemplate', "RolloverGeneric",
			'RolloverAnchor', "center-top",
			'Id', "idIcon",
			'IdNode', false,
			...
			'Image', "UI/Icons/SateliteView/icon_enemy",
		}, {
			PlaceObj('XTemplateWindow', {
				'__class', "XImage",
				'Id', "idInner",
				...
				'VAlign', "center",
				'UseClipBox', false,
				'Image', "UI/Icons/SateliteView/guard_post",
			}),
