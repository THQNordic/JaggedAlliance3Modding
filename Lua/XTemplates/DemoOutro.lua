	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__class', "XVideo",
				'Id', "idVideoPlayer",
				'VideoDefId', "HotDiamondsDemoOutro",
				'Sound', "Sounds/movies/HotDiamondsDemoOutro",
				'AutoPlay', true,
				'Gamma', 2400,
			}, {
			...
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return GetLanguage() ~= "English" end,
				'__class', "XText",
				'Id', "TEXT",
				'Margins', box(10, 10, 10, 100),
				'MarginPolicy', "FitInSafeArea",
				'HAlign', "center",
				'VAlign', "bottom",
				'MaxWidth', 1200,
				'ScaleModifier', point(1600, 1600),
				'UseClipBox', false,
				'FadeInTime', 300,
				'FadeOutTime', 300,
		...
		PlaceObj('XTemplateThread', {
			...
			PlaceObj('XTemplateVoice', {
				'TimeBefore', 500,
				'TimeAdd', 500,
				'Text', T(993177753169, --[[XTemplate DemoOutro Text]] "Grand Chien still needs you"),
			}),
			PlaceObj('XTemplateVoice', {
				'TimeBefore', 16000,
				'TimeAdd', 30000,
				'Text', T(992696528563, --[[XTemplate DemoOutro Text]] "Explore Grand Chien at your own pace in the full game.<newline><newline>Thanks for playing the demo version!"),
			}),
			}),
		}),
})
