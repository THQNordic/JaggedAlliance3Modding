...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		'__template', "ZuluMessageDialogTemplate",
		'HostInParent', false,
	}, {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "public",
			'ActionName', T(600864774681, --[[XTemplate MultiplayerHostQuestion ActionName]] "Public"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "private",
			'ActionName', T(454022690610, --[[XTemplate MultiplayerHostQuestion ActionName]] "Private"),
			'ActionToolbar', "ActionBar",
			'ActionShortcut', "R",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Close",
			'ActionName', T(607757565362, --[[XTemplate MultiplayerHostQuestion ActionName]] "Close"),
			'ActionToolbar', "ActionBar",
