...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'Visible', false,
		'HasTitle', false,
		'AppId', "XEditorToolSettingsPanel",
		'InitialWidth', 350,
	}, {
		PlaceObj('XTemplateFunc', {
			'name', "ApplySavedSettings(self, ...)",
			'func', function (self, ...)
				-- don't restore saved layout, we have a fixed layout
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "Open(self, ...)",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateTemplate', {
				'__parent', function (parent, context) return parent.idTitleContainer end,
				'__template', "GedToolbarToggleButtonSmall",
				'RolloverText', T(292312175244, --[[XTemplate XEditorToolSettingsPanel RolloverText]] "Move tool settings in/out of game."),
				'Id', "idToggleDisplayInGame",
			...
			PlaceObj('XTemplateFunc', {
				'comment', "re-translate shortcuts from Filter field",
				'name', "RebuildControls(self)",
				'func', function (self)
					...
					if filter_edit then
						...
						filter_edit.OnShortcut = function(self, shortcut, source, ...)
						...
						-- allow various shortcuts to pass through the always-focused Filter edit field
