...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		'MaxHeight', 1100,
		'DrawOnTop', true,
		'BorderColor', RGBA(128, 131, 136, 255),
		...
		PlaceObj('XTemplateWindow', {
			...
			'FocusedBackground', RGBA(160, 160, 160, 255),
		}, {
			PlaceObj('XTemplateWindow', {
				'__class', "XLabel",
				'Margins', box(4, 2, 4, 2),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'comment', "Combo container",
					'__context', function (parent, context) return "appendToExistingBug" end,
					...
					PlaceObj('XTemplateWindow', {
						'comment', "Reporter",
						'RolloverText', T(714018055914, --[[XTemplate BugReport RolloverText]] "Rollover"),
						'LayoutMethod', "HList",
						'LayoutHSpacing', 33,
						'FoldWhenHidden', true,
					}, {
						...
						PlaceObj('XTemplateWindow', {
							...
							'OnContextUpdate', function (self, context, ...)
								...
								if node and node.idReporter and node.idAPIToken and node.idAppendToExistingBug then
									local reporter = node.idReporter:GetValue()
									local token = node.idAPIToken:GetText()
									-- Disable appending to existing issue if no reporter or token is set
									if ((reporter or "") == "" or reporter == " ") and (token or "") == "" then -- No reporter (AutoReporter) = " "
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'MaxWidth', 170,
							'RelativeFocusOrder', "next-in-line",
							'MRUStorageId', "BugReporterAssignTo",
						}),
						}),
					PlaceObj('XTemplateWindow', {
						'comment', "Severity",
					...
					PlaceObj('XTemplateWindow', {
						'comment', "append to existing bug",
						'Id', "idAppendToExistingBugContainer",
						'FoldWhenHidden', true,
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XLabel",
							...
							'MinWidth', 100,
							'FocusedBackground', RGBA(255, 255, 255, 255),
							'Text', "Append to existing issue:",
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XEdit",
							'Id', "idAppendToExistingBug",
							'Margins', box(5, 0, 0, 0),
							'HAlign', "left",
							'MinWidth', 110,
							'MaxWidth', 110,
							'RelativeFocusOrder', "next-in-line",
							'DisabledBorderColor', RGBA(0, 0, 0, 255),
							'DisabledBackground', RGBA(124, 124, 124, 255),
							'OnTextChanged', function (self)
								ObjModified("appendToExistingBug")
							end,
							'Hint', "mantis id or link",
						}),
						}),
					}),
				PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateForEach', {
								'array', function (parent, context)
									return Platform.ged and g_GedApp.bug_report_tags or PresetArray("BugReportTag", function (tag) return not tag.Automatic and not tag.Platform and (insideHG() or tag.ShowInExternal) end)
								end,
								...
								PlaceObj('XTemplateWindow', {
									...
									'Background', RGBA(0, 0, 0, 0),
									'FocusedBackground', RGBA(41, 160, 244, 255),
									'DisabledBackground', RGBA(124, 124, 124, 255),
									'RolloverBackground', RGBA(41, 160, 244, 255),
									'RolloverBorderColor', RGBA(128, 128, 128, 255),
									'PressedBackground', RGBA(41, 160, 244, 255),
									'PressedBorderColor', RGBA(128, 128, 128, 255),
									'ToggledBackground', RGBA(41, 160, 244, 255),
					...
					PlaceObj('XTemplateWindow', {
						'__condition', function (parent, context) return not Platform.ged end,
						'Id', "idPlatformTags",
						'LayoutMethod', "HList",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XLabel",
							'Id', "idPlatformTagsLabel",
							'Dock', "left",
							'HAlign', "center",
							'VAlign', "top",
							'MinWidth', 100,
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateForEach', {
								'array', function (parent, context)
									return Platform.ged and g_GedApp.bug_report_tags or PresetArray("BugReportTag", function (tag) return not tag.Automatic and tag.Platform and (insideHG() or tag.ShowInExternal) end)
								end,
								'run_after', function (child, context, item, i, n, last)
									local id = item.id
									child:SetId("id" .. id)
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'Dock', "bottom",
						'HAlign', "center",
						'TextStyle', "BugReportScreenshot",
						'Text', "Click to draw, right-click to clear.",
					}),
					}),
				}),
			}),
