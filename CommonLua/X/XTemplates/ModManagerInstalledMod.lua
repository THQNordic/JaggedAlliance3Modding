			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'FoldWhenHidden', true,
						'Translate', true,
						'Text', T(432182749504, --[[XTemplate ModManagerInstalledMod Text]] "Enabled"),
					}),
					PlaceObj('XTemplateWindow', {
						'__class', "XLabel",
						'Id', "idDisabled",
						...
						'FoldWhenHidden', true,
						'Translate', true,
						'Text', T(953706379202, --[[XTemplate ModManagerInstalledMod Text]] "Disabled"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__condition', function (parent, context) return context.Source ~= "local" and context.Source ~= "steam" end,
					'__class', "XTextButton",
					'Id', "idRemove",
