	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateMode', {
				...
				PlaceObj('XTemplateTemplate', {
					...
					'Text', T(621030754081, --[[XTemplate SaveLoadGameDialog Text]] "SAVE GAME"),
				}),
				}),
			PlaceObj('XTemplateMode', {
				'mode', "load",
				...
				PlaceObj('XTemplateTemplate', {
					'__template', "DialogTitle",
					'Text', T(404394084503, --[[XTemplate SaveLoadGameDialog Text]] "LOAD GAME"),
				}),
				}),
			}),
		PlaceObj('XTemplateAction', {
			'ActionId', "Delete",
			'ActionName', T(858497021631, --[[XTemplate SaveLoadGameDialog ActionName]] "DELETE"),
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateTemplate', {
							...
							'Text', T(640605238354, --[[XTemplate SaveLoadGameDialog Text]] "<<< New Savegame >>>"),
						}, {
							PlaceObj('XTemplateFunc', {
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self, shortcut, source, ...)
								if shortcut == "Up" and self.focused_item == 1 then
									if GetDialogMode(self) == "save" then
				...
				PlaceObj('XTemplateAction', {
					'ActionId', "Back",
					'ActionName', T(127501107069, --[[XTemplate SaveLoadGameDialog ActionName]] "BACK"),
					'ActionToolbar', "ActionBar",
