...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "GedApp",
		'Title', "XWindow Inspector",
		'AppId', "XWindowInspector",
		'CommonActionsInMenubar', false,
		'CommonActionsInToolbar', false,
	}, {
		PlaceObj('XTemplateAction', {
			'ActionId', "RolloverMode",
			'ActionTranslate', false,
			'ActionName', "Rollover Mode",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "InspectFocusedWindow",
			'ActionTranslate', false,
			'ActionName', "Inspect Focused Window",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "FocusLogging",
			'ActionTranslate', false,
			'ActionName', "Toggle Focus Logging",
			'ActionIcon', "CommonAssets/UI/Ged/log-focused.tga",
			'ActionToolbar', "main",
			'ActionToggle', true,
			'ActionToggled', function (self, host)
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "RolloverLogging",
			'ActionTranslate', false,
			'ActionName', "Toggle Rollover Logging",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "ContextLogging",
			'ActionTranslate', false,
			'ActionName', "Toggle Context Logging",
		...
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return "SelectedWindow" end,
			'__class', "GedBreadcrumbPanel",
			'Id', "idWindowPath",
			'Margins', box(0, 0, 0, 1),
			'Dock', "top",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				'Title', "",
				'DisplayWarnings', false,
				'FormatFunc', "GedThreadsPausedStatus",
			}, {
				PlaceObj('XTemplateWindow', {
					'__class', "XTextButton",
					'Id', "idPauseResume",
