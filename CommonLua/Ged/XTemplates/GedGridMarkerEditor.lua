...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		'__class', "GedApp",
		'MinWidth', 700,
		'Title', "Grid Marker Editor",
		'AppId', "GedGridMarkerEditor",
	}, {
		PlaceObj('XTemplateWindow', {
			'MinWidth', 300,
			'LayoutMethod', "VPanel",
			...
			PlaceObj('XTemplateWindow', {
				'comment', "filter",
				'__context', function (parent, context) return "MarkersFilter" end,
			...
			PlaceObj('XTemplateWindow', {
				...
				'Format', "<EditorText>",
				'FilterName', "MarkersFilter",
				'FilterClass', "GridMarkerFilter",
				'SelectionBind', "SelectedObjects",
		...
		PlaceObj('XTemplateWindow', {
			'comment', "marker properties",
			'__context', function (parent, context) return "SelectedObjects" end,
			'__class', "GedPropPanel",
			'MinWidth', 300,
			'Title', "Properties",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Save",
			'ActionName', T(658264891173, --[[XTemplate GedGridMarkerEditor ActionName]] "Save"),
		...
		PlaceObj('XTemplateForEach', {
			'array', function (parent, context) return {"GridMarker", "UnitMarker", "ContainerMarker", "CustomInteractable", "WaypointMarker", "AmbientLifeMarker"} end,
			'unique', true,
			'run_after', function (child, context, item, i, n, last)
				...
				child.OnAction = function(this, host, source)
