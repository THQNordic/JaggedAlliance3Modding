...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Format', "<EditorView>",
			'SelectionBind', "SelectedPrg,SelectedObject,SelectedPrg2",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "File",
			'ActionName', T(948732019662, --[[XTemplate UnitAIEditor ActionName]] "File"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
		}, {
			PlaceObj('XTemplateAction', {
				'ActionId', "NewPrg",
				'ActionName', T(556464891609, --[[XTemplate UnitAIEditor ActionName]] "New Prg"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "SavePrg",
				'ActionName', T(162535700852, --[[XTemplate UnitAIEditor ActionName]] "Save"),
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionName', T(434679393664, --[[XTemplate UnitAIEditor ActionName]] "Force Save All"),
				'ActionIcon', "CommonAssets/UI/Ged/save.tga",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Edit",
			'ActionName', T(865980146926, --[[XTemplate UnitAIEditor ActionName]] "Edit"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
		}, {
			PlaceObj('XTemplateAction', {
				'ActionId', "MoveUp",
				'ActionName', T(185621365384, --[[XTemplate UnitAIEditor ActionName]] "Move Up"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "MoveDown",
				'ActionName', T(111040886672, --[[XTemplate UnitAIEditor ActionName]] "Move Down"),
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionName', T(984343171402, --[[XTemplate UnitAIEditor ActionName]] "Move Out"),
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionName', T(346253453974, --[[XTemplate UnitAIEditor ActionName]] "Move In"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Delete",
				'ActionName', T(116422019899, --[[XTemplate UnitAIEditor ActionName]] "Delete"),
			...
			PlaceObj('XTemplateAction', {
				'ActionName', T(205229988402, --[[XTemplate UnitAIEditor ActionName]] "-----"),
			}),
			PlaceObj('XTemplateAction', {
				'ActionId', "Undo",
				'ActionName', T(586638531914, --[[XTemplate UnitAIEditor ActionName]] "Undo"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Redo",
				'ActionName', T(337422381388, --[[XTemplate UnitAIEditor ActionName]] "Redo"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Cut",
				'ActionName', T(661644791099, --[[XTemplate UnitAIEditor ActionName]] "Cut"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Copy",
				'ActionName', T(410671052718, --[[XTemplate UnitAIEditor ActionName]] "Copy"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Paste",
				'ActionName', T(161980212288, --[[XTemplate UnitAIEditor ActionName]] "Paste"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Duplicate",
				'ActionName', T(813358135659, --[[XTemplate UnitAIEditor ActionName]] "Duplicate"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Prg",
			'ActionName', T(520146974925, --[[XTemplate UnitAIEditor ActionName]] "Prg"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Condition",
			'ActionName', T(885408776889, --[[XTemplate UnitAIEditor ActionName]] "Condition"),
			'ActionMenubar', "main",
			'ActionToolbarSplit', true,
			'OnActionEffect', "popup",
			'ActionContexts', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Object",
			'ActionName', T(925998964504, --[[XTemplate UnitAIEditor ActionName]] "Object"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Move",
			'ActionName', T(128715807740, --[[XTemplate UnitAIEditor ActionName]] "Move"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Execute",
			'ActionName', T(106465668170, --[[XTemplate UnitAIEditor ActionName]] "Execute"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Define",
			'ActionName', T(223759203414, --[[XTemplate UnitAIEditor ActionName]] "Define"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
