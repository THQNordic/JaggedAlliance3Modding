...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Id', "idPrgs",
			'Title', "Program",
			'ActionContext', "PrgsPanelAction",
			'SearchActionContexts', {
				"PrgsPanelAction",
			},
			'FormatFunc', "GedPresetTree",
			'Format', "<EditorView>",
			'SelectionBind', "SelectedPrg,SelectedObject,SelectedPrg2,SelectedPreset",
			'MultipleSelection', true,
			'RootActionContext', "PrgsRootAction",
			'ChildActionContext', "PrgsChildAction",
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XPanelSizer",
		}),
		PlaceObj('XTemplateWindow', {
			'__context', function (parent, context) return "SelectedPrg" end,
			'__class', "GedTreePanel",
			'Id', "idCommands",
			'Title', "Commands",
			'ActionContext', "CommandPanelAction",
			'SearchActionContexts', {
				"CommandPanelAction",
			},
			'Format', "<TreeView>",
			...
			'MultipleSelection', true,
			'RootActionContext', "CommandRootAction",
			'ChildActionContext', "CommandChildAction",
		}),
		PlaceObj('XTemplateWindow', {
			'__class', "XPanelSizer",
		}),
		PlaceObj('XTemplateWindow', {
			...
			'Id', "idProps",
			'Title', "Properties",
			'ActionContext', "PropAction",
			'SearchActionContexts', {
				"PropAction",
			},
			'RootObjectBindName', "SelectedPrg",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__context', function (parent, context) return "SelectedPrg2" end,
				'__class', "GedMultiLinePanel",
				'Id', "idLuaError",
				'Dock', "bottom",
				'MinWidth', 400,
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "File",
			'ActionName', T(712323352797, --[[XTemplate PrgEditor ActionName]] "File"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
		}, {
			PlaceObj('XTemplateAction', {
				'ActionId', "NewPrg",
				'ActionName', T(360697141304, --[[XTemplate PrgEditor ActionName]] "New Prg"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "SavePrg",
				'ActionName', T(916183504912, --[[XTemplate PrgEditor ActionName]] "Save"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "ForceSaveAllPrg",
				'ActionName', T(434679393664, --[[XTemplate PrgEditor ActionName]] "Force Save All"),
				'ActionIcon', "CommonAssets/UI/Ged/save.tga",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Edit",
			'ActionName', T(330213008455, --[[XTemplate PrgEditor ActionName]] "Edit"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
		}, {
			PlaceObj('XTemplateAction', {
				'ActionId', "MoveUp",
				'ActionName', T(791671477037, --[[XTemplate PrgEditor ActionName]] "Move Up"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "MoveDown",
				'ActionName', T(503417209595, --[[XTemplate PrgEditor ActionName]] "Move Down"),
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionName', T(783481543051, --[[XTemplate PrgEditor ActionName]] "Move Out"),
			...
			PlaceObj('XTemplateAction', {
				...
				'ActionName', T(497045530704, --[[XTemplate PrgEditor ActionName]] "Move In"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Delete",
				'ActionName', T(113212469761, --[[XTemplate PrgEditor ActionName]] "Delete"),
			...
			PlaceObj('XTemplateAction', {
				'ActionName', T(567507320026, --[[XTemplate PrgEditor ActionName]] "-----"),
			}),
			PlaceObj('XTemplateAction', {
				'ActionId', "Undo",
				'ActionName', T(725875328081, --[[XTemplate PrgEditor ActionName]] "Undo"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Redo",
				'ActionName', T(922446426176, --[[XTemplate PrgEditor ActionName]] "Redo"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Cut",
				'ActionName', T(538499375745, --[[XTemplate PrgEditor ActionName]] "Cut"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Copy",
				'ActionName', T(770103851001, --[[XTemplate PrgEditor ActionName]] "Copy"),
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "Paste",
				'ActionName', T(600145840118, --[[XTemplate PrgEditor ActionName]] "Paste"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Prg",
			'ActionName', T(363353647533, --[[XTemplate PrgEditor ActionName]] "Prg"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Object",
			'ActionName', T(498415903648, --[[XTemplate PrgEditor ActionName]] "Object"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Move",
			'ActionName', T(459238074396, --[[XTemplate PrgEditor ActionName]] "Move"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Slot",
			'ActionName', T(163944698213, --[[XTemplate PrgEditor ActionName]] "Slot"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Game",
			'ActionName', T(669051064939, --[[XTemplate PrgEditor ActionName]] "Game"),
			'ActionMenubar', "main",
			'OnActionEffect', "popup",
			'ActionContexts', {
				"CommandPanelAction",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Condition",
			'ActionName', T(782379681327, --[[XTemplate PrgEditor ActionName]] "Condition"),
			'ActionMenubar', "main",
			'ActionToolbarSplit', true,
			'OnActionEffect', "popup",
			'ActionContexts', {
		...
		PlaceObj('XTemplateAction', {
			...
			'RolloverText', T(690760718686, --[[XTemplate PrgEditor RolloverText]] "Click to toggle debug waypoints for units."),
			'RolloverTitle', T(951928076276, --[[XTemplate PrgEditor RolloverTitle]] "Toggle Waypoints"),
			'ActionId', "ToggleWaypoints",
			'ActionIcon', "CommonAssets/UI/Ged/log-mousetarget.tga",
			'ActionMenubar', "main",
			'ActionToolbar', "main",
			'ActionToggle', true,
